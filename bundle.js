webpackJsonp([4], [function(t, e, n) {
    ...
    i(x);
    n(610),
    new r.default(document.body),
    TweenMax.set(a.default.q("#stage"), {
        display: "block"
    })
}
, function(t, e, n) {
    var i = n(8)
      ...
      , u = "prototype"
      , c = function(t, e, n) {
        var l, f, h, p, d = t & c.F, v = t & c.G, m = t & c.S, g = t & c.P, y = t & c.B, w = v ? i : m ? i[e] || (i[e] = {}) : (i[e] || {})[u], x = v ? o : o[e] || (o[e] = {}), b = x[u] || (x[u] = {});
        v && (n = e);
        for (l in n)
            f = !d && w && void 0 !== w[l],
            h = (f ? w : n)[l],
            p = y && f ? a(h, i) : g && "function" == typeof h ? a(Function.call, h) : h,
            w && s(w, l, h, t & c.U),
            x[l] != h && r(x, l, p),
            g && b[l] != h && (b[l] = h)
    };
        ...
        return r(t, [{
            ...
            value: function(e) {
                ...
                new Promise(function(r, s) {
                    c.default.isInCache(e) || n.getFile(e, i),
                    c.default.add(e, function(e) {
                        n._finishedFiles++,
                        o(e),
                        r(e),
    ...
    n(19))
      ...
      , p = function() {
        function t() {
            o(this, t),
            this.isReady = !1,
            c.default.addEventListener(t.Events.INIT, this.init.bind(this))
        }
        return r(t, [{
            key: "init",
            value: function() {
...
, function(t, e, n) {
    ...
    function t(e) {
        ...
        this.timelines = {},
        this.$node = e,
        this.isDark = DOMUtils.hasClass(document.body, "dark-mode")
    }
    );
    s.Events = {
    ...
    var r = function() {
      ...
      , c = function() {
        ...
        return r(t, [{
            ...
            key: "trackPageView",
            value: function(t) {
                "undefined" != typeof u && "undefined" != typeof webtrends || this.checkForLibs(),
                "undefined" != typeof u ? u("send", "pageview", t) : console.log("Tracking: can not send tracking requests, because ga is not defined")
            }
        }, {
            key: "trackInteraction",
            value: function(t, e, n, i) {
                "undefined" == typeof u && this.checkForLibs(),
                "undefined" != typeof u ? u("send", "event", t, e, n, i) : console.log("Tracking: can not send tracking requests, because ga is not defined")
            }
        }, {
            key: "setupListeners",
            value: function() {
                a.default.addEventListener(t.Events.TRACK_PAGE, this.onTrackPage.bind(this)),
                a.default.addEventListener(t.Events.TRACK_EVENT, this.onTrackEvent.bind(this))
            }
        }, {
            key: "onTrackPage",
            value: function(t) {
...
, function(t, e, n) {
    ...
    if (n(15)) {
        var i = n(69)
          ...
          , Dt = function(t, e) {
            for (var n = 0, i = e.length, o = Ct(t, i); i > n; )
                o[n] = e[n++];
            return o
        }
          , It = function(t, e, n) {
          ...
          , jt = function(t) {
            var e, n, i, o, r, s, a = P(t), u = arguments.length, l = u > 1 ? arguments[1] : void 0, f = void 0 !== l, h = T(a);
            if (void 0 != h && !M(h)) {
                for (s = h.call(a),
                i = [],
                e = 0; !(r = s.next()).done; e++)
          ...
          , Bt = {
            ...
            reverse: function() {
                for (var t, e = this, n = $t(e).length, i = Math.floor(n / 2), o = 0; o < i; )
                    t = e[o],
                    e[o++] = e[--n],
                    e[n] = t;
                return e
          ...
          , Ht = function(t, e, n) {
            return !(Wt(t, e = g(e, !0)) && b(n) && y(n, "value")) || y(n, "get") || y(n, "set") || n.configurable || y(n, "writable") && !n.writable || y(n, "enumerable") && !n.enumerable ? F(t, e, n) : (t[e] = n.value,
            t)
        };
        Pt || (B.f = zt,
        R.f = Ht),
        ...
        t.exports = function(t, e, n, u) {
            ...
            w ? (m = n(function(t, n, i, o) {
                ...
                var r, s, a, u, f = 0, p = 0;
                if (b(n)) {
                    if (!(n instanceof J || (u = x(n)) == H || u == G))
                        return Mt in n ? Dt(m, n) : jt.call(m, n);
                    r = n,
                    p = Lt(i, e);
                    var d = n.byteLength;
                    if (void 0 === o) {
            ...
            M = m[X] = O(Gt),
            h(M, "constructor", m)) : I(function(t) {
                new m(null),
                new m(t)
    ...
    n(46))
      ...
      , _ = function(t) {
        function e() {
            ...
            return t.isMenuVisible = !1,
            t.targetMenuContainerX = -50,
            t.currentMenuContainerX = -50,
            t.currentMenuEnterTLs = [],
            t.currentMenuLeaveTLs = [],
            t.isMouseOverSome = [],
            t.someEnterTLs = [],
            t.someLeaveTLs = [],
            (0,
            P.default)(t),
            t.preload().then(t.setup.bind(t)),
            t
        }
        return a(e, t),
        u(e, [{
            ...
            key: "setupDOMNodes",
            value: function() {
                this.$menuButton = DOMUtils.q(".menu-button", this.$node),
                this.$menuButtonStripes = DOMUtils.q(".stripe", this.$menuButton),
                this.$closeButton = DOMUtils.q(".close-button", this.$node),
                this.$closeButtonStripes = DOMUtils.q(".stripe", this.$closeButton),
                this.$logo = DOMUtils.q(".logo", this.$node),
                this.$logoContainer = DOMUtils.q(".logo-container", this.$logo),
                this.$logoLines = DOMUtils.q(".logo-lines path", this.$logo),
                this.$logoFakeLine = DOMUtils.q(".fake-line", this.$logo),
                this.$logoRPath = DOMUtils.q("#r-stroke", this.$logo),
                this.$logoFPath = DOMUtils.q("#f-stroke", this.$logo),
                this.$logoRPath2 = DOMUtils.q("#r-stroke_1_", this.$logo),
                this.$logoSPath = DOMUtils.q("#s-stroke", this.$logo),
                this.$logoHPath = DOMUtils.q("#h-stroke", this.$logo),
                this.$menu = DOMUtils.q(".menu", this.$node),
                this.$someContainer = DOMUtils.q(".some-container", this.$node),
                this.$someLabel = DOMUtils.q(".label", this.$someContainer),
                this.$someLinksContainer = DOMUtils.q(".link-container", this.$someContainer),
                this.$someLinks = DOMUtils.q(".link-container a", this.$someContainer),
                this.$menuContainer = DOMUtils.q(".menu-container", this.$node),
                this.$menuLinks = DOMUtils.q("a", this.$menuContainer)
            }
        }, {
            key: "setupTimelines",
            value: function() {
            ...
            value: function() {
                ...
                DOMUtils.on(this.$menuButton, "click", this.onMenuButtonClick),
                DOMUtils.on(this.$closeButton, "click", this.onCloseButtonClick),
                DOMUtils.on(this.$menuLinks, "click", this.onMenuLinkClick),
                DOMUtils.on(this.$logo, "click", this.onLogoClick),
                window.APP.isMobile || (DOMUtils.on(this.$menuButton, "mouseenter", this.onMenuButtonEnter),
                DOMUtils.on(this.$closeButton, "mouseenter", this.onCloseButtonEnter),
                DOMUtils.on(this.$menuLinks, "mouseenter", this.onMenuLinkEnter),
                DOMUtils.on(this.$menuLinks, "mouseleave", this.onMenuLinkLeave),
                DOMUtils.on(this.$someLinks, "mouseenter", this.onSomeEnter),
                DOMUtils.on(this.$someLinks, "mouseleave", this.onSomeLeave),
                DOMUtils.on(this.$logo, "mouseenter", this.onLogoEnter),
                DOMUtils.on(this.$logo, "mouseleave", this.onLogoLeave))
            }
        }, {
            key: "activateMouseMove",
            value: function() {
                this.targetMenuContainerX = -50,
                this.currentMenuContainerX = -50,
                DOMUtils.on(window, "mousemove", this.onMouseMove),
                p.default.addEventListener(y.Events.TICK, this.onMenuTick)
            }
        }, {
            key: "deactivateMouseMove",
            value: function() {
                DOMUtils.off(window, "mousemove", this.onMouseMove),
                p.default.removeEventListener(y.Events.TICK, this.onMenuTick)
            }
        }, {
            key: "show",
            value: function() {
                var t = this;
                return this.timelines.hide.kill(),
                new Promise(function(e, n) {
                    t.timelines.show.eventCallback("onComplete", e),
            ...
            value: function() {
                var t = this;
                return this.timelines.show.kill(),
                new Promise(function(e, n) {
                    t.timelines.hide.eventCallback("onComplete", e),
            ...
            value: function() {
                var t = this;
                return this.isMenuVisible = !0,
                this.timelines.hideMenu.kill(),
                new Promise(function(n, i) {
                    p.default.dispatchEvent(e.Events.OPEN_MENU),
                    t.timelines.showMenu.eventCallback("onComplete", function() {
                        window.APP.isMobile || t.activateMouseMove(),
                        n()
                    }),
            ...
            value: function(t, n) {
                var i = this;
                return this.isMenuVisible = !1,
                this.timelines.showMenu.kill(),
                new Promise(function(o, r) {
                    t && v.default.push(n),
                    n = "undefined" != typeof n ? n.substring(1) : n,
                    i.timelines.hideMenu.eventCallback("onComplete", function() {
                        if (p.default.dispatchEvent(e.Events.CLOSE_MENU, {
                            wasLink: t,
                            page: n
                        }),
                        i.deactivateMouseMove(),
                        window.APP.isMobile) {
            ...
            value: function(t) {
                var e = t.page
                  , n = T.indexOf(e);
                this.currentIndex = n,
                n < 0 ? this.showCloseButton() : this.hideCloseButton(),
                this.isActive || p.default.addEventListener(l.Events.CURR_OUT, this.onSectionCurrOut)
            }
        }, {
            key: "onSectionCurrOut",
            value: function() {
                p.default.removeEventListener(l.Events.CURR_OUT, this.onSectionCurrOut),
                this.isActive = !0,
                this.show()
            }
        }, {
            ...
            value: function(t) {
                t.preventDefault(),
                window.APP.isMobile ? x.mobileMenuLinkClick(this, t.currentTarget) : x.desktopMenuLinkClick(this, t.currentTarget),
                E.default.trackInteraction("Ui", "click", t.currentTarget.className)
            }
        }, {
            key: "mouseEnter",
            value: function(t, e) {
            ...
            value: function(t) {
                if (!this.inMenuClickTransition) {
                    var e = t.currentTarget
                      , n = DOMUtils.index(e);
                    this.currentCursorHover = void 0,
                    this.mouseLeave(e, n)
                }
            }
        }, {
            ...
            value: function(t) {
                this.isMenuVisible ? (this.timelines.menuEnter.isActive() && this.timelines.menuEnter.pause().progress(1),
                this.timelines.menuCloseEnter.isActive() || this.timelines.menuCloseEnter.restart(!0, !1)) : (this.timelines.menuCloseEnter.isActive() && this.timelines.menuCloseEnter.pause().progress(1),
                this.timelines.menuEnter.isActive() || this.timelines.menuEnter.restart(!0, !1))
            }
        }, {
            ...
            value: function(t) {
                var e = t.clientX
                  ...
                  , r = (e - i) / i;
                r *= 1 - Math.min(Math.abs(n - o), .5 * o) / (.5 * o),
                this.targetMenuContainerX = -50 + 20 * -r
            }
        }, {
            key: "onMenuTick",
            value: function() {
                this.currentMenuContainerX += .05 * (this.targetMenuContainerX - this.currentMenuContainerX),
                TweenMax.set(this.$menuContainer, {
            ...
            value: function(t) {
                t.preventDefault(),
                this.isMenuVisible ? (!window.APP.isMobile && this.timelines.menuCloseEnter.isActive() && this.timelines.menuCloseEnter.pause().progress(1),
                this.hideMenu(!1),
                this.currentIndex < 0 && this.showCloseButton()) : (!window.APP.isMobile && this.timelines.menuEnter.isActive() && this.timelines.menuEnter.pause().progress(1),
                this.showMenu(),
                0 !== this.currentIndex && this.hideCloseButton()),
                E.default.trackInteraction("Ui", "click", "MenuButton")
            }
        }, {
            ...
            key: "onLogoEnter",
            value: function(t) {
                this.timelines.logoEnter.isActive() || this.timelines.logoLeave.isActive() || this.logoEnter(),
                this.isMouseOverLogo = !0
            }
        }, {
            key: "onLogoLeave",
            value: function(t) {
                this.timelines.logoEnter.isActive() || this.timelines.logoLeave.isActive() || this.timelines.logoLeave.restart(!0, !1),
                this.isMouseOverLogo = !1
            }
        }, {
            key: "onLogoClick",
            value: function(t) {
...
, function(t, e, n) {
    var i = n(6)
      ...
      , u = "prototype"
      , c = function() {
        var t, e = n(152)("iframe"), i = r.length, o = "<", s = ">";
            ...
            value: function(t) {
                ...
                return new Promise(function(n, i) {
                    if ("undefined" != typeof t.length) {
                        ...
                        a.default.isInCache(u) || e.fetchSVG(u),
                        a.default.add(u, function(i) {
                            e.injectSVG(t, i),
                            n()
                        })
                    }
      ...
      , e = t.exports = function(t, e, n, f, h) {
        ...
        if (r(g)) {
            for (p = a(t.length); p > w; w++)
                if (m = e ? y(s(d = t[w])[0], d[1]) : y(t[w]),
                m === c || m === l)
                    return m
        } else
            for (v = g.call(t); !(d = v.next()).done; )
                if (m = o(v, y, d.value, e),
                m === c || m === l)
                    return m
    }
    ;
            ...
            function d() {
                ...
                n) {
                    if (void 0 === w)
                        return r(M);
                    if (E)
                        return w = setTimeout(l, e),
                        o(M)
                }
                return void 0 === w && (w = setTimeout(l, e)),
                y
            }
            var v, m, g, y, w, M, O = 0, k = !1, E = !1, T = !0;
            if ("function" != typeof t)
                throw new TypeError(a);
            return e = s(e) || 0,
            i(n) && (k = !!n.leading,
            E = "maxWait"in n,
            g = E ? x(s(n.maxWait) || 0, e) : g,
      ...
      , u = function() {
        ...
        return r(t, [{
            ...
            value: function() {
                ...
                a.default.dispatchEvent(t.Events.TICK, +new Date - this.lastTick, !1),
...
, function(t, e, n) {
    ...
    t.exports = function(t) {
        return function(e, n, s) {
            var a, u = i(e), c = o(u.length), l = r(s, c);
            if (t && n != n) {
                for (; c > l; )
                    if (a = u[l++],
                    a != a)
...
, function(t, e, n) {
    for (var i, o = n(8), r = n(27), s = n(76), a = s("typed_array"), u = s("view"), c = !(!o.ArrayBuffer || !o.DataView), l = c, f = 0, h = 9, p = "Int8Array,Uint8Array,Uint8ClampedArray,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array".split(","); f < h; )
        (i = o[p[f++]]) ? (r(i.prototype, a, !0),
        r(i.prototype, u, !0)) : l = !1;
    t.exports = {
        ABV: c,
        CONSTR: l,
        TYPED: a,
      ...
      , o = function() {
        ...
        return i(t, [{
            ...
            value: function(t) {
                var e = this._cache[t];
                if (e && e.isLoaded)
                    for (var n = 0, i = e.callbacks.length; n < i; n++)
                        e.callbacks.shift()(e.data),
                        n--,
                        i--
            }
        }]),
        ...
        n(35))
          ...
          , E = function(e) {
            function n() {
                ...
                return e.isDark = DOMUtils.hasClass(document.body, "dark-mode"),
                e.isActive = !1,
                e.isTempActive = !1,
                e.targetCameraX = 0,
                e.mousePosition = new t.Vector2,
                (0,
                x.default)(e),
                e.preload().then(function() {
                    e.setup(),
                    e.onResize()
                }),
                e
            ...
            a(n, [{
                ...
                value: function() {
                    ...
                    i.setClearColor(0, 1),
                    this.$node.appendChild(i.domElement),
                    this.camera = e,
                    this.scene = n,
                    this.renderer = i,
                    this.setupScene(),
                ...
                value: function() {
                    ...
                    this.fullWidth = i,
                    this.fullHeight = n,
                    this.screenWidth = n * (window.innerWidth / window.innerHeight),
                    this.simulator = new P.default(this.renderer,2 * i,2 * n);
                ...
                value: function() {
                    ...
                    h.default.addEventListener(m.Events.OPEN_MENU, this.onOpenMenu),
                    h.default.addEventListener(m.Events.CLOSE_MENU, this.onCloseMenu),
                    h.default.addEventListener(g.Events.ACTIVE, this.onLandscapeOverlayActive),
                    h.default.addEventListener(g.Events.NOT_ACTIVE, this.onLandscapeOverlayNotActive),
                    h.default.addEventListener(n.Events.WAVEFADE_SHOW, this.onWaveFadeShow),
                    h.default.addEventListener(n.Events.WAVEFADE_HIDE, this.onWaveFadeHide)
                }
            }, {
                key: "show",
                value: function() {
                ...
                value: function() {
                    ...
                    return new Promise(function(e, n) {
                        var i = new TimelineMax({
                            onComplete: function() {
                                DOMUtils.off(window, "mousemove", t.onMouseMove),
                                e()
                            }
                        });
                ...
                key: "render",
                value: function() {
                    (this.isActive || this.isTempActive) && requestAnimationFrame(this.render.bind(this)),
                    window.APP.isMobile || this.isLandscapeOverlayActive || (this.simulator.render(),
                    this.currentWF && (this.currentWF.render(),
                    this.currentWF.position.x = this.camera.position.x),
                    this.mesh.material.uniforms.uTime.value += .001,
                    this.camera.position.x += .05 * (this.targetCameraX - this.camera.position.x),
                ...
                value: function() {
                    ...
                    this.currentWF && this.currentWF.onResize()
                }
            }, {
                key: "onRouterUpdate",
                value: function(t) {
                    var e = this
                      , n = t.page;
                    this.currentPage = n,
                    this.isActive || "" === n || h.default.addEventListener(c.Events.CURR_OUT, this.onSectionCurrOut),
                    this.isActive && "" === n && this.hide().then(function() {
                        e.isActive = !1,
                        h.default.dispatchEvent(c.Events.CURR_OUT)
                    })
                }
            }, {
                key: "onSectionCurrOut",
                value: function() {
                    h.default.removeEventListener(c.Events.CURR_OUT, this.onSectionCurrOut),
                    this.isActive = !0,
                    this.show()
                }
            }, {
                ...
                value: function(t) {
                    ...
                    if (this.menuMode) {
                        var i = window.innerWidth / 2
                          ...
                          , r = (e - i) / i;
                        r *= 1 - Math.min(Math.abs(n - o), .5 * o) / (.5 * o),
                        this.targetCameraX = (this.fullWidth - this.screenWidth) / 6 * r
                    }
                }
            }, {
                key: "onOpenMenu",
                value: function() {
                    var t = this;
                    this.isActive ? (this.enterMenuMode(),
                    "undefined" != typeof this.currentWF && (console.log(this.currentWF),
                    this.currentWF.fastHide())) : (this.isTempActive = !0,
                ...
                value: function(t) {
                    ...
                    this.isActive || n && "" !== i ? (this.leaveMenuMode(),
                    console.log("leave only"),
                    "undefined" == typeof this.currentWF || n && "about" !== this.currentPage || (console.log("fast show"),
                    this.currentWF.fastShow())) : (console.log("leave and hide"),
                    this.leaveMenuMode(),
                ...
                value: function(t) {
                    ...
                    "undefined" != typeof this.currentWF ? this.upcomingWF = e : (this.scene.add(e),
                    e.fadeIn().then(function() {
                ...
                value: function(t) {
                    ...
                    this.currentWF.fadeOut().then(function() {
                        e.scene.remove(e.currentWF),
                        e.currentWF = void 0,
                        h.default.dispatchEvent(n.Events.WAVEFADE_HIDE_DONE),
                        "undefined" != typeof e.upcomingWF && (e.scene.add(e.upcomingWF),
                        e.upcomingWF.fadeIn().then(function() {
                            h.default.dispatchEvent(n.Events.WAVEFADE_SHOW_DONE)
                        }),
                        e.currentWF = e.upcomingWF,
                        e.upcomingWF = void 0)
                    })
                }
            }, {
    ...
    n(32))
      ...
      , M = function(t) {
        function e() {
            ...
            return t.isFirstRouterUpdate = !0,
            (0,
            y.default)(t),
            t.preload().then(t.setup.bind(t)),
            t.onResize(),
        ...
        a(e, [{
            ...
            value: function() {
                DOMUtils.on(window, "resize", this.onResize),
                d.default.addEventListener(v.Events.UPDATE, this.onRouterUpdate)
            }
        }, {
            key: "setupDOMNodes",
            value: function() {
                this.$michael = DOMUtils.q("img.left", this.$node),
                this.$raphael = DOMUtils.q("img.right", this.$node),
                this.$logoContainer = DOMUtils.q(".logo-container", this.$node),
                this.$subText = DOMUtils.q(".sub-text", this.$node),
                this.$icon = DOMUtils.q(".icon-container", this.$node)
            }
        }, {
            key: "setupTimelines",
            value: function() {
            ...
            value: function() {
                var t = this;
                return d.default.dispatchEvent(e.Events.ACTIVE),
                this.timelines.hide.kill(),
                new Promise(function(e, n) {
                    t.timelines.show.eventCallback("onComplete", e),
                    t.timelines.show.restart(!0, !1),
                    P.default.trackInteraction("LandscapeScreen", "show")
                }
                )
            }
        }, {
            ...
            value: function() {
                var t = this;
                return d.default.dispatchEvent(e.Events.NOT_ACTIVE),
                this.timelines.show.kill(),
                new Promise(function(e, n) {
                    t.timelines.hide.eventCallback("onComplete", e),
                    t.timelines.hide.restart(!0, !1),
                    P.default.trackInteraction("LandscapeScreen", "hide")
                }
                )
            }
        }, {
            key: "onResize",
            value: function() {
                window.innerWidth > window.innerHeight && window.APP.isMobile ? this.isActive || (this.isActive = !0,
                this.isFirstRouterUpdate || this.show()) : this.isActive && (this.isActive = !1,
                this.isFirstRouterUpdate || this.hide())
            }
        }, {
            key: "onRouterUpdate",
            value: function() {
                this.isFirstRouterUpdate && (this.isFirstRouterUpdate = !1,
...
, , , , , , , , , , , , , , , , , , , , , , , , function(t, e, n) {
    ...
    var i = n(21)
      ...
      , r = n(20);
    t.exports = function(t) {
        for (var e = i(this), n = r(e.length), s = arguments.length, a = o(s > 1 ? arguments[1] : void 0, n), u = s > 2 ? arguments[2] : void 0, c = void 0 === u ? n : o(u, n); c > a; )
            e[a++] = t;
        return e
    }
}
...
, function(t, e, n) {
    ...
    t.exports = function(t, e, n, y, w, x, b) {
        ...
        }, E = e + " Iterator", T = w == m, _ = !1, A = t.prototype, L = A[h] || A[d] || w && A[w], $ = L || k(w), C = w ? T ? k("entries") : $ : void 0, S = "Array" == e ? A.entries || L : L;
        if (S && (O = f(S.call(new t)),
        O !== Object.prototype && (l(O, E, !0),
        i || a(O, h) || s(O, h, g))),
        T && L && L.name !== m && (_ = !0,
        $ = function() {
            return L.call(this)
...
, function(t, e, n) {
    ...
    t.exports = {
        set: Object.setPrototypeOf || ("__proto__"in {} ? function(t, e, i) {
            try {
                i = n(53)(Function.call, n(33).f(Object.prototype, "__proto__").set, 2),
                i(t, []),
...
, function(t, e, n) {
    ...
    t.exports = function(t) {
        return function(e, n) {
            var r, s, a = String(o(e)), u = i(n), c = a.length;
            return u < 0 || u >= c ? t ? "" : void 0 : (r = a.charCodeAt(u),
            r < 55296 || r > 56319 || u + 1 === c || (s = a.charCodeAt(u + 1)) < 56320 || s > 57343 ? t ? a.charAt(u) : r : t ? a.slice(u, u + 2) : (r - 55296 << 10) + (s - 56320) + 65536)
        }
    }
}
, function(t, e, n) {
...
, function(t, e, n) {
    var i, o, r, s = n(53), a = n(110), u = n(155), c = n(152), l = n(8), f = l.process, h = l.setImmediate, p = l.clearImmediate, d = l.MessageChannel, v = 0, m = {}, g = "onreadystatechange", y = function() {
        var t = +this;
...
, function(t, e, n) {
    ...
    var i = n(8)
      ...
      , N = o ? "_o" : I
      , R = function(t, e, n) {
        var i, o, r, s = Array(n), a = 8 * n - e - 1, u = (1 << a) - 1, c = u >> 1, l = 23 === e ? A(2, -24) - A(2, -77) : 0, f = 0, h = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
        for (t = _(t),
        t != t || t === E ? (o = t != t ? 1 : 0,
        i = u) : (i = L($(t) / C),
        t * (r = A(2, -i)) < 1 && (i--,
        r *= 2),
        t += i + c >= 1 ? l / r : l * A(2, 1 - c),
        t * r >= 2 && (i++,
        r /= 2),
        i + c >= u ? (o = 0,
        i = u) : i + c >= 1 ? (o = (t * r - 1) * A(2, e),
        i += c) : (o = t * A(2, c - 1) * A(2, e),
        i = 0)); e >= 8; s[f++] = 255 & o,
        o /= 256,
        e -= 8)
            ;
      ...
      , B = function(t, e, n) {
        var i, o = 8 * n - e - 1, r = (1 << o) - 1, s = r >> 1, a = o - 7, u = n - 1, c = t[u--], l = 127 & c;
      ...
      , X = function(t, e, n, i, o, r) {
        ...
        if (s != a || a < 0 || a + e > t[U])
            throw k(b);
        for (var u = t[j]._b, c = a + t[N], l = i(+o), h = 0; h < e; h++)
            u[c + h] = l[r ? h : e - h - 1]
    }
      , K = function(t, e) {
        l(t, P, g);
    ...
    if (s.ABV) {
        if (!c(function() {
            ...
            ;
            for (var J, Q = P[w] = T[w], Z = p(T), tt = 0; Z.length > tt; )
                (J = Z[tt++])in P || a(P, J, T[J]);
            r || (Q.constructor = P)
        }
        ...
        !et.getInt8(0) && et.getInt8(1) || u(M[w], {
...
, function(t, e, n) {
    ...
    e.startListener = function(t) {
        ...
        (0,
        o.addEventListener)(window, u, e);
        var n = function() {
            return t(h())
        };
        return l && (0,
        o.addEventListener)(window, c, n),
        function() {
            (0,
            o.removeEventListener)(window, u, e),
            l && (0,
            o.removeEventListener)(window, c, n)
        }
    }
    ,
    function(t, e) {
      ...
      , l = function() {
        var t = arguments.length <= 0 || void 0 === arguments[0] ? {} : arguments[0]
          ...
          , y = function(t) {
            var e = g();
            h = t,
            h.action === u.PUSH ? m = [].concat(m.slice(0, e + 1), [h.key]) : h.action === u.REPLACE && (m[e] = h.key),
          ...
          , b = function(t, e) {
            (0,
            o.loopAsync)(d.length, function(e, n, i) {
                (0,
          ...
          , P = function(t) {
            h && (0,
            c.locationsAreEqual)(h, t) || p && (0,
            c.locationsAreEqual)(p, t) || (p = t,
            b(t, function(e) {
                if (p === t)
                    if (p = null,
                    e) {
                        if (t.action === u.PUSH) {
                            ...
                            r.createPath)(t);
                            o === n && (0,
                            c.statesAreEqual)(h.state, t.state) && (t.action = u.REPLACE)
                        }
...
, , , , function(t, e, n) {
    "use strict";
    function i(t) {
        u(this, "_onWheel", "_onMouseWheel", "_onTouchStart", "_onTouchMove", "_onKeyDown"),
        this.el = window,
        t && t.el && (this.el = t.el,
        delete t.el),
        this.options = o({
...
, function(t, e, n) {
    ...
    t.exports = {
        ...
        def: function(t, e, n) {
            var i = o(r(e), !0);
            return i === !0 ? d(t).set(e, n) : i[t._i] = n,
            t
        },
        ufstore: d
    }
...
, function(t, e, n) {
    ...
    t.exports = !u || n(10)(function() {
        ...
        for (var n = s(t), u = arguments.length, c = 1, l = o.f, f = r.f; u > c; )
            for (var h, p = a(arguments[c++]), d = l ? i(p).concat(l(p)) : i(p), v = d.length, m = 0; v > m; )
...
, function(t, e, n) {
    ...
    t.exports = function(t) {
        return function(e) {
            for (var n, s = o(e), a = i(s), u = a.length, c = 0, l = []; u > c; )
                r.call(s, n = a[c++]) && l.push(t ? [n, s[n]] : s[n]);
            return l
        }
    }
}
...
, function(t, e, n) {
    "use strict";
    var i, o = n(43)(0), r = n(28), s = n(57), a = n(200), u = n(194), c = n(11), l = s.getWeak, f = Object.isExtensible, h = u.ufstore, p = {}, d = function(t) {
        return function() {
            return t(this, arguments.length > 0 ? arguments[0] : void 0)
        }
    }, v = {
    ...
    7 != (new m).set((Object.freeze || Object)(p), 7).get(p) && (i = u.getConstructor(d),
    a(i.prototype, v),
    s.NEED = !0,
    ...
    e.saveState = function(t, e) {
        if (window.sessionStorage)
            try {
                ...
                if (s[t.name])
                    return;
                if (r[t.name] && 0 === window.sessionStorage.length)
                    return;
                throw t
            }
    }
    ...
    : function(t) {
      ...
      , l = function() {
        ...
        return s(t, [{
            ...
            key: "set",
            value: function(e, n) {
                return "string" == typeof e ? (c.setItem(e, n),
                u.default.dispatchEvent(t.Events.UPDATE, {
                    key: e,
                    value: n
    ...
    n(35))
      ...
      , $ = function(t) {
        function e() {
            ...
            return t.currentDelta = 0,
            t.currentVisiblePart = 0,
            (0,
            O.default)(t),
            t.preload().then(t.setup.bind(t)),
            t
        ...
        u(e, [{
            ...
            value: function() {
                ...
                return new Promise(function(e, n) {
                    y.default.loadAll([{
                        ...
                        if (t.$contentImages = n.slice(0, 4),
                        t.waveShowFactor = 1,
                        window.APP.isMobile) {
            ...
            key: "setupDOMNodes",
            value: function() {
                this.$partContainers = DOMUtils.q(".part-container", this.$node),
                this.$partIndicators = DOMUtils.q(".part-indicator li", this.$node),
                this.$scrollIndicatorBar = DOMUtils.q(".scroll-indicator .bar", this.$node),
                this.$logoPart = DOMUtils.q(".logo-container", this.$node),
                this.$logoBackground = DOMUtils.q(".background", this.$logoPart),
                this.$logo = DOMUtils.q("svg.logo-minimal", this.$logoPart),
                this.$logoScrollIndicator = DOMUtils.q(".scroll-indicator", this.$logoPart),
                this.$logoScrollIndicatorBar = DOMUtils.q(".scroll-indicator .bar", this.$logoPart),
                this.$logoScrollIndicatorText = DOMUtils.q(".scroll-indicator .text", this.$logoPart),
                this.$whoPart = DOMUtils.q(".who-container", this.$node),
                this.$whoHeadline = DOMUtils.q("h2", this.$whoPart),
                this.$whoText = DOMUtils.q("p", this.$whoPart),
                this.$whatPart = DOMUtils.q(".what-container", this.$node),
                this.$whatHeadline = DOMUtils.q("h2", this.$whatPart),
                this.$whatText = DOMUtils.q("p", this.$whatPart),
                this.$awardsPart = DOMUtils.q(".awards-container", this.$node),
                this.$awardsHeadline = DOMUtils.q("h2", this.$awardsPart),
                this.$awardsText = DOMUtils.q("p", this.$awardsPart),
                this.$awardsList = DOMUtils.q(".award-list", this.$awardsPart),
                this.$awardsElements = DOMUtils.q("li", this.$awardsPart),
                this.$clientPart = DOMUtils.q(".client-container", this.$node),
                this.$clientHeadline = DOMUtils.q("h2", this.$clientPart),
                this.$clientText = DOMUtils.q("p", this.$clientPart),
                this.$clientRow = DOMUtils.q(".client-list tr", this.$clientPart),
                this.$clientElements = DOMUtils.q(".client-list td", this.$clientPart)
            }
        }, {
            key: "setupTimelines",
            value: function() {
            ...
            value: function() {
                ...
                v.default.addEventListener(b.Events.OPEN_MENU, this.onOpenMenu),
                v.default.addEventListener(b.Events.CLOSE_MENU, this.onCloseMenu),
                this.virtualScroll = new f.default({
                    limitInertia: !1,
                    mouseMultiplier: 1,
                    touchMultiplier: 5,
            ...
            value: function() {
                ...
                new Promise(function(e, n) {
                    ...
                    t.timelines.hide.restart(!0, !1),
                    t.hideCurrentPart(),
                    t.virtualScroll.off(t.onScroll),
                    t.currentVisiblePart = 0
                }
                )
            }
            ...
            value: function() {
                ...
                return new Promise(function(n, i) {
                    (!window.APP.isMobile && !t.showPartTimelines[t.currentVisiblePart].isActive() || window.APP.isMobile && !t.showNextPartTimelines[t.currentVisiblePart].isActive() && !t.showPrevPartTimelines[t.currentVisiblePart].isActive()) && (t.currentVisiblePart > 0 && !window.APP.isMobile ? !function() {
                        var e = function t() {
                            v.default.removeEventListener(P.Events.WAVEFADE_SHOW_DONE, t),
                            n()
                        };
                        v.default.addEventListener(P.Events.WAVEFADE_SHOW_DONE, e),
                    ...
                    window.APP.isMobile ? e ? t.showNextPartTimelines[t.currentVisiblePart].restart(!0, !1) : t.showPrevPartTimelines[t.currentVisiblePart].restart(!0, !1) : t.showPartTimelines[t.currentVisiblePart].restart(!0, !1),
                    t.highlightCurrrentPartIndicator(),
                    _.default.trackInteraction("About", "show", t.currentVisiblePart))
                }
                )
            }
        }, {
            ...
            value: function() {
                ...
                return new Promise(function(n, i) {
                    (!window.APP.isMobile && !t.hidePartTimelines[t.currentVisiblePart].isActive() || window.APP.isMobile && !t.hideNextPartTimelines[t.currentVisiblePart].isActive() && !t.hidePrevPartTimelines[t.currentVisiblePart].isActive()) && (t.currentVisiblePart > 0 && !window.APP.isMobile ? !function() {
                        var e = function t() {
                            v.default.removeEventListener(P.Events.WAVEFADE_HIDE_DONE, t),
                            n()
                        };
                        v.default.addEventListener(P.Events.WAVEFADE_HIDE_DONE, e),
                    ...
                    window.APP.isMobile ? e ? t.hideNextPartTimelines[t.currentVisiblePart].restart(!0, !1) : t.hidePrevPartTimelines[t.currentVisiblePart].restart(!0, !1) : t.hidePartTimelines[t.currentVisiblePart].restart(!0, !1),
                    t.unhighlightCurrentPartIndicator())
                }
                )
            }
        }, {
            ...
            value: function() {
                ...
                return new Promise(function(e, n) {
                    t.currentVisiblePart < t.$partContainers.length - 1 ? t.hideCurrentPart(!0).then(function() {
                        t.currentVisiblePart++,
                        t.showCurrentPart(!0).then(function() {
                            e()
                        })
                    }) : e()
                }
            ...
            value: function() {
                ...
                return new Promise(function(e, n) {
                    t.currentVisiblePart > 0 ? t.hideCurrentPart(!1).then(function() {
                        t.currentVisiblePart--,
                        t.showCurrentPart(!1).then(function() {
                            e()
                        })
                    }) : e()
                }
            ...
            value: function(t) {
                var e = this
                  , n = t.page;
                this.isActive || n !== A || (console.log("WAIT FOR OUT -> ABOUT"),
                v.default.addEventListener(h.Events.CURR_OUT, this.onSectionCurrOut)),
                this.isActive && n !== A && this.hide().then(function() {
                    e.isActive = !1,
                    v.default.dispatchEvent(h.Events.CURR_OUT)
                })
            }
        }, {
            key: "onSectionCurrOut",
            value: function() {
                v.default.removeEventListener(h.Events.CURR_OUT, this.onSectionCurrOut),
                this.isActive = !0,
                this.show()
            }
        }, {
            ...
            value: function(t) {
                var e = this;
                this.ignoreScroll || (this.currentDelta += t.deltaY,
                Math.abs(this.currentDelta) > L && (this.ignoreScroll = !0,
                this.currentDelta > 0 ? this.showPrevPart().then(function() {
                    e.ignoreScroll = !1
            ...
            value: function(t) {
                ...
                !e && this.isActive || this.isActive && e && n === A ? TweenMax.to(this.$node, .2, {
                    autoAlpha: 1
                }) : this.isActive && e && n !== A && (this.isActive = !1,
                this.timelines.hide.progress(1, !1))
            }
        }]),
        e
    }(p.default);
...
, function(t, e, n) {
    ...
    e.setupMobileTimelines = function(t) {
        t.showNextPartTimelines = [],
        t.showPrevPartTimelines = [];
        ...
        t.showNextPartTimelines.push(e),
        t.showPrevPartTimelines.push(e);
        ...
        t.showNextPartTimelines.push(n),
        t.showPrevPartTimelines.push(i);
        ...
        t.showNextPartTimelines.push(o),
        t.showPrevPartTimelines.push(r);
        var s = new TimelineMax({
            paused: !0,
            immediateRender: !1
        });
        ...
        t.showNextPartTimelines.push(s),
        t.showPrevPartTimelines.push(a);
        ...
        t.showNextPartTimelines.push(u),
        t.showPrevPartTimelines.push(c),
        t.hideNextPartTimelines = [],
        t.hidePrevPartTimelines = [];
        ...
        t.hideNextPartTimelines.push(l),
        t.hidePrevPartTimelines.push(l);
        ...
        t.hideNextPartTimelines.push(f),
        t.hidePrevPartTimelines.push(f);
        ...
        t.hideNextPartTimelines.push(h),
        t.hidePrevPartTimelines.push(h);
        ...
        t.hideNextPartTimelines.push(p),
        t.hidePrevPartTimelines.push(p);
        ...
        t.hideNextPartTimelines.push(d),
        t.hidePrevPartTimelines.push(d)
    }
    ,
          ...
          , u = function(e) {
            ...
            s(n, [{
                ...
                value: function() {
                    ...
                    this.camera = new t.OrthographicCamera(this.width / -2,this.width / 2,this.height / 2,this.height / -2,-1e4,1e4),
        ...
        var s = function() {
          ...
          , l = function(e) {
            ...
            s(n, [{
                key: "setup",
                value: function() {
                    this.texture = new t.Texture(this.$image),
                    this.texture.magFilter = t.LinearFilter,
                    this.texture.minFilter = t.LinearFilter,
                    this.texture.needsUpdate = !0,
                    this.geo = new t.PlaneBufferGeometry(this.$image.width,this.$image.height,100,100),
                ...
                value: function() {
                    var t = this;
                    return console.log("WAVEFADE: fade in"),
                    new Promise(function(e, n) {
                        var i = new TimelineMax({
                            onComplete: function() {
                                console.log("WAVEFADE: fade in done"),
                                e()
                            }
                        });
    ...
    n(35))
      ...
      , O = function(t) {
        ...
        a(e, [{
            ...
            key: "setupDOMNodes",
            value: function() {
                this.$textContainer = DOMUtils.q(".text-container", this.$node),
                this.$background = DOMUtils.q(".background", this.$node),
                this.$textLines = DOMUtils.q(".text-container > div", this.$node),
                this.$links = DOMUtils.q("a", this.$node),
                this.$reverseTextLines = Array.prototype.slice.call(this.$textLines, 0).reverse()
            }
        }, {
            key: "setupAnimations",
            value: function() {
                ...
                this.waveFade = new WaveFade(this.$textContainer),
                TweenMax.set(this.$node, {
                    autoAlpha: 0
                })
            }
            ...
            value: function() {
                ...
                h.default.addEventListener(m.Events.OPEN_MENU, this.onOpenMenu),
                h.default.addEventListener(m.Events.CLOSE_MENU, this.onCloseMenu),
                DOMUtils.on(this.$links, "mouseenter", this.onLinksEnter),
                DOMUtils.on(this.$links, "mouseleave", this.onLinksLeave),
                DOMUtils.on(this.$links, "click", this.onLinksClick)
            }
        }, {
            key: "show",
            value: function() {
            ...
            value: function(t) {
                var e = this
                  , n = t.page;
                this.isActive || n !== M || (console.log("WAIT FOR OUT -> CONTACT"),
                h.default.addEventListener(c.Events.CURR_OUT, this.onSectionCurrOut)),
                this.isActive && n !== M && this.hide().then(function() {
                    e.isActive = !1,
                    h.default.dispatchEvent(c.Events.CURR_OUT)
                })
            }
            ...
            value: function(t) {
                ...
                !e && this.isActive || this.isActive && e && n === M ? TweenMax.to(this.$node, .5, {
                    autoAlpha: 1
                }) : this.isActive && e && n !== M && (this.isActive = !1,
                this.timelines.hide.progress(1, !1))
            }
        }, {
            key: "linkEnter",
    ...
    n(32))
      ...
      , M = function(t) {
        function e() {
            ...
            return t.isDark = DOMUtils.hasClass(document.body, "dark-mode"),
            t.isActive = !0,
            t.width = 0,
            t.height = 0,
            t.hideObj = {
            ...
            t.currentPer = 0,
            t.targetPer = 0,
            t.fontSize = 22 * window.devicePixelRatio,
            t.gridSize = window.devicePixelRatio,
            t.gridGap = 9 * window.devicePixelRatio,
            t.gridOffset = {
                x: 0,
                y: 0
            },
            t.rows = [],
            t.imageRows = [],
            t.imageBoxWidth = window.APP.isMobile ? .8 * window.innerWidth * window.devicePixelRatio : 390 * window.devicePixelRatio,
            t.imageBoxHeight = window.APP.isMobile ? t.imageBoxWidth / (390 * window.devicePixelRatio) * 120 * window.devicePixelRatio : 120 * window.devicePixelRatio,
        ...
        a(e, [{
            key: "setup",
            value: function() {
                this.colors = this.isDark ? P.DARK : P.LIGHT,
                this.setupLogo(),
                this.setupDOMNodes(),
                this.onResize(),
                this.setupTimelines(),
            ...
            value: function() {
                ...
                this.$logo.onload = function() {
                    t.logoWidth = t.$logo.width,
                    t.logoHeight = t.$logo.height,
                    t.logoOutputWidth = 120 * window.devicePixelRatio,
                    t.logoOutputHeight = t.logoHeight * (120 * window.devicePixelRatio / t.$logo.width)
                }
                ,
            ...
            key: "setupDOMNodes",
            value: function() {
                this.$canvas = DOMUtils.q("canvas", this.$node),
            ...
            value: function() {
                this.onResize = (0,
                w.default)(this.onResize, 100)
            }
        }, {
            key: "setupListeners",
            value: function() {
                DOMUtils.on(window, "resize", this.onResize),
                h.default.addEventListener(v.Events.UPDATE, this.onLoaderUpdate),
                h.default.addEventListener(p.Events.UPDATE, this.onRouterUpdate)
            }
        }, {
            key: "show",
            ...
            value: function() {
                ...
                new Promise(function(e, n) {
                    t.timelines.hide.eventCallback("onComplete", e),
                    t.timelines.hide.restart(!0, !1),
                    b.default.trackInteraction("Preloader", "stats", "Done", Math.round((+new Date - t.startTime) / 1e3))
                }
                )
            }
        }, {
            ...
            value: function() {
                ...
                this.$canvas.height = this.height = window.innerHeight * window.devicePixelRatio,
                this.$canvas.style.width = window.innerWidth + "px",
                this.$canvas.style.height = window.innerHeight + "px",
                this.fontSize = 22 * window.devicePixelRatio,
                this.gridOffsetX = Math.ceil(this.width / 2 - this.imageBoxWidth / 2),
                this.gridOffsetY = Math.ceil(this.height / 2 - this.imageBoxHeight / 2);
                for (var t = Math.round(10 * window.devicePixelRatio), e = 0, n = this.imageBoxHeight / t - 1; e < n; e++)
                    "undefined" == typeof this.rows[e] ? this.rows[e] = {
                        progress: 0,
                        y: Math.floor(e * t)
            ...
            value: function() {
                ...
                d.default.init()),
                this.isActive && requestAnimationFrame(this.render.bind(this)),
                this.currentPer += Math.round(Math.random()),
                this.currentPer = Math.min(100, Math.min(this.currentPer, this.targetPer)),
                this.ctx.clearRect(0, 0, this.width, this.height),
                this.ctx.globalCompositeOperation = "source-over",
                this.currentPer >= 100 && (this.ctx.globalAlpha = 1 - Math.max(0, this.hideObj.bar - .99) / .01);
                ...
                for (var e = 0; e < this.rows.length; e++) {
                    ...
                    this.ctx.fillRect(this.gridOffsetX, n.y + this.gridOffsetY, o, t)
                }
                if (this.ctx.globalCompositeOperation = "source-atop",
                this.ctx.font = this.fontSize + "px DINNextLTPro",
                this.ctx.textAlign = "center",
                this.ctx.textBaseline = "middle",
                this.ctx.fillStyle = this.colors.overlay,
                this.ctx.fillText(Math.floor(this.currentPer), this.width / 2, this.height / 2),
                this.ctx.globalCompositeOperation = "destination-over",
                this.ctx.globalAlpha = this.showObj.logo,
                this.ctx.drawImage(this.$logo, this.width / 2 - this.logoOutputWidth / 2, this.height / 2 - this.logoOutputHeight / 2, this.logoOutputWidth, this.logoOutputHeight),
                ...
                this.currentPer >= 100) {
                    ...
                    this.ctx.moveTo(this.gridOffsetX, this.gridOffsetY),
                    this.ctx.lineTo(r, this.gridOffsetY),
                    this.ctx.lineTo(r, s),
                    this.ctx.lineTo(this.gridOffsetX, s),
                    this.ctx.fill()
                }
            }
        }, {
    ...
    n(103))
      ...
      , D = function(t) {
        ...
        u(e, [{
            ...
            value: function() {
                ...
                return new Promise(function(e, i) {
                    y.default.loadAll([{
                        ...
                        t.projectData = i[0].projects,
                        t.projectData.forEach(function(e) {
            ...
            key: "setupDOMNodes",
            value: function() {
                this.$projectContainer = DOMUtils.q(".project-container", this.$node),
                this.$contentContainer = DOMUtils.q(".content-container", this.$node),
                this.$projectMask = DOMUtils.q(".project-mask", this.$node),
                this.$randomContainer = DOMUtils.q(".random-container", this.$node),
                this.$nextButton = DOMUtils.q(".next-button", this.$node),
                this.$nextThumbMask = DOMUtils.q(".thumb-mask", this.$nextButton),
                this.$nextThumb = DOMUtils.q(".thumb", this.$nextButton),
                this.$nextProjectTitle = DOMUtils.q(".project-title", this.$nextButton),
                this.$nextLine = DOMUtils.q(".line", this.$nextButton),
                this.$nextSVG = DOMUtils.q("svg", this.$nextButton),
                this.$nextCanvas = DOMUtils.q("canvas", this.$nextButton),
                this.nextContext = this.$nextCanvas.getContext("2d"),
                this.$prevButton = DOMUtils.q(".prev-button", this.$node),
                this.$prevThumbMask = DOMUtils.q(".thumb-mask", this.$prevButton),
                this.$prevThumb = DOMUtils.q(".thumb", this.$prevButton),
                this.$prevProjectTitle = DOMUtils.q(".project-title", this.$prevButton),
                this.$prevLine = DOMUtils.q(".line", this.$prevButton),
                this.$prevSVG = DOMUtils.q("svg", this.$prevButton),
                this.$prevCanvas = DOMUtils.q("canvas", this.$prevButton),
                this.prevContext = this.$prevCanvas.getContext("2d"),
                this.$backButton = DOMUtils.q(".back-button", this.$node),
                this.$backButtonMask = DOMUtils.q(".mask", this.$backButton),
                this.$visitButton = DOMUtils.q(".site-button", this.$node),
                this.$visitButtonMask = DOMUtils.q(".button-mask", this.$visitButton)
            }
        }, {
            key: "setupContentDOMNodes",
            value: function() {
                this.$textContainer = DOMUtils.q(".text-container", this.$node),
                this.$headline = DOMUtils.q("h2", this.$textContainer),
                this.$clientBox = DOMUtils.q(".client-box", this.$textContainer),
                this.$serviceBox = DOMUtils.q(".services-box", this.$textContainer),
                this.$partnerBox = DOMUtils.q(".partners-box", this.$textContainer),
                this.$storyBox = DOMUtils.q(".story-box", this.$textContainer),
                this.$headlines = DOMUtils.q(".headline-container", this.$node),
                this.$videoContainer = DOMUtils.q(".video-container", this.$node),
                this.$imageContainer = DOMUtils.q(".image-container", this.$node)
            }
        }, {
            key: "setupSizes",
            value: function() {
                var t = this;
                if (this.$positionSortedMedia = [],
                this.$videoContainer.length && this.$videoContainer.length > 0)
                    Array.prototype.slice.call(this.$videoContainer, 0).forEach(function(e) {
            ...
            value: function() {
                ...
                p.default.addEventListener(d.Events.UPDATE, this.onRouterUpdate),
                p.default.addEventListener(m.Events.TICK, this.onTick),
                p.default.addEventListener(w.Events.OPEN_MENU, this.onOpenMenu),
                p.default.addEventListener(w.Events.CLOSE_MENU, this.onCloseMenu),
                DOMUtils.on(window, "resize", this.onResize),
                window.APP.isMobile || (DOMUtils.on([this.$nextButton, this.$prevButton], "mouseenter", this.onNextPrevMouseEnter),
                DOMUtils.on([this.$nextButton, this.$prevButton], "mouseleave", this.onNextPrevMouseLeave),
                DOMUtils.on(this.$backButton, "mouseenter", this.onBackEnter),
                DOMUtils.on(this.$backButton, "mouseleave", this.onBackLeave),
                DOMUtils.on(this.$visitButton, "mouseenter", this.onVisitEnter),
                DOMUtils.on(this.$visitButton, "mouseleave", this.onVisitLeave)),
                DOMUtils.on([this.$nextButton, this.$prevButton], "click", this.onNextPrevClick),
                DOMUtils.on(this.$backButton, "click", this.onBackClick)
            }
        }, {
            key: "setupContent",
            value: function(t) {
            ...
            value: function() {
                ...
                [].concat(this.$videoContainer).forEach(function(e) {
                    DOMUtils.on(e, "click", t.onVideoContainerClick),
                    DOMUtils.on(e, "mouseenter", t.onVideoContainerEnter),
                    DOMUtils.on(e, "mouseleave", t.onVideoContainerLeave)
                })
            }
        }, {
            key: "updateTimelines",
            ...
            value: function() {
                ...
                this.$nextCanvas.width = e * i,
                this.$nextCanvas.height = n * i,
                this.$prevCanvas.width = e * i,
                this.$prevCanvas.height = n * i;
                var o = this.nextContext;
                o.strokeStyle = "#fff",
                o.lineWidth = 2 * i,
                o.beginPath(),
                o.moveTo(2 * i, 2 * i),
                o.lineTo((e - 2) * i, n / 2 * i),
                o.lineTo(2 * i, (n - 2) * i),
                o.lineTo(2 * i, 2 * i),
                o.closePath(),
                o.stroke();
            ...
            value: function() {
                ...
                new Promise(function(n, i) {
                    t.timelines.show.eventCallback("onComplete", function() {
                        "undefined" != typeof t.currentMouseTarget,
                        n()
                    }),
                    t.timelines.show.restart(!0, !1),
                    e ? TweenMax.from(t.$headline, .3, {
                        autoAlpha: 0,
                        y: "+=20px",
                        ease: Power2.easeOut
            ...
            value: function(t) {
                ...
                !this.isActive && i >= 0 && (console.log("WAIT FOR OUT -> PROJECT"),
                this.setupContent(i).then(function() {
                    p.default.dispatchEvent(l.Events.CONTENT_READY, e.$node),
                    p.default.addEventListener(l.Events.CURR_OUT, e.onSectionCurrOut)
                })),
                this.isActive && i < 0 && this.hide().then(function() {
                    e.isActive = !1,
                    e.$projectMask.scrollTop = 0,
                    e.currentDelta = 0,
                    e.targetDelta = 0,
                    p.default.dispatchEvent(l.Events.CURR_OUT)
                }),
                this.isActive && i >= 0 && this.currentIndex !== i && (this.timelines.gatherMenu.pause(),
                this.timelines.gatherMenu.reverse(),
                this.isActive = !1,
                this.$projectMask.scrollTop = 0,
                this.currentDelta = 0,
                this.targetDelta = 0,
                this.setupContent(i).then(function() {
                    e.isSwitchingProject = !1,
                    e.isActive = !0,
                    e.show(!0)
                }))
            }
            ...
            key: "onTick",
            value: function() {
                if (this.isActive && !this.isSwitchingProject && (this.currentDelta += .1 * (this.targetDelta - this.currentDelta),
                this.$projectMask.scrollTop !== this.currentDelta)) {
                    this.checkViewportMedia(),
                    this.$projectMask.scrollTop = -this.currentDelta;
                    ...
                    if (!(n < o) || this.areControllsAnimating || this.areControllsGathered || t || this.timelines.gatherMenu.isActive()) {
                        if (n > o && this.areControllsGathered && t && !this.timelines.gatherMenu.isActive() && (this.timelines.gatherMenu.pause(),
                        this.timelines.gatherMenu.reverse(),
                        "undefined" != typeof this.currentMouseTarget)) {
                            ...
                            this.currentMouseTarget.isSameNode(r) && (this.currentMouseTarget = void 0)
                        }
                    } else
                        this.timelines.gatherMenu.restart(!0, !1)
                }
            }
        }, {
            key: "onScroll",
            ...
            value: function() {
                ...
                if (this.isActive) {
                    ...
                    Array.prototype.slice.call(this.$imageContainer, 0).forEach(function(e, n) {
                        ...
                        t.$positionSortedMedia[n].height = r.height,
                        t.$positionSortedMedia[n].top = r.top,
                        t.$positionSortedMedia[n].isVisible) {
            ...
            value: function(t) {
                ...
                n.src = n.src,
                n.isPlaying = !1,
                window.APP.isIOS || TweenMax.to(i, .3, {
                    autoAlpha: .5,
                    ease: Power2.easeOut
                })) : (n.play(),
                window.APP.isIOS || (n.isPlaying = !0,
                TweenMax.to(i, .3, {
                    autoAlpha: 0,
                    ease: Power2.easeOut
                })))
            ...
            value: function(t) {
                ...
                var e = t.currentTarget
                  , n = (DOMUtils.q(".svg", e),
                DOMUtils.q(".play-button", e))
                  , i = new TimelineMax;
                i.to(n, .3, {
                    backgroundColor: "rgba(0, 0, 0, .4)",
                    ease: Power2.easeOut
                }, "start"),
                this.currentVideoLeaveTL = i
            }
        }, {
            ...
            value: function(t, e) {
                ...
                var i = new TimelineMax({
                    onComplete: function() {
                        e ? (n.isNextAnimating = !1,
                        n.isMouseOverNextButton || n.nextPrevMouseLeave(t, e)) : (n.isPrevAnimating = !1,
                        n.isMouseOverPrevButton || n.nextPrevMouseLeave(t, e))
                    }
                });
                if (this.areControllsGathered) {
                    ...
                    DOMUtils.hasClass(t, "next-button") ? i.fromTo(a, .5, {
                        x: "-20px"
                    }, {
                        x: "0",
                        ease: Expo.easeInOut
            ...
            value: function(t, e) {
                ...
                if (this.areControllsGathered) {
                    ...
                    this.currentMouseTarget && this.currentMouseTarget.isSameNode(t) && (this.currentMouseTarget = void 0)
                } else {
                    var a = DOMUtils.q(".project-title", t);
                    i.to(a, .3, {
                        autoAlpha: 0,
                    ...
                    DOMUtils.hasClass(t, "next-button") ? i.to(a, .5, {
                        x: "-20px",
                        ease: Expo.easeInOut
                    }, "start") : i.to(a, .5, {
                        x: "20px",
            ...
            value: function(t) {
                ...
                this.isMouseOverNextButton = n,
                this.isMouseOverPrevButton = !n,
                (n && !this.isNextAnimating || !n && !this.isPrevAnimating) && this.nextPrevMouseEnter(e, n)
            }
        }, {
            ...
            value: function(t) {
                var e = t.currentTarget
                  , n = DOMUtils.hasClass(e, "next-button");
                this.isMouseOverNextButton = !1,
                this.isMouseOverPrevButton = !1,
                (n && !this.isNextAnimating || !n && !this.isPrevAnimating) && this.nextPrevMouseLeave(e, n)
            }
        }, {
            key: "onNextPrevClick",
            value: function(t) {
                ...
                var a = new TimelineMax({
                    onComplete: function() {
                        e.areControllsGathered ? (e.timelines.gatherMenu.pause(),
                        e.timelines.gatherMenu.eventCallback("onReverseComplete", function() {
                            e.timelines.gatherMenu.eventCallback("onReverseComplete", function() {
                                e.areControllsGathered = !1
                            }),
                            e.areControllsGathered = !1,
                            window.APP.isMobile ? v.default.push(n.getAttribute("href")) : (TweenMax.set(e.$nextButton, {
                                right: "40px",
                                left: "auto"
                            }),
                ...
                this.areControllsGathered ? a.to(r, .3, {
                    width: 0,
                    ease: Expo.easeInOut
                }, "start").to(s, .3, {
                    width: 0,
                ...
                L.default.trackInteraction("Project", "click", "NextButton")) : (a.set(this.$projectMask, {
                    right: 0,
                    left: "auto"
                }, "start").set(this.$randomContainer, {
                    right: 0,
                ...
                L.default.trackInteraction("Project", "click", "PrevButton"))
            }
        }, {
            key: "onBackClick",
            value: function(t) {
                t.preventDefault(),
                v.default.push("/work"),
                L.default.trackInteraction("Project", "click", "BackButton")
            }
        }, {
            key: "backEnter",
            value: function() {
            ...
            key: "onBackEnter",
            value: function(t) {
                this.isMouseOverBack = !0,
                this.isBackAnimating || this.backEnter()
            }
        }, {
            key: "onBackLeave",
            value: function(t) {
                this.isMouseOverBack = !1,
                this.isBackAnimating || this.backLeave()
            }
        }, {
            key: "visitEnter",
            value: function() {
                ...
                var e = new TimelineMax({
                    onComplete: function() {
                        t.isVisitAnimating = !1,
                        t.isMouseOverVisit || t.visitLeave()
                    }
                });
            ...
            value: function() {
                ...
                var e = new TimelineMax({
                    onComplete: function() {
                        t.isVisitAnimating = !1,
                        t.isMouseOverVisit && t.visitEnter()
                    }
                });
            ...
            key: "onVisitEnter",
            value: function(t) {
                this.isMouseOverVisit = !0,
                this.isVisitAnimating || this.visitEnter()
            }
        }, {
            key: "onVisitLeave",
            value: function(t) {
                this.isMouseOverVisit = !1,
                this.isVisitAnimating || this.visitLeave()
            }
        }, {
            key: "onOpenMenu",
            value: function() {
...
, function(t, e, n) {
    ...
    e.setupMobileTimelines = function(t) {
        var e = t.timelines.gatherMenu = new TimelineMax({
            ...
            onComplete: function() {
                t.areControllsAnimating = !1,
                t.areControllsGathered = !0
            },
    ...
    e.setupDesktopTimelines = function(t) {
        ...
        e.to(n, .8, {
            ...
            onStart: function() {
                ...
                n.nextLeft = e.left,
                n.nextDiff = n.nextLeft - (window.innerWidth / 2 + 560 - e.width - 195),
                TweenMax.set(t.$nextButton, {
                    right: "auto",
                    left: n.nextLeft + "px"
                });
                var i = t.$prevButton.getBoundingClientRect();
                n.prevRight = window.innerWidth - i.right,
                n.prevDiff = n.prevRight - (window.innerWidth / 2 + 560 - i.width - 195),
      ...
      , T = function(t) {
        ...
        a(e, [{
            ...
            value: function() {
                ...
                null == t || void 0 == t || Number.isNaN(t) || (e = t + 1,
                e >= k.length && (e = 0)),
                "#landscape" === window.location.hash ? e = 0 : "#skull" === window.location.hash && (e = 1),
                DOMUtils.addClass(document.body, k[e].mode),
                this.isDark = "dark-mode" === k[e].mode,
                this.experimentIndex = e,
                f.default.set("exp-index", e)
            }
        }, {
            key: "loadExperiment",
            value: function() {
                ...
                return new Promise(function(e, i) {
                    ...
                    case 0:
                        ...
                        DOMUtils.addClass(t.$node, "landscape"),
                        DOMUtils.addClass(document.body, "landscape");
                        break;
                    case 1:
                        n.e(0, function(t) {
                            E = n(241).default,
                        ...
                        DOMUtils.addClass(t.$node, "skull"),
                        DOMUtils.addClass(document.body, "skull")
                    }
                }
                )
            }
            ...
            key: "setupDOMNodes",
            value: function() {
                this.$experimentContainer = DOMUtils.q(".experiment-container", this.$node),
                this.$footer = DOMUtils.q("footer", this.$node),
                this.$footerContent = DOMUtils.q(".content-wrapper", this.$footer),
                this.$footerLeft = DOMUtils.q(".left", this.$footerContent),
                this.$footerCenter = DOMUtils.q(".center", this.$footerContent),
                this.$footerRight = DOMUtils.q(".right", this.$footerContent),
                this.$someContainer = DOMUtils.q(".some-container", this.$node),
                this.$someLinks = DOMUtils.q("a", this.$someContainer),
                this.$experimentNumber = DOMUtils.q(".left span", this.$node),
                this.$soundButton = DOMUtils.q(".sound-button", this.$footer),
                this.$soundCanvas = DOMUtils.q("canvas", this.$soundButton),
                this.$soundText = DOMUtils.q(".text", this.$soundButton),
                TweenMax.set(this.$soundText, {
                    x: "-100%",
                    y: "-50%"
                });
                var t = this.$soundCanvas.getBoundingClientRect();
                this.$soundCanvas.width = t.width,
                this.$soundCanvas.height = t.height,
                this.soundContext = this.$soundCanvas.getContext("2d")
            }
        }, {
            key: "setupTimelines",
            value: function() {
            ...
            value: function() {
                v.default.addEventListener(m.Events.UPDATE, this.onRouterUpdate),
                v.default.addEventListener(y.Events.OPEN_MENU, this.onMenuOpen),
                v.default.addEventListener(y.Events.CLOSE_MENU, this.onMenuClose),
                v.default.addEventListener(y.Events.CLOSE_MENU, this.onMenuClose),
                v.default.addEventListener(w.Events.ACTIVE, this.onLandscapeOverlayActive),
                v.default.addEventListener(w.Events.NOT_ACTIVE, this.onLandscapeOverlayNotActive),
                DOMUtils.on(this.$someLinks, "mouseenter", this.onSomeEnter),
                DOMUtils.on(this.$someLinks, "mouseleave", this.onSomeLeave),
                DOMUtils.on(this.$soundButton, "mouseenter", this.onSoundEnter),
                DOMUtils.on(this.$soundButton, "mouseleave", this.onSoundLeave),
                DOMUtils.on(this.$soundButton, "click", this.onSoundClick)
            }
        }, {
            key: "setupExperiment",
            value: function() {
                this.experiment = new E(this.$experimentContainer,this.$footerCenter),
                window.APP.isMobile && (this.isSoundMuted = !0,
                this.soundAnim.radius = -Math.PI / 2,
                this.drawSoundButton(),
                this.experiment.mute());
            ...
            value: function() {
                var t = this;
                return this.experiment.onResize(),
                this.timelines.hide.kill(),
                new Promise(function(e, n) {
                    DOMUtils.addClass(document.body, "is-on-splash"),
                    t.drawSoundButton(),
                    t.experiment.start(),
                    t.timelines.show.eventCallback("onComplete", e),
                    t.timelines.show.restart(!0, !1)
            ...
            value: function() {
                ...
                return this.timelines.show.kill(),
                new Promise(function(e, n) {
                    DOMUtils.removeClass(document.body, "is-on-splash"),
                    t.timelines.hide.eventCallback("onComplete", function() {
                        t.experiment.stop(),
                        e()
                    }),
            ...
            value: function() {
                ...
                t.clearRect(0, 0, e, n),
                t.beginPath(),
                t.arc(e / 2, n / 2, e / 2 - 4, -Math.PI / 2, this.soundAnim.radius, this.soundAnim.direction),
                t.lineWidth = 2,
                t.strokeStyle = k[this.experimentIndex].soundColor,
                t.stroke(),
                t.globalAlpha = .3,
                t.beginPath(),
                t.arc(e / 2, n / 2, e / 2 - 4, 0, 2 * Math.PI, !1),
                t.lineWidth = 2,
                t.strokeStyle = k[this.experimentIndex].soundColor,
                t.stroke(),
                t.globalAlpha = 1
            ...
            value: function(t) {
                var e = this
                  , n = t.page;
                this.isActive || n !== O || v.default.addEventListener(h.Events.CURR_OUT, this.onSectionCurrOut),
                this.isActive && n !== O && this.hide().then(function() {
                    e.isActive = !1,
                    v.default.dispatchEvent(h.Events.CURR_OUT)
                })
            }
            ...
            key: "onMenuOpen",
            value: function() {
                this.isActive && (DOMUtils.removeClass(document.body, "is-on-splash"),
            ...
            value: function(t) {
                var e = t.wasLink;
                t.page;
                this.isActive && !e && (DOMUtils.addClass(document.body, "is-on-splash"),
            ...
            value: function() {
                ...
                var e = new TimelineMax({
                    ...
                    onComplete: function() {
                        t.isSoundAnimating = !1,
                        t.isMouseOverSound || t.soundLeave()
                    }
                });
                ...
                this.isSoundMuted ? (this.experiment.unmute(),
                this.soundAnim.direction = !1,
                e.fromTo(this.soundAnim, .5, {
                    radius: -Math.PI / 2
                }, {
                    radius: 1.5 * Math.PI,
                    ease: Power2.easeInOut
                }, "start")) : (this.experiment.mute(),
                this.soundAnim.direction = !0,
                e.fromTo(this.soundAnim, .5, {
                    radius: -2.5 * Math.PI
                }, {
                    radius: -Math.PI / 2,
            ...
            value: function() {
                ...
                var e = new TimelineMax({
                    ...
                    onComplete: function() {
                        t.isSoundAnimating = !1,
                        t.isMouseOverSound && t.soundEnter()
                    }
                });
                ...
                this.isSoundMuted ? (this.experiment.mute(),
                this.soundAnim.direction = !0,
                e.fromTo(this.soundAnim, .5, {
                    radius: -2.5 * Math.PI
                }, {
            ...
            key: "onSoundEnter",
            value: function(t) {
                this.isMouseOverSound = !0,
                this.isSoundAnimating || this.soundEnter()
            }
        }, {
            key: "onSoundLeave",
            value: function(t) {
                return this.ignoreNextSoundLeave ? void (this.ignoreNextSoundLeave = !1) : (this.isMouseOverSound = !1,
                void (this.isSoundAnimating || this.soundLeave()))
            }
        }, {
            key: "onSoundClick",
            value: function(t) {
                return t.preventDefault(),
                M.default.trackInteraction("Splash", "click", "SoundButton"),
                this.isSoundMuted = !this.isSoundMuted,
                this.isSoundMuted ? window.APP.isMobile ? (this.soundLeave(),
                this.experiment.mute()) : (TweenMax.to(this.$soundText, .4, {
                    autoAlpha: 0,
                    x: "-=20px",
                    ease: Expo.easeInOut
                }, "start"),
                this.experiment.mute()) : window.APP.isMobile ? (this.soundLeave(),
                this.experiment.unmute()) : (TweenMax.to(this.$soundText, .4, {
                    autoAlpha: 0,
                    x: "-=20px",
                    ease: Expo.easeInOut
                }, "start"),
                this.experiment.unmute()),
                this.ignoreNextSoundLeave = !0,
                !1
            }
        }, {
            key: "onLandscapeOverlayActive",
...
, function(t, e) {
    ...
    var n = e.setupUniTimelines = function(t) {
        ...
        var i = (DOMUtils.hasClass(document.body, "dark-mode") ? "#fff" : "#000",
        t.timelines.showMenu = new TimelineMax({
            paused: !0,
            immediateRender: !0
        }));
        i.set(t.$menu, {
    ...
    e.mobileMenuLinkClick = function(t, e) {
        ...
        t.deactivateMouseMove(),
        t.inMenuClickTransition = !0;
        var n = new TimelineMax({
            onComplete: function() {
                var n = e.getAttribute("href");
                t.hideMenu(!0, n),
                t.inMenuClickTransition = !1
            }
        });
...
, function(t, e, n) {
    ...
    e.setupDesktopTimelines = function(t) {
        ...
        var e = t.timelines.projectIn = new TimelineMax({
            ...
            immediateRender: !1,
            onComplete: function() {
                t.isProjectLinkAnimating = !1,
                t.isMouseOverProjectLink || t.projectLinkLeave()
            }
        });
        ...
        var n = t.timelines.projectOut = new TimelineMax({
            ...
            onComplete: function() {
                t.isProjectLinkAnimating = !1,
                t.isMouseOverProjectLink && t.projectLinkEnter()
            }
        });
        ...
        var i = t.timelines.siteIn = new TimelineMax({
            ...
            immediateRender: !1,
            onComplete: function() {
                t.isSiteLinkAnimating = !1,
                t.isMouseOverSiteLink || t.siteLinkLeave()
            }
        });
        ...
        var o = t.timelines.siteOut = new TimelineMax({
            ...
            onComplete: function() {
                t.isSiteLinkAnimating = !1,
                t.isMouseOverSiteLink && t.siteLinkEnter()
            }
        });
    ...
    e.mobileShow = function(t) {
        return t.timelines.hide.pause(),
        new Promise(function(e, n) {
            t.collapseNumberOverlay(!1),
    ...
    e.showNextMobile = function(t) {
        return new Promise(function(e, n) {
            ...
            t.projectData[i],
            Math.abs(t.currentMediaIndex - 1))
              , r = t.$images[o]
    ...
    e.showNextDesktop = function(t) {
        return new Promise(function(e, n) {
            ...
            var f = new TimelineMax({
                onComplete: function() {
                    console.log(t.isMouseOverProjectLink),
                    e()
                }
            });
            f.add("out", 0).set(c, {
                ...
                t.activeIndex = i,
                t.showCurrentProject(),
                t.updateEntryPositions(!0).then(function() {
                    t.expandNumberOverlay()
                })
            ...
            t.isMouseOverProjectLink ? f.to(t.$projectLinkLine, .4, {
                width: "100%",
                ease: Power2.easeInOut
    ...
    e.showPrevDesktop = function(t) {
        return new Promise(function(e, n) {
            ...
            f.add("out", 0).set(c, {
                ...
                t.activeIndex = i,
                t.showCurrentProject(),
                t.updateEntryPositions(!1).then(function() {
                    t.expandNumberOverlay()
                })
            }, "out+=.551").add("in", "out+=.552").set([t.$headline, t.$client, t.$projectLink, t.$siteLink], {
                y: "-20px"
    ...
    n(35))
      ...
      , $ = function(t) {
        ...
        u(e, [{
            ...
            key: "setupDOMNodes",
            value: function() {
                this.$nav = DOMUtils.q(".navigation-container", this.$node),
                this.$navParent = DOMUtils.q("ul", this.$nav),
                this.$navEntries = DOMUtils.q("li", this.$nav),
                this.lineCenterIndex = Math.floor(this.$navEntries.length / 2),
                this.$numberOverlay = DOMUtils.q(".number-overlay", this.$nav),
                this.$numberCurrent = DOMUtils.q(".number", this.$numberOverlay),
                this.$numberTotal = DOMUtils.q(".total", this.$numberOverlay),
                this.$textContainer = DOMUtils.q(".text-container", this.$node),
                this.$headline = DOMUtils.q(".text-container .headline", this.$node),
                this.$client = DOMUtils.q(".text-container .client", this.$node),
                this.$projectLink = DOMUtils.q(".text-container .project-link", this.$node),
                this.$projectLinkLine = DOMUtils.q(".line", this.$projectLink),
                this.$projectLinkDarkLine = DOMUtils.q(".dark-line", this.$projectLink),
                this.$projectLinkMask = DOMUtils.q(".link-mask", this.$siteLink),
                this.$siteLink = DOMUtils.q(".text-container .site-link", this.$node),
                this.$siteLinkLine = DOMUtils.q(".line", this.$siteLink),
                this.$siteLinkDarkLine = DOMUtils.q(".dark-line", this.$siteLink),
                this.$siteLinkMask = DOMUtils.q(".link-mask", this.$siteLink),
                this.$previewContainer = DOMUtils.q(".preview-container", this.$node),
                this.$mediaMasks = DOMUtils.q(".mask", this.$previewContainer),
                this.$videoMasks = DOMUtils.q(".mask.video", this.$previewContainer),
                this.$videos = DOMUtils.q(".mask.video video", this.$previewContainer),
                this.$imageMasks = DOMUtils.q(".mask.image", this.$previewContainer),
                this.$images = DOMUtils.q(".mask.image img", this.$previewContainer),
                this.$scrollIndicator = DOMUtils.q(".scroll-indicator-container", this.$node),
                this.$scrollUpArrow = DOMUtils.q(".up-arrow", this.$scrollIndicator),
                this.$scrollDownArrow = DOMUtils.q(".down-arrow", this.$scrollIndicator)
            }
        }, {
            key: "setupTimelines",
            value: function() {
            ...
            value: function() {
                ...
                p.default.addEventListener(d.Events.UPDATE, this.onRouterUpdate),
                p.default.addEventListener(y.Events.OPEN_MENU, this.onOpenMenu),
                p.default.addEventListener(y.Events.CLOSE_MENU, this.onCloseMenu),
                DOMUtils.on(this.$projectLink, "click", this.onProjectLinkClick),
                DOMUtils.on(this.$siteLink, "click", this.onSiteLinkClick),
                window.APP.isMobile || (DOMUtils.on(this.$previewContainer, "click", this.onPreviewClick),
                DOMUtils.on(this.$previewContainer, "mouseenter", this.onProjectLinkMouseEnter),
                DOMUtils.on(this.$previewContainer, "mouseleave", this.onProjectLinkMouseLeave),
                DOMUtils.on(this.$projectLink, "mouseenter", this.onProjectLinkMouseEnter),
                DOMUtils.on(this.$projectLink, "mouseleave", this.onProjectLinkMouseLeave),
                DOMUtils.on(this.$siteLink, "mouseenter", this.onSiteLinkMouseEnter),
                DOMUtils.on(this.$siteLink, "mouseleave", this.onSiteLinkMouseLeave))
            }
        }, {
            key: "prepFadeIn",
            value: function() {
                this.collapseNumberOverlay(!1),
                this.navEntryPositons = [];
                var t = 50;
                ...
                for (var e = this.lineCenterIndex + 1, n = this.$navEntries.length; e < n; e++)
                    t -= .5 * t,
                    TweenMax.set(this.$navEntries[e], {
                        bottom: Math.floor(t) + "%",
                        top: "auto",
                        y: "0%"
                    });
                var i = 50;
                t = 50;
                for (var o = this.lineCenterIndex - 1; o >= 0; o--)
                    i *= .5,
                    t += i,
                    TweenMax.set(this.$navEntries[o], {
                        bottom: Math.floor(t) + "%",
                        top: "auto",
                        y: "0%"
                    })
            ...
            value: function() {
                var t = this;
                return this.timelines.show.pause(),
                new Promise(function(e, n) {
                    t.vScroll.off(t.onScroll),
                    window.clearTimeout(t.videoBackgroundTimeout),
                    t.timelines.hide.eventCallback("onComplete", e),
                    t.timelines.hide.restart(!0, !1)
                }
                )
            ...
            value: function() {
                ...
                window.clearTimeout(this.videoBackgroundTimeout),
                window.APP.isMobile ? (this.currentMediaIndex = Math.abs(this.currentMediaIndex - 1),
                this.$images[this.currentMediaIndex].src = e["mobile-background"]) : "video" === e["background-type"] ? (this.currentMediaIndex = Math.abs(this.currentMediaIndex - 1),
                this.$videos[this.currentMediaIndex].src = e.background,
                window.APP.isMobile || (this.videoBackgroundTimeout = window.setTimeout(function() {
                    t.$videos[t.currentMediaIndex].play()
                }, 2e3))) : "image" === e["background-type"] && (this.currentMediaIndex = Math.abs(this.currentMediaIndex - 1),
                this.$images[this.currentMediaIndex].src = e.background),
                _.default.trackInteraction("Work", "show", this.activeIndex)
            }
        }, {
            ...
            value: function() {
                ...
                if (t) {
                    ...
                    e.to(this.$navEntries[this.lineCenterIndex], .3, {
                        width: "80px",
                        x: "0px",
                        ease: Power2.easeIn
                    }, "start"),
                    ...
                    e.to(this.$numberTotal, .3, {
                        autoAlpha: 0,
                        x: "-=15px"
                    }, "start+=.15")
                } else
                    TweenMax.set(this.$numberCurrent, {
                        autoAlpha: 0
                    }),
            ...
            value: function() {
                ...
                return new Promise(function(n) {
                    if (DOMUtils.text(t.$numberCurrent, "0" + (t.activeIndex + 1)),
                    e) {
                        var i = new TimelineMax({
                            onComplete: function() {
                                n()
            ...
            value: function(t) {
                ...
                return new Promise(function(n, i) {
                    var o = new TimelineMax({
                        onComplete: function() {
                            t ? (e.$navParent.appendChild(e.$navEntries[0]),
                            TweenMax.set(e.$navEntries[0], {
                                bottom: "0%"
                            })) : (e.$navParent.insertBefore(e.$navEntries[e.$navEntries.length - 1], e.$navEntries[0]),
                            TweenMax.set(e.$navEntries[e.$navEntries.length - 1], {
                                bottom: "99%"
                            })),
                            e.$navEntries = DOMUtils.q("li", e.$nav),
                            n()
                        }
                    })
                      , r = 50;
                    if (t) {
                        ...
                        for (var s = e.lineCenterIndex + 2, a = e.$navEntries.length; s < a; s++)
                            r -= .5 * r,
                            o.to(e.$navEntries[s], .5, {
                                ease: Power2.easeInOut,
                                bottom: Math.floor(r) + "%",
                                top: "auto",
                                y: "0%"
                        ...
                        var u = 50;
                        r = 50;
                        for (var c = e.lineCenterIndex; c >= 0; c--)
                            u *= .5,
                            r += u,
                            o.to(e.$navEntries[c], .5, {
                                ease: Power2.easeInOut,
                                bottom: Math.floor(r) + "%",
                                top: "auto",
                                y: "0%"
                        ...
                        for (var l = e.lineCenterIndex, f = e.$navEntries.length; l < f; l++)
                            r -= .5 * r,
                            o.to(e.$navEntries[l], .5, {
                                ease: Power2.easeInOut,
                                bottom: Math.floor(r) + "%",
                                top: "auto",
                                y: "0%"
                        ...
                        var h = 50;
                        r = 50;
                        for (var p = e.lineCenterIndex - 2; p >= 0; p--)
                            h *= .5,
                            r += h,
                            o.to(e.$navEntries[p], .5, {
                                ease: Power2.easeInOut,
                                bottom: Math.floor(r) + "%",
                                top: "auto",
                                y: "0%"
            ...
            value: function(t) {
                var e = this
                  , n = t.page;
                this.isActive || n !== A || (console.log("WAIT FOR OUT -> WORK"),
                p.default.addEventListener(l.Events.CURR_OUT, this.onSectionCurrOut)),
                this.isActive && n !== A && !this.ignoreNextRouterUpdate && this.hide().then(function() {
                    e.isActive = !1,
                    p.default.dispatchEvent(l.Events.CURR_OUT)
                }),
            ...
            value: function(t) {
                ...
                this.ignoreScroll || (this.currentDelta += t.deltaY,
                Math.abs(this.currentDelta) > L && (this.ignoreScroll = !0,
                this.currentDelta > 0 ? this.showPrevProject().then(function() {
                    e.ignoreScroll = !1
            ...
            value: function(t) {
                t.preventDefault(),
                p.default.addEventListener(l.Events.CONTENT_READY, this.onProjectContentReady),
                this.ignoreNextRouterUpdate = !0;
                var e = t.currentTarget.getAttribute("href");
                v.default.push(e),
                _.default.trackInteraction("Work", "click", "ProjectLink")
            }
        }, {
            key: "onPreviewClick",
            value: function(t) {
                ...
                v.default.push(e),
                _.default.trackInteraction("Work", "click", "ProjectPreview")
            }
        }, {
            ...
            value: function() {
                this.isProjectLinkAnimating = !0,
                this.timelines.projectIn.restart(!0, !1)
            }
        }, {
            key: "projectLinkLeave",
            value: function() {
                this.isProjectLinkAnimating = !0,
                this.timelines.projectOut.restart(!0, !1)
            }
        }, {
            key: "onProjectLinkMouseEnter",
            value: function(t) {
                this.isMouseOverProjectLink = !0,
                this.isProjectLinkAnimating || this.projectLinkEnter()
            }
        }, {
            key: "onProjectLinkMouseLeave",
            value: function(t) {
                this.isMouseOverProjectLink = !1,
                this.isProjectLinkAnimating || this.projectLinkLeave()
            }
        }, {
            key: "siteLinkEnter",
            value: function() {
                this.isSiteLinkAnimating = !0,
                this.timelines.siteIn.restart(!0, !1)
            }
        }, {
            key: "siteLinkLeave",
            value: function() {
                this.isSiteLinkAnimating = !0,
                this.timelines.siteOut.restart(!0, !1)
            }
        }, {
            key: "onSiteLinkMouseEnter",
            value: function(t) {
                this.isMouseOverSiteLink = !0,
                this.isSiteLinkAnimating || this.siteLinkEnter()
            }
        }, {
            key: "onSiteLinkMouseLeave",
            value: function(t) {
                this.isMouseOverSiteLink = !1,
                this.isSiteLinkAnimating || this.siteLinkLeave()
            }
        }, {
            key: "onSiteLinkClick",
            value: function(t) {
    ...
    var i = function() {
      ...
      , o = function() {
        ...
        return i(t, [{
            ...
            value: function(t, e) {
                "undefined" == typeof this.listeners[t] && (this.listeners[t] = []),
                this.listeners[t].indexOf(e) === -1 && this.listeners[t].push(e)
            }
        }, {
            ...
            value: function(t, e) {
                ...
                if (n && console.log("EventDispatcher.dispatchEvent", t, "Data:", e),
...
, function(t, e, n) {
    "use strict";
    console.log("Hey curious visitor :)"),
    console.log("Thank you for checking out our site!"),
    console.log("If you have feedback or questions or just want to talk, just hit us up on Twitter: @refreshStu"),
    console.log("We also want to thank Hello Monday, Watson, Resn, Active Theory, Ultranoir, Jam3 and all the other amazing agencies for their work and for the inspiration they give us!"),
...
, function(t, e) {
    ...
    t.exports = function(t) {
        ...
        if (0 === e.length)
            for (var r in t)
                o.call(t, r) && "function" == typeof t[r] && "[object Function]" == i.call(t[r]) && e.push(r);
...
, function(t, e, n) {
    ...
    var i = n(281)
      ...
      , r = n(26);
    t.exports = function() {
        for (var t = r(this), e = arguments.length, n = Array(e), s = 0, a = i._, u = !1; e > s; )
            (n[s] = arguments[s++]) === a && (u = !0);
        return function() {
            var i, r = this, s = arguments.length, c = 0, l = 0;
            if (!u && !s)
                return o(t, n, r);
            if (i = n.slice(),
            u)
                for (; e > c; c++)
                    i[c] === a && (i[c] = arguments[l++]);
            for (; s > l; )
                i.push(arguments[l++]);
            return o(t, i, r)
        }
...
, function(t, e, n) {
    ...
    o(o.S + o.F * !n(112)(function(t) {
        ...
        from: function(t) {
            var e, n, o, f, h = r(t), p = "function" == typeof this ? this : Array, d = arguments.length, v = d > 1 ? arguments[1] : void 0, m = void 0 !== v, g = 0, y = l(h);
            if (m && (v = i(v, d > 2 ? arguments[2] : void 0, 2)),
...
, function(t, e, n) {
    ...
    i(i.P + i.F * n(10)(function() {
        ...
        slice: function(t, e) {
            ...
            for (var o = s(t, n), c = s(e, n), l = a(c - o), f = Array(l), h = 0; h < l; h++)
                f[h] = "String" == i ? this.charAt(o + h) : this[o + h];
            return f
        }
    })
}
...
, function(t, e, n) {
    ...
    i(i.S, "Math", {
        fround: function(t) {
            ...
            return i < c ? r * l(i / c / a) * c * a : (e = (1 + a / s) * i,
            n = e - (e - i),
            n > u || n != n ? r * (1 / 0) : r * n)
        }
    })
...
, function(t, e, n) {
    ...
    i(i.S, "Math", {
        hypot: function(t, e) {
            for (var n, i, r = 0, s = 0, a = arguments.length, u = 0; s < a; )
                n = o(arguments[s++]),
                u < n ? (i = u / n,
                r = r * i * i + 1,
                u = n) : n > 0 ? (i = n / u,
...
, function(t, e, n) {
    ...
    if (!d(" 0o1") || !d("0b1") || d("+0x1")) {
        ...
        ;
        for (var x, b = n(15) ? c(v) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), P = 0; b.length > P; P++)
            o(v, x = b[P]) && !o(d, x) && f(d, x, l(v, x));
        d.prototype = m,
        m.constructor = d,
        n(28)(i, p, d)
    }
...
, function(t, e, n) {
    ...
    i(i.P + i.F * (!!a && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== (0xde0b6b3a7640080).toFixed(0)) || !n(10)(function() {
        ...
        toFixed: function(t) {
            var e, n, i, a, u = r(this, l), c = o(t), g = "", y = f;
            if (c < 0 || c > 20)
                throw RangeError(l);
            if (u != u)
                return "NaN";
            ...
            u > 1e-21)
                ...
                e > 0) {
                    ...
                    h(1 << -e, 0),
                    y = d() + s.call(f, c);
            return c > 0 ? (a = y.length,
            y = g + (a <= c ? "0." + s.call(f, c - a) + y : y.slice(0, a - c) + "." + y.slice(a - c))) : y = g + y,
            y
        }
    })
}
...
, function(t, e, n) {
    "use strict";
    var i, o, r, s = n(69), a = n(8), u = n(53), c = n(98), l = n(1), f = n(11), h = n(26), p = n(68), d = n(81), v = n(166), m = n(171).set, g = n(163)(), y = "Promise", w = a.TypeError, x = a.process, b = a[y], x = a.process, P = "process" == c(x), M = function() {}, O = !!function() {
        try {
            var t = b.resolve(1)
        ...
        if (!t._n) {
            ...
            g(function() {
                for (var i = t._v, o = 1 == t._s, r = 0, s = function(e) {
                    var n, r, s = o ? e.ok : e.fail, a = e.resolve, u = e.reject, c = e.domain;
                    try {
                        s ? (o || (2 == t._h && S(t),
                        t._h = 1),
                        s === !0 ? n = i : (c && c.enter(),
                        n = s(i),
                        c && c.exit()),
                        n === e.promise ? u(w("Promise-chain cycle")) : (r = E(n)) ? r.call(n, a, u) : a(n)) : u(i)
                    } catch (t) {
                        u(t)
                    }
                }; n.length > r; )
    ...
    l(l.S + l.F * (s || !O), y, {
        resolve: function(t) {
            if (t instanceof b && k(t.constructor, this))
                return t;
            var e = T(this)
              , n = e.resolve;
            return n(t),
...
, function(t, e, n) {
    function i(t, e, n) {
        var u, h, p = arguments.length < 4 ? t : arguments[3], d = r.f(l(t), e);
        if (!d) {
            if (f(h = s(t)))
                return i(h, e, n, p);
            d = c(0)
        }
        return a(d, "value") ? !(d.writable === !1 || !f(p)) && (u = r.f(p, e) || c(0),
        u.value = n,
        o.f(p, e, u),
    ...
    n(108)("split", 2, function(t, e, i) {
        ...
        if ("c" == "abbc"[a](/(b)*/)[1] || 4 != "test"[a](/(?:)/, -1)[u] || 2 != "ab"[a](/(?:ab)*/)[u] || 4 != "."[a](/(.?)(.?)/)[u] || "."[a](/()()/)[u] > 1 || ""[a](/.?/)[u]) {
            ...
            i = function(t, e) {
                ...
                if (!o(t))
                    return r.call(n, t, e);
                var i, a, f, h, p, d = [], v = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), m = 0, g = void 0 === e ? 4294967295 : e >>> 0, y = new RegExp(t.source,v + "g");
                for (l || (i = new RegExp("^" + y.source + "$(?!\\s)",v)); (a = y.exec(n)) && (f = a.index + a[0][u],
                !(f > m && (d.push(n.slice(m, a.index)),
                !l && a[u] > 1 && a[0].replace(i, function() {
                ...
                d[u] >= g))); )
                    y[c] === a.index && y[c]++;
                return m === n[u] ? !h && y.test("") || d.push("") : d.push(n.slice(m)),
                d[u] > g ? d.slice(0, g) : d
            }
        } else
            "0"[a](void 0, 0)[u] && (i = function(t, e) {
...
, function(t, e, n) {
    ...
    : function(t) {
      ...
      , X = function(t, e) {
        w(t);
        for (var n, i = g(e = x(e)), o = 0, r = i.length; r > o; )
            Y(t, n = i[o++], e[n]);
        return t
    }
      , K = function(t, e) {
      ...
      , Z = function(t) {
        for (var e, n = L(x(t)), i = [], r = 0; n.length > r; )
            o(R, e = n[r++]) || e == I || e == u || i.push(e);
        return i
    }
      , tt = function(t) {
        for (var e, n = t === F, i = L(n ? B : x(t)), r = [], s = 0; i.length > s; )
            !o(R, e = i[s++]) || n && !o(F, e) || r.push(R[e]);
        return r
    };
    V || ($ = function() {
        if (this instanceof $)
    ...
    n(100).f = J,
    n(114).f = tt,
    r && !n(69) && a(F, "propertyIsEnumerable", J, !0),
    d.f = function(t) {
        return H(p(t))
    }
    ),
...
, function(t, e, n) {
    ...
    i(i.P + i.U + i.F * n(10)(function() {
        ...
        slice: function(t, e) {
            ...
            for (var n = s(this).byteLength, i = a(t, n), o = a(void 0 === e ? n : e, n), r = new (f(this, h))(u(o - i)), c = new p(this), l = new p(r), d = 0; i < o; )
...
, function(t, e, n) {
    ...
    i(i.S, "Object", {
        getOwnPropertyDescriptors: function(t) {
            for (var e, n = r(t), i = s.f, u = o(n), c = {}, l = 0; u.length > l; )
                a(c, e = u[l++], i(n, e));
            return c
        }
    })
...
, function(t, e, n) {
    ...
    i(i.P, "String", {
        matchAll: function(t) {
            ...
            return i.lastIndex = r(t.lastIndex),
            new c(i,e)
        }
    })
}
...
, function(t, e, n) {
    for (var i = n(175), o = n(28), r = n(8), s = n(27), a = n(82), u = n(12), c = u("iterator"), l = u("toStringTag"), f = a.Array, h = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], p = 0; p < 5; p++) {
        var d, v = h[p], m = r[v], g = m && m.prototype;
        if (g) {
            g[c] || s(g, c, f),
            g[l] || s(g, l, v),
            a[v] = f;
...
, function(t, e, n) {
    (function(e, i) {
        !function(e, n) {
            ...
            function E(t, e) {
                t._state === rt && (t._result = e,
                t._state = st,
                0 !== t._subscribers.length && K(A, t))
            }
            function T(t, e) {
                t._state === rt && (t._state = at,
                t._result = e,
                K(k, t))
            }
            function _(t, e, n, i) {
            ...
            function A(t) {
                var e = t._subscribers
                  , n = t._state;
                if (0 !== e.length) {
                    for (var i = void 0, o = void 0, r = t._result, s = 0; s < e.length; s += 3)
                        i = e[s],
                        o = e[s + n],
                        i ? C(n, i, o, r) : o(r);
            ...
            function j(t, e) {
                ...
                this.promise[ot] || I(this.promise),
                H(e) ? (this._input = e,
                ...
                this._enumerate(),
                0 === this._remaining && E(this.promise, this._result))) : T(this.promise, U())
            }
            function U() {
            ...
            return j.prototype._enumerate = function() {
                for (var t = this.length, e = this._input, n = 0; this._state === rt && n < t; n++)
            ...
            j.prototype._settledAt = function(t, e, n) {
                var i = this.promise;
                i._state === rt && (this._remaining--,
                t === at ? T(i, n) : this._result[e] = n),
...
, function(t, e) {}
, 456, 456, 456, 456, 456, 456, 456, 456, 456, 456, function(t, e, n) {
    var i;
    !function() {
        "use strict";
        function o(t, e) {
            ...
            !o.notNeeded(t)) {
                for (var r = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], a = this, u = 0, c = r.length; u < c; u++)
                    a[r[u]] = n(a[r[u]], a);
        ...
        o.prototype.onTouchEnd = function(t) {
            ...
            "label" === i) {
                ...
                return t.timeStamp - n > 100 || a && window.top !== window && "input" === i ? (this.targetElement = null,
                !1) : (this.focus(l),
                this.sendClick(l, t),
                a && "select" === i || (this.targetElement = null,
                t.preventDefault()),
                !1);
            return !(!a || u || (o = l.fastClickScrollParent,
        ...
        o.notNeeded = function(t) {
            ...
            if (l && (i = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/),
        ...
        var i = 0
          ...
          , u = function() {
            for (var t = arguments.length, e = Array(t), i = 0; i < t; i++)
                e[i] = arguments[i];
            return o = !0,
            r ? void (a = e) : void n.apply(void 0, e)
        }
          , c = function c() {
            if (!o && (s = !0,
            !r)) {
                for (r = !0; !o && i < t && s; )
                    ...
                    e(i++, c, u);
                return r = !1,
                o ? void n.apply(void 0, a) : void (i >= t && s && (o = !0,
                n()))
            }
        };
        c()
...
, function(t, e, n) {
    ...
    n(77))
      ...
      , m = (e.startListener = function(t, e, n) {
        ...
        return o !== r && p(r),
        (0,
        a.addEventListener)(window, l, i),
        function() {
            return (0,
            a.removeEventListener)(window, l, i)
        }
    }
    ,
    function(t, e, n, i) {
        ...
        c.createPath)(t));
        void 0 !== o && (s = (0,
        c.addQueryStringValueToPath)(s, n, r),
        (0,
        u.saveState)(r, o)),
        v = t,
        i(s)
...
, function(t, e, n) {
    ...
    n(102))
      ...
      , d = function() {
        ...
        null == m ? m = v.length - 1 : m >= 0 && m < v.length ? void 0 : (0,
        a.default)(!1);
        var g = p(v)
          , y = function(t, e) {
            return g[t] = e
...
, function(t, e, n) {
    ...
    e.__esModule = !0,
    e.locationsAreEqual = e.Actions = e.useQueries = e.useBeforeUnload = e.useBasename = e.createMemoryHistory = e.createHashHistory = e.createHistory = void 0;
    var r = n(77);
...
, function(t, e, n) {
    ...
    var o = Object.assign || function(t) {
      ...
      , c = function(t) {
        ...
        return (0,
        a.addEventListener)(window, "beforeunload", e),
        function() {
            return (0,
            a.removeEventListener)(window, "beforeunload", e)
        }
    }
      , l = function(t) {
        return u.canUseDOM ? void 0 : (0,
        s.default)(!1),
        function(e) {
            var n = t(e)
              , i = []
              , r = void 0
              , s = function() {
                for (var t = void 0, e = 0, n = i.length; null == t && e < n; ++e)
                    t = i[e].call();
                return t
            }
              , a = function(t) {
    ...
    var o = Object.assign || function(t) {
      ...
      , h = function(t) {
        return function() {
            ...
            var s = function(t) {
                return t ? (null == t.query && (t.query = r(t.search.substring(1))),
                t) : t
            }
              , h = function(t, e) {
                if (null == e)
              ...
              , x = function(t) {
                ...
                return t.query && (r.query = (0,
                u.createQuery)(t.query)),
                s(r)
            };
            return o({}, n, {
...
, function(t, e) {
    (function() {
        var t;
        t = "undefined" != typeof e && null !== e ? e : this,
        t.Lethargy = function() {
            function t(t, e, n, i) {
            ...
            return t.prototype.check = function(t) {
                ...
                null != t.wheelDelta ? e = t.wheelDelta : null != t.deltaY ? e = t.deltaY * -40 : null == t.detail && 0 !== t.detail || (e = t.detail * -40),
            ...
            t.prototype.isInertia = function(t) {
                var e, n, i, o, r, s, a;
                return e = t === -1 ? this.lastDownDeltas : this.lastUpDeltas,
                null === e[0] ? t : !(this.deltasTimestamp[2 * this.stability - 2] + this.delay > Date.now() && e[0] === e[2 * this.stability - 1]) && (i = e.slice(0, this.stability),
                ...
                s = a / i.length,
                o = r / n.length,
                Math.abs(s) < Math.abs(o * this.tolerance) && this.sensitivity < Math.abs(o) && t)
            }
            ,
...
, function(t, e, n) {
    ...
    function o(t) {
        ...
        case "bracket":
            return function(t, n, i) {
                return e = /(\[])$/.exec(t),
                t = t.replace(/\[]$/, ""),
                e && void 0 !== i[t] ? void (i[t] = [].concat(i[t], n)) : void (i[t] = n)
            }
            ;
        default:
    ...
    e.parse = function(t, e) {
        ...
        Object.keys(i).sort().reduce(function(t, e) {
            var n = i[e];
            return Boolean(n) && "object" == typeof n && !Array.isArray(n) ? t[e] = s(n) : t[e] = n,
            t
...
, , , , , function(t, e, n) {
    (function(e, n) {
        !function(e) {
                    ...
                    for (; ; ) {
                        ...
                        if ("next" === r)
                            ...
                            if (i === O)
                                throw i = T,
                                s;
                            n.dispatchException(s) && (r = "next",
                            s = m)
                        } else
                            "return" === r && n.abrupt("return", s);
                        i = E;
                        var c = o(t, e, n);
                        if ("normal" === c.type) {
                            i = n.done ? T : k;
            ...
            var m, g = Object.prototype, y = g.hasOwnProperty, w = "function" == typeof Symbol ? Symbol : {}, x = w.iterator || "@@iterator", b = w.toStringTag || "@@toStringTag", P = "object" == typeof t, M = e.regeneratorRuntime;
            if (M)
                return void (P && (t.exports = M));
            M = e.regeneratorRuntime = P ? t.exports : {},
            M.wrap = i;
            ...
            a.constructor = s,
            a[b] = s.displayName = "GeneratorFunction",
            ...
            p.prototype = {
                ...
                abrupt: function(t, e) {
                    ...
                    return r.type = t,
                    r.arg = e,
                    o ? this.next = o.finallyLoc : this.complete(r),
                    _
                },
        ...
        function f() {
            ...
            this._initBody = function(t) {
                ...
                t)
                    ...
                    else if (g.arrayBuffer && g.blob && w(t))
                        this._bodyArrayBuffer = l(t.buffer),
                        this._bodyInit = new Blob([this._bodyArrayBuffer]);
                    else {
                        if (!g.arrayBuffer || !ArrayBuffer.prototype.isPrototypeOf(t) && !x(t))
