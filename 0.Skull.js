webpackJsonp([0], {
    ...
    14: function(t, e, n) {
        function i(t, e, n, i) {
            ...
            i = i || {},
            i.label = i.label || n,
            a.apply(this, [t, i.label]),
            this._obj = e,
            this._key = n,
            this._onChange = function() {}
            ,
            s.get().addEventListener(r.UPDATE_VALUE, this, "onValueUpdate"),
            this.addEventListener(r.VALUE_UPDATED, s.get(), "onValueUpdated")
        }
        var o = n(37)
          , a = n(49)
          , r = n(7)
        ...
        i.prototype.setValue = function(t) {
            ...
            this.dispatchEvent(new p(this,r.VALUE_UPDATED,null))
        }
        ,
    ...
    22: function(t, e, n) {
        function i() {
            ...
            this._onDocumentMouseMove = function(e) {
                ...
                e || (e = window.event),
                e.pageX ? (n = e.pageX,
                i = e.pageY) : e.clientX && (n = e.clientX + document.body.scrollLeft + document.documentElement.scrollLeft,
                i = e.clientY + document.body.scrollTop + document.documentElement.scrollTop),
                t._pos[0] = n,
                t._pos[1] = i,
                t._hoverElement = document.elementFromPoint(n, i)
            }
            ,
            this._onDocumentMouseWheel = function(e) {
                t._wheelDirection = e.detail < 0 ? 1 : e.wheelDelta > 0 ? 1 : -1,
                t.dispatchEvent(new a(t,r.MOUSE_WHEEL,e))
            }
            ,
        ...
        i.prototype.constructor = i,
        i.prototype._removeDocumentListener = function() {
    ...
    31: function(t, e, n) {
        ...
        var o = n(23)
          , a = n(123);
        t.exports = i,
        i.prototype.setShader = function(t, e) {
            this.shader = a(t, e)
        }
        ,
    ...
    36: function(t, e, n) {
        function i(t) {
            ...
            e.setStyleClass(s.Options),
            e.addChild(n),
            this._selectedIndex = null,
            this._callbackOut = function() {}
            ,
            this._unfocusable = !1,
            document.addEventListener(a.MOUSE_DOWN, this._onDocumentMouseDown.bind(this)),
            document.addEventListener(a.MOUSE_UP, this._onDocumentMouseUp.bind(this)),
            this.clear()
        }
        var o = n(3)
          , a = n(9)
        ...
        i.prototype = {
            ...
            build: function(t, e, n, i, a, u, d, c) {
                ...
                if (d) {
                    c = c || l.HEX,
                    v.setStyleClass(s.Color);
                    for (var y, x; ++b < t.length; ) {
                        switch (f = t[b],
                        A = v.addChild(new o(o.LIST_ITEM)),
                        y = A.addChild(new o),
                        c) {
                        case l.HEX:
                            x = f;
                        ...
                        y.getStyle().backgroundColor = x,
                        y.getStyle().backgroundImage = "linear-gradient( rgba(0,0,0,0) 0%, rgba(0,0,0,0.1) 100%)",
                        y.setProperty("innerHTML", f),
                        f == e && A.setStyleClass(s.OptionsSelected),
                        A.addEventListener(r.MOUSE_DOWN, function() {
                            m._selectedIndex = Array.prototype.indexOf.call(this.parentNode.children, this),
                            i()
                        })
                    }
                } else
                    for (v.deleteStyleClass(); ++b < t.length; )
                        f = t[b],
                        A = v.addChild(new o(o.LIST_ITEM)),
                        A.setProperty("innerHTML", f),
                        f == e && A.setStyleClass(s.OptionsSelected),
                        A.addEventListener(r.MOUSE_DOWN, function() {
                            m._selectedIndex = Array.prototype.indexOf.call(this.parentNode.children, this),
                            i()
    ...
    37: function(t, e, n) {
        ...
        i.prototype = Object.create(o.prototype),
        i.prototype.constructor = i,
        i.prototype.pushState = function(t, e, n) {
            if (!this._enabled) {
                var i = this._states;
                i.length >= s && i.shift(),
                i.push({
        ...
        i.prototype.popState = function() {
            if (!this._enabled) {
                ...
                if (!(t.length < 1)) {
                    ...
                    this.dispatchEvent(new a(this,r.STATE_POP,null))
                }
            }
        }
        ,
    ...
    41: function(t, e, n) {
        ...
        s._node._element.style.display = "none",
        e.default = r;
        e.controlKit = s
    },
    48: function(t, e, n) {
        ...
        NumberInput_Internal = function(t, e, n, i, r, s) {
            ...
            ,
            this._onError = s || function() {}
            ,
            this._keyCode = null,
            this._caretOffset = 0;
            var h = this._input = new a("text");
            h.setProperty("value", this._value),
            h.addEventListener("input", this._onInput.bind(this)),
            h.addEventListener("keydown", this._onKeydown.bind(this)),
            l || (h.getElement().setSelectionRange ? (l = function(t, e) {
        ...
        NumberInput_Internal.prototype._onInput = function() {
            var t = this._input
              ...
              , i = this._valueDp
              , o = e[0];
            return "" == e ? e = 0 : "." === o && (e = "0" + e),
            s.test(e) && "-" != e ? (this._onBegin(this._value),
            this._setValue(e),
            l(t, n - this._caretOffset),
            void this._onChange()) : (t.setProperty("value", this._value.toFixed(i)),
            l(t, Math.max(--n, 0)),
        ...
        NumberInput_Internal.prototype._onKeydown = function(t) {
            ...
            if (x)
                return w ? (i(n, "-0"),
                l(n, 1)) : (i(n, u ? 0 : String.fromCharCode(e)),
                l(n, g ? a : s)),
                void t.preventDefault();
            if (u && a - 1 == C)
                return void l(n, a - 1);
            ...
            if (m) {
                var _ = (f ? r : 1) * this._valueStep
                  , E = 38 == e ? 1 : -1;
                return i(n, Number(o) + _ * E),
                l(n, a),
                void t.preventDefault()
            }
            return !y || f && A ? !f && !A && !u && a > C && a < h ? (o = o.substr(0, a) + String.fromCharCode(e) + o.substr(a + 1, h - 1),
            i(n, o),
            l(n, Math.min(a + 1, h - 1)),
            void t.preventDefault()) : void (!u && !A && !m && a >= h && t.preventDefault()) : (A ? l(n, g ? a : s) : (o = o.substr(0, a) + String.fromCharCode(e) + o.substr(s, h - s),
            i(n, o),
            l(n, s)),
            void t.preventDefault())
        }
    ...
    49: function(t, e, n) {
        function i(t, e) {
            ...
            e = t.usesLabels() ? e : "none",
            this._parent = t,
            this._enabled = !0;
            var n = this._node = new o(o.LIST_ITEM)
              , i = this._wrapNode = new o;
            if (i.setStyleClass(a.Wrap),
            n.addChild(i),
            void 0 !== e) {
                if (0 != e.length && "none" != e) {
                    var l = this._lablNode = new o(o.SPAN);
                    l.setStyleClass(a.Label),
                    l.setProperty("innerHTML", e),
                    n.addChild(l)
                }
                "none" == e && (i.setStyleProperty("marginLeft", "0"),
                i.setStyleProperty("width", "100%"))
            }
            this._parent.addEventListener(s.ENABLE, this, "onEnable"),
            this._parent.addEventListener(s.DISABLE, this, "onDisable"),
    ...
    50: function(t, e, n) {
        ...
        i.prototype = Object.create(o.prototype),
        i.prototype.constructor = i,
        i.prototype.onValueUpdated = function(t) {
    ...
    62: function(t, e, n) {
        function i(t) {
            ...
            e.addEventListener(l.MOUSE_DOWN, this._onMouseDown.bind(this)),
            e.addChild(n),
            t.addChildAt(e, 0),
            a.get().addEventListener(s.TRIGGER, this, "onOptionTrigger"),
            this.addEventListener(s.TRIGGERED, a.get(), "onOptionTriggered")
        }
        var o = n(17)
          , a = n(50)
          , r = n(4)
        ...
        i.prototype = Object.create(o.prototype),
        i.prototype.constructor = i,
        i.prototype.onOptionTrigger = function(t) {
            return t.data.origin == this ? void (this._isActive ? this._onDeactive() : (this._onActive(),
            this._btnNode.setStyleClass(h.ButtonPresetActive),
            this._isActive = !0)) : void (this._isActive && this.deactivate())
        }
        ,
    ...
    63: function(t, e, n) {
        function i(t, e, n, i) {
            ...
            l.style.stroke = "rgb(" + r[0] + "," + r[1] + "," + r[2] + ")",
            l.style.strokeWidth = a,
            l.style.fill = "none"
        }
        var o = n(137);
        i.prototype = Object.create(o.prototype),
    ...
    64: function(t, e, n) {
        function i(t, e, n, i) {
            ...
            i = i || {},
            i.height = i.height || p,
            i.resolution = i.resolution || r;
            for (var h = i.resolution, u = Math.floor(l / h), d = this._points = new Array(2 * u), c = this._buffer0 = new Array(u), g = this._buffer1 = new Array(u), v = .5 * this._lineWidth, A = -1; ++A < u; )
                c[A] = g[A] = d[2 * A] = d[2 * A + 1] = v;
            this._height = i.height = i.height < a.COMPONENT_MIN_HEIGHT ? a.COMPONENT_MIN_HEIGHT : i.height,
            this._svgSetSize(p, Math.floor(i.height)),
        ...
        i.prototype._redraw = function() {
            for (var t = this._points, e = this._buffer0.length, n = Number(this._svg.getAttribute("width")), i = n / (e - 1), o = -1; ++o < e; )
                t[2 * o] = n - o * i;
            this._drawValue()
        }
        ,
        ...
        i.prototype._drawGrid = function() {
            var t = this._svg
              ...
              , i = "";
            i += this._pathCmdMoveTo(0, n),
            i += this._pathCmdLineTo(e, n),
            this._grid.setAttribute("d", i)
        }
        ,
        i.prototype._drawCurve = function() {
            ...
            o[1] = n[0],
            n[a - 1] = e * l * -1 + Math.floor(s),
            r += this._pathCmdMoveTo(o[0], o[1]);
            for (var p, h = 0; ++h < a; )
                p = 2 * h,
                i[h - 1] = n[h],
                o[p + 1] = n[h - 1] = i[h - 1],
                r += this._pathCmdLineTo(o[p], o[p + 1]);
        ...
        var n = {
            HSV2RGB: function(t, e, n) {
                var i = 360
                  ...
                  , s = 0;
                if (t %= i,
                n = Math.max(s, Math.min(n, a)) / a * 255,
                e <= r)
            ...
            RGB2HSV: function(t, e, n) {
                ...
                var l = t == r ? e - n : n == r ? t - e : n - t
                  , p = t == r ? 3 : n == r ? 1 : 5;
                return i = Math.round(60 * (p - l / (s - r))),
                o = Math.round((s - r) / s * 100),
                a = Math.round(100 * s),
                [i, o, a]
            },
    ...
    67: function(t, e, n) {
        function i(t, e, n) {
            ...
            this._scrollMin = 0,
            this._scrollMax = 0,
            h.setPositionY(a.SCROLLBAR_TRACK_PADDING),
            h.addEventListener(s.MOUSE_DOWN, this._onThumbDragStart.bind(this)),
            this._isValid = !1,
            this._enabled = !1;
            var u = l.getElement()
              , d = h.getElement()
            ...
            this._onMouseWheel = function(t) {
                ...
                if (n == u || n == d) {
                    ...
                    c._scroll(h.getPositionY() + e.getWheelDirection() * i * -1),
        ...
        i.prototype.update = function() {
            ...
            !(s > 1)) {
                var l = r * s;
                this._scrollHeight = r,
                this._scrollUnit = o - this._scrollHeight - 2 * n,
                this._scrollMin = n,
                this._scrollMax = n + r - l,
                e.setHeight(l),
                this._isValid = !0
            }
        }
        ...
        i.prototype._scroll = function(t) {
            var e = this._scrollMin
              ...
              , o = (i - e) / (n - e);
            this._thumbNode.setPositionY(i),
            this._targetNode.setPositionY(o * this._scrollUnit * -1)
        }
        ,
        i.prototype._onThumbDragStart = function() {
            if (this._isValid && !this._enabled) {
                ...
                this._scroll(n.getY() - i - o._mouseThumbOffset)
            }
        }
        ,
        i.prototype.enable = function() {
        ...
        i.prototype._updateAppearance = function() {
            ...
            this._thumbNode.setPositionY(a.SCROLLBAR_TRACK_PADDING)) : this._node.setStyleProperty("display", "block")
        }
        ,
    ...
    86: function(t, e, n) {
        function i(t, e) {
            ...
            this._setCanvasSize(r, r),
            this._updateHeight(),
            this._node.setStyleClass(a.CanvasListItem),
        ...
        i.prototype.onGroupSizeChange = function() {
            ...
            this._updateHeight(),
            this._redraw(),
            this.dispatchEvent(new s(this,l.GROUP_SIZE_UPDATE,null))
        }
        ,
    ...
    87: function(t, e, n) {
        function i(t, e, n, i) {
            if (i = i || {},
            i.showMinMaxLabels = void 0 === i.showMinMaxLabels ? A : i.showMinMaxLabels,
            o.apply(this, arguments),
            "function" != typeof e[n])
                throw new c(e,n);
            var l = e[n].length;
            ...
            H.setStyleClass(r.GraphSliderYHandle),
            z.addChild(U),
            M.addChild(H),
            R.addChild(z),
            k.addChild(M);
            ...
            if (F == s.IMPLICIT) {
                ...
                Y.style.width = Y.style.height = G + "px",
                Y.width = Y.height = G,
                K.getElement().insertBefore(Y, B),
                this._canvasContext = Y.getContext("2d"),
                this._canvasImageData = this._canvasContext.getImageData(0, 0, G, G),
                O.style.stroke = S,
                D.style.stroke = T
            } else
                O.style.stroke = N,
            ...
            K.addChild(R),
            K.addChild(k),
            U.addEventListener(d.MOUSE_DOWN, this._onSliderXHandleDown.bind(this)),
            H.addEventListener(d.MOUSE_DOWN, this._onSliderYHandleDown.bind(this));
            var Z = this._units = [null, null];
            this._scale = null,
            F == s.NON_IMPLICIT ? (Z[0] = f,
            Z[1] = m,
            this._scale = C) : F == s.IMPLICIT && (Z[0] = b,
            Z[1] = y,
            this._scale = _),
            this._unitsMinMax = [x, w],
            this._scaleMinMax = [E, P],
            this._center = [Math.round(.5 * G), Math.round(.5 * G)],
            this._svgPos = [0, 0],
            this._func = null,
            this.setFunction(this._obj[this._key]),
            this._sliderXHandleUpdate(),
            this._sliderYHandleUpdate(),
            B.addEventListener(h.MOUSE_DOWN, this._onDragStart.bind(this), !1),
            this._wrapNode.getElement().addEventListener("mousewheel", this._onScale.bind(this, !1)),
            v.get().addEventListener(u.UPDATE_VALUE, this, "onValueUpdate")
        }
        var o = n(63)
          , a = n(3)
          , r = n(2)
        ...
        i.prototype = Object.create(o.prototype),
        i.prototype.constructor = i,
        i.prototype._updateCenter = function() {
            var t = this._svg
              , e = Number(t.getAttribute("width"))
              ...
              , o = this._svgPos
              , a = this._center;
            a[0] = Math.max(0, Math.min(i[0] - o[0], e)),
            a[1] = Math.max(0, Math.min(i[1] - o[1], n)),
            this._plotGraph()
        }
        ,
        ...
        i.prototype._onScale = function(t) {
            t = window.event || t,
            this._scale += Math.max(-1, Math.min(1, t.wheelDelta || -t.detail)) * -1;
        ...
        i.prototype._drawAxes = function() {
            var t = this._svg
              ...
              , a = i[1]
              , r = "";
            r += this._pathCmdLine(0, a, e, a),
            r += this._pathCmdLine(o, 0, o, n),
            this._axes.setAttribute("d", r)
        }
        ,
        i.prototype._drawPlot = function() {
            var t, e, n, i, o, a, r, l, p, h, u, d = this._center, c = d[0], g = d[1], v = this._units, A = this._scale;
            if (this._plotMode == s.NON_IMPLICIT) {
                var f = this._svg;
                t = Number(f.getAttribute("width")),
                e = Number(f.getAttribute("height")),
                n = v[0] * A,
                i = e / (v[1] * A),
                p = c / t;
                var m = Math.floor(t)
                ...
                for (u = -1; ++u < m; )
                    ...
                    b[l + 1] = r;
                var y = "";
                for (y += this._pathCmdMoveTo(b[0], b[1]),
                u = 2; u < b.length; )
                    y += this._pathCmdLineTo(b[u], b[u + 1]),
                    u += 2;
                ...
                for (var N; ++u < e; )
                    for (N = -1; ++N < t; )
                        r = this._func((-p + N * _) * n, (-h + u * E) * i),
                        P[0] = Math.floor((T[0] - S[0]) * r + S[0]),
                        P[1] = Math.floor((T[1] - S[1]) * r + S[1]),
                        P[2] = Math.floor((T[2] - S[2]) * r + S[2]),
                        l = 4 * (u * t + N),
                        C.data[l] = P[0],
                        C.data[l + 1] = P[1],
                        C.data[l + 2] = P[2],
        ...
        ,
        i.prototype._drawGrid = function() {
            var t, e, n = this._svg, i = Number(n.getAttribute("width")), o = Number(n.getAttribute("height")), a = this._scale, r = this._units, s = i / (r[0] * a), l = o / (r[1] * a), h = this._center, u = h[0], d = h[1], c = Math.round(d / l) + 1, g = Math.round((o - d) / l) + 1, v = Math.round(u / s) + 1, A = Math.round((i - u) / s) + 1, f = "", m = "", b = p.STROKE_SIZE, y = p.FUNCTION_PLOTTER_LABEL_TICK_SIZE, x = i - y - b, w = o - y - b, C = x - y, _ = w - y, E = x - 2 * (y + b), P = w - 2 * (y + b);
            for (t = -1; ++t < c; )
                e = Math.round(d - l * t),
                f += this._pathCmdLine(0, e, i, e),
                e > y && (m += this._pathCmdLine(x, e, C, e));
            for (t = -1; ++t < g; )
                e = Math.round(d + l * t),
                f += this._pathCmdLine(0, e, i, e),
                e < P && (m += this._pathCmdLine(x, e, C, e));
            for (t = -1; ++t < v; )
                e = Math.round(u - s * t),
                f += this._pathCmdLine(e, 0, e, o),
                e > y && (m += this._pathCmdLine(e, w, e, _));
            for (t = -1; ++t < A; )
                e = Math.round(u + s * t),
                f += this._pathCmdLine(e, 0, e, o),
                e < E && (m += this._pathCmdLine(e, w, e, _));
            this._grid.setAttribute("d", f),
            this._axesLabels.setAttribute("d", m)
        }
        ,
        ...
        i.prototype._onSliderHandleDown = function(t) {
            var e = h.MOUSE_MOVE
              ...
              , a = function() {
                ...
                document.removeEventListener(n, a, !1)
            };
            t(i.getPosition()),
    ...
    88: function(t, e, n) {
        ...
        i.prototype._setValue = function() {
            if (!this._parent.isDisabled()) {
                var t, e, n = this._obj[this._key], i = this._textArea, o = this._valueDp;
                if ("object" != typeof n || "number" != typeof n.length || "function" != typeof n.splice || n.propertyIsEnumerable("length"))
                    e = n.toString(),
                    t = e.indexOf("."),
                    i.setProperty("value", t > 0 ? e.slice(0, t + o) : e);
                else {
                    e = n.slice();
                    for (var a, r = -1, s = this._wrap; ++r < e.length; )
                        a = e[r] = e[r].toString(),
                        t = a.indexOf("."),
                        t > 0 && (e[r] = a.slice(0, t + o));
                    s && (i.setStyleProperty("white-space", "nowrap"),
                    e = e.join("\n")),
    ...
    89: function(t, e, n) {
        function i(t, e, n, i) {
            ...
            i = i || {},
            i.height = i.height || c,
            i.wrap = void 0 === i.wrap ? g : i.wrap,
            i.update = void 0 === i.update ? v : i.update,
            this._wrap = i.wrap,
            this._update = i.update;
            var p = this._textArea = new a(a.TEXTAREA)
              , h = this._wrapNode
              , A = this._node;
            if (p.setProperty("readOnly", !0),
            h.addChild(p),
            p.addEventListener(u.MOUSE_DOWN, this._onInputDragStart.bind(this)),
            this.addEventListener(d.INPUT_SELECT_DRAG, this._parent, "onComponentSelectDrag"),
            i.height) {
                var f = new a;
                f.setStyleClass(r.TextAreaWrap),
                f.addChild(p),
                h.addChild(f);
                var m = this._height = i.height
                  , b = 4;
                p.setHeight(Math.max(m + b, s.COMPONENT_MIN_HEIGHT)),
                h.setHeight(p.getHeight()),
                A.setHeight(h.getHeight() + b),
                this._scrollBar = new l(f,p,m - b)
            }
            i.wrap && p.setStyleProperty("white-space", "pre-wrap"),
            this._prevString = "",
    ...
    90: function(t, e, n) {
        function i(t) {
            ...
            F.addChildren(X, O.getNode()),
            Y.addChildren(Q, I.getNode()),
            Z.addChildren(q, D.getNode());
            ...
            W.addChildren($, B.getNode()),
            j.addChildren(tt, G.getNode()),
            J.addChildren(et, R.getNode()),
            f.addChildren(W, F, j, Y, J, Z, U);
            var nt = new o;
            ...
            at.setProperty("innerHTML", "#"),
            ot.addChildren(at, it),
            nt.addChild(ot),
            it.addEventListener(h.CHANGE, this._onInputHEXFinish.bind(this)),
            ...
            v.addEventListener(rt, st),
            w.addEventListener(rt, st),
            st = this._onCanvasSliderMouseDown.bind(this),
            A.addEventListener(rt, st),
            C.addEventListener(rt, st),
            g.addEventListener(rt, this._onClose.bind(this)),
            z.addEventListener(rt, this._onPick.bind(this)),
            M.addEventListener(rt, this._onClose.bind(this)),
            ...
            this._imageDataSlider = x.createImageData(b.width, b.height),
            this._imageDataField = y.createImageData(m.width, m.height),
        ...
        i.prototype = {
            _drawHandleField: function() {
                ...
                this._setColorHSV(this._valueHue, l, p),
                this._updateColorRGBFromHSV(),
                this._updateColorHEXFromRGB(),
            ...
            _drawHandleSlider: function() {
                ...
                this._setColorHSV(a, this._valueSat, this._valueVal),
                this._updateColorRGBFromHSV(),
                this._updateColorHEXFromRGB(),
            ...
            _onInputHEXFinish: function() {
                var t = this._inputHEX
                  , e = t.getProperty("value");
                return l.isValidHEX(e) ? (this._valueHEX = this._valueHEXValid = e,
                void this._updateColorFromHEX()) : void t.setProperty("value", this._valueHEXValid)
            },
            ...
            _onHeadDragStart: function() {
                ...
                var a = p.MOUSE_MOVE
                  ...
                  , u = function() {
                    ...
                    document.removeEventListener(r, u, !1)
                };
                e.removeChild(t),
                e.addChild(t),
                document.addEventListener(a, h, !1),
                document.addEventListener(r, u, !1),
            ...
            _updatePosition: function() {
                ...
                r[0] = Math.max(0, Math.min(n, l)),
                r[1] = Math.max(0, Math.min(i, p)),
                o.setPositionGlobal(r[0], r[1])
            },
            _drawCanvasField: function() {
                for (var t, e = this._canvasField, n = this._contextCanvasField, i = e.width, o = e.height, a = 1 / i, r = 1 / o, s = this._imageDataField, p = [], h = 0, u = this._valueHue, d = -1; ++d < o; )
                    for (t = -1; ++t < i; )
                        p = l.HSV2RGB(u, t * a * 100, 100 * (1 - d * r)),
                        h = 4 * (d * i + t),
                        s.data[h] = p[0],
                        s.data[h + 1] = p[1],
                        s.data[h + 2] = p[2],
    ...
    91: function(t, e, n) {
        function i(t, e, n, i) {
            o.apply(this, arguments),
            i = i || {},
            i.onChange = i.onChange || this._onChange,
            i.step = i.step || h,
            i.dp = null != i.dp ? i.dp : u,
            this._onChange = i.onChange;
            ...
            d.setStyleClass(s.Label).setProperty("innerHTML", "MIN"),
            g.setStyleClass(s.Label).setProperty("innerHTML", "MAX");
            var y = this._obj[this._key];
            c.setValue(y[0]),
            v.setValue(y[1]);
            var x = this._wrapNode;
            A.addChild(d),
            f.addChild(c.getNode()),
            m.addChild(g),
            b.addChild(v.getNode()),
            x.addChild(A),
            x.addChild(f),
            x.addChild(m),
            x.addChild(b)
    ...
    96: function(t, e, n) {
        function i(t, e) {
            ...
            this._node = new a(a.LIST_ITEM),
            this._wrapNode = new a,
            this._listNode = new a(a.LIST),
        ...
        i.prototype = Object.create(o.prototype),
        i.prototype.constructor = i,
        i.prototype.addScrollWrap = function() {
    ...
    119: function(t, e, n) {
        "use strict";
        t.exports.Composer = n(120),
        t.exports.CopyPass = n(85),
        t.exports.BlendMode = {
            Normal: 1,
            Dissolve: 2,
            Darken: 3,
    ...
    120: function(t, e, n) {
        ...
        function i(t, e) {
            ...
            this.width = Math.floor(t.context.canvas.width / n) || 1,
            this.height = Math.floor(t.context.canvas.height / n) || 1,
            this.output = null,
            this.input = null,
            this.read = null,
            this.write = null,
            this.settings = e || {},
            this.useRGBA = this.settings.useRGBA || !1,
            this.renderer = t,
            this.copyPass = new a(this.settings),
            this.defaultMaterial = new o.MeshBasicMaterial({
                color: 65280,
                wireframe: !1
            }),
            this.scene = new o.Scene,
            this.quad = new o.Mesh(new o.PlaneBufferGeometry(1,1),this.defaultMaterial),
            this.scene.add(this.quad),
            this.camera = new o.OrthographicCamera(1,1,1,1,-1e4,1e4),
            this.front = new o.WebGLRenderTarget(1,1,{
        ...
        i.prototype.render = function(t, e, n, i) {
            n && this.swapBuffers(),
            this.renderer.render(t, e, i ? i : this.write, !0),
            i || this.swapBuffers()
        }
        ,
        ...
        i.prototype.toTexture = function(t) {
            this.quad.material = this.copyPass.shader,
            this.quad.material.uniforms.tInput.value = this.read,
            this.renderer.render(this.scene, this.camera, t, !1)
        }
        ,
        i.prototype.pass = function(t) {
            if (t instanceof r)
                ...
                if (t instanceof o.ShaderMaterial && (this.quad.material = t),
                t instanceof s)
                    return void t.run(this);
                t.isSim || (this.quad.material.uniforms.tInput.value = this.read),
                this.quad.material.uniforms.resolution.value.set(this.width, this.height),
                this.quad.material.uniforms.time.value = .001 * (Date.now() - this.startTime),
                this.renderer.render(this.scene, this.camera, this.write, !1),
                this.swapBuffers()
            }
        }
        ,
        ...
        i.prototype.setSource = function(t) {
            this.quad.material = this.copyPass.shader,
            this.quad.material.uniforms.tInput.value = t,
            this.renderer.render(this.scene, this.camera, this.write, !0),
            this.swapBuffers()
        }
        ,
        i.prototype.setSize = function(t, e) {
            this.width = t,
            this.height = e,
            this.camera.projectionMatrix.makeOrthographic(t / -2, t / 2, e / 2, e / -2, this.camera.near, this.camera.far),
            this.quad.scale.set(t, e, 1),
            this.front.setSize(t, e),
            this.back.setSize(t, e)
        }
    },
    121: function(t, e) {
        "use strict";
        ...
        t.exports = n,
        n.prototype.addPass = function(t, e, n, i) {
            var o = 0
              , a = {
                shaderName: t,
                enabled: e || !1
            };
            return this.passItems.push(a),
            o = this.passItems.length,
            this.updatePasses(),
            i ? this.movePassToIndex(this.passItems[o], i) : o - 1
        }
        ,
        n.prototype.removePass = function(t) {
            this.passItems.splice(t, 1),
            this.updatePasses()
        }
        ,
        n.prototype.enablePass = function(t) {
            this.passItems[t].enabled = !0,
            this.updatePasses()
        }
        ,
        n.prototype.disablePass = function(t) {
            this.passItems[t].enabled = !1,
            this.updatePasses()
        }
        ,
        ...
        n.prototype.movePassToIndex = function(t, e) {
            return this.passItems.splice(e, 0, this.passItems.splice(t, 1)[0]),
            this.updatePasses(),
            e
        }
        ,
        ...
        n.prototype.updatePasses = function() {
            ...
            this.passItems.forEach(function(t, e) {
    ...
    122: function(t, e, n) {
        ...
        function i(t) {
            ...
            t = t || {},
            this.setShader(a, r),
            this.params.amount = t.amount || .1,
            this.params.speed = t.speed || 0
        }
        var o = (n(23),
        n(31))
          , a = n(56)
    ...
    128: function(t, e, n) {
        function i(t) {
            ...
            t = t || {},
            t.history = void 0 === t.history ? x : t.history,
            t.loadAndSave = void 0 === t.loadAndSave ? E : t.loadAndSave,
            t.opacity = void 0 === t.opacity ? w : t.opacity,
            ...
            t.enable = void 0 === t.enable ? _ : t.enable,
            ...
            var h = v.setup();
            this._historyEnabled ? (h.addEventListener(c.STATE_PUSH, this, "onHistoryStatePush"),
            h.addEventListener(c.STATE_POP, this, "onHistoryStatePop")) : h.disable(),
            f.setup(),
            s.setup(e),
            r.setup(e);
            var d = t.opacity;
            1 != d && 0 != d && e.setStyleProperty("opacity", d),
            this._canUpdate = !0;
            var g, A = this, m = 0, b = 10;
            ...
            this._shortcutEnable = P,
            document.addEventListener("keydown", function(t) {
                t.ctrlKey && String.fromCharCode(t.which || t.keyCode).toLowerCase() == A._shortcutEnable && (A._enabled = !A._enabled,
                A._enabled ? A._enable() : A._disable())
            }),
        ...
        i.prototype.constructor = i,
        i.prototype.addPanel = function(t) {
            var e = new a(this,t);
            ...
            if (this._enabled && this._canUpdate) {
                ...
                i = h.length; ++t < i; )
                    ...
                    !r.isDisabled())
                        ...
                        e = -1,
                        o = s.length; ++e < o; )
                            for (l = s[e].getComponents(),
                            n = -1,
                            a = l.length; ++n < a; )
                                p = l[n],
                                p.isDisabled() || (p instanceof m || p instanceof b || p instanceof y) && p.update()
            }
        }
        ,
    ...
    129: function(t, e, n) {
        function i(t, e, n, i) {
            ...
            i = i || {},
            i.label = i.label || h,
            l.apply(this, [t, i.label]);
            var u = this._inputNode = new s(s.INPUT_BUTTON);
            u.setStyleClass(p.Button),
            u.setProperty("value", e);
            var d = this;
            u.addEventListener(a.ON_CLICK, function() {
                n.bind(d)(),
                d.dispatchEvent(new o(d,r.VALUE_UPDATED))
            }),
        ...
        i.prototype.constructor = i,
        i.prototype.getButtonLabel = function() {
    ...
    130: function(t, e, n) {
        function i(t, e, n, i) {
            ...
            r.addEventListener(s.CHANGE, this._onInputChange.bind(this)),
    ...
    131: function(t, e, n) {
        function i(t, e, n, i) {
            o.apply(this, arguments),
            i = i || {},
            i.presets = i.presets || m,
            i.colorMode = i.colorMode || f,
            i.onChange = i.onChange || this._onChange,
            this._presetsKey = i.presets,
            this._onChange = i.onChange;
            ...
            if (this._presetsKey) {
                ...
                l.addChild(c),
                c.addChild(r);
                for (var v = this._obj[this._presetsKey], A = -1; ++A < v.length; )
                    this._validateColorFormat(v[A], x, w);
                var C = p.get()
                  , _ = new h(l)
                  , E = function() {
                    C.clear(),
                ...
                r.setStyleClass(d.Color),
                l.addChild(r);
            r.addEventListener(g.MOUSE_DOWN, this._onColorTrigger.bind(this)),
            this._updateColor()
        }
        var o = n(14)
          , a = n(3)
        ...
        i.prototype = Object.create(o.prototype),
        i.prototype.constructor = i,
        i.prototype._onColorTrigger = function() {
            var t, e = this._colorMode, n = r.HEX, i = r.RGB, o = r.RGBfv, a = r.HSV, l = this._value, p = function() {
        ...
        i.prototype.applyValue = function() {
            ...
            this._updateColor(),
            this.dispatchEvent(new c(this,v.VALUE_UPDATED,null)),
        ...
        i.prototype._validateColorFormat = function(t, e, n) {
            ...
            if (i == r.HEX && "[object Array]" === Object.prototype.toString.call(t) || i == r.HEX && "[object Float32Array]" === Object.prototype.toString.call(t))
                throw new A(e);
            if ((i == r.RGB || i == r.RGBfv || i == r.HSV) && "[object Array]" !== Object.prototype.toString.call(t) || i == r.HSV && "[object Float32Array]" !== Object.prototype.toString.call(t))
                throw new A(n)
        }
        ,
        t.exports = i
    ...
    135: function(t, e, n) {
        function i(t, e, n, i) {
            o.apply(this, arguments),
            i = i || {},
            i.onBegin = i.onBegin || null,
            i.onChange = i.onChange || this._onChange,
            i.onFinish = i.onFinish || null,
            i.onError = i.onError || null,
            i.dp = void 0 === i.dp || null == i.dp ? v : i.dp,
            i.step = i.step || A,
            i.presets = i.presets || f,
            this._onBegin = i.onBegin,
            this._onChange = i.onChange,
            this._presetsKey = i.presets;
            ...
            if (m) {
                var b = new r;
                b.setStyleClass(p.WrapInputWPreset),
                d.addChild(b),
                b.addChild(u.getNode());
                var y = s.get()
                  ...
                  , _ = function() {
                    y.build(m, u.getValue(), u.getNode(), function() {
                        u.setValue(m[y.getSelectedIndex()]),
                        C.applyValue(),
                        C._onChange(C._obj[C._key])
                    }, w, h.PADDING_PRESET, !1)
                };
                x.setOnActive(_),
                x.setOnDeactive(w)
            } else
                d.addChild(u.getNode());
            u.getNode().addEventListener(c.MOUSE_DOWN, this._onInputDragStart.bind(this)),
            this.addEventListener(g.INPUT_SELECT_DRAG, this._parent, "onComponentSelectDrag"),
            u.setValue(this._obj[this._key])
        }
        var o = n(14)
          , a = n(48)
          , r = n(3)
        ...
        i.prototype.applyValue = function() {
            ...
            this.dispatchEvent(new u(this,g.VALUE_UPDATED,null))
        }
        ,
        i.prototype.onValueUpdate = function(t) {
        ...
        i.prototype._onInputDragStart = function() {
            ...
            this.dispatchEvent(new u(this,n,null)),
    ...
    136: function(t, e, n) {
        function i(t, e, n, i) {
            ...
            l.setAttribute("r", String(11)),
            l.setAttribute("fill", "rgba(0,0,0,0.05)");
            var c = r.appendChild(this._createSVGObject("circle"));
            c.setAttribute("r", String(10)),
            c.setAttribute("fill", "rgb(83,93,98)");
            var g = r.appendChild(this._createSVGObject("circle"));
            g.setAttribute("r", String(9)),
            g.setAttribute("fill", "rgb(57,69,76)"),
            g.setAttribute("cy", String(.75));
            var v = r.appendChild(this._createSVGObject("circle"));
            v.setAttribute("r", String(10)),
            v.setAttribute("stroke", "rgb(17,19,20)"),
            v.setAttribute("stroke-width", String(1)),
            v.setAttribute("fill", "none");
            var A = r.appendChild(this._createSVGObject("circle"));
            A.setAttribute("r", String(6)),
            A.setAttribute("fill", "rgb(30,34,36)");
            var f = r.appendChild(this._createSVGObject("circle"));
            f.setAttribute("r", String(3)),
            f.setAttribute("fill", "rgb(255,255,255)"),
            r.setAttribute("tranform", "translate(0 0)"),
            this._svg.addEventListener(s.MOUSE_DOWN, this._onDragStart.bind(this), !1),
        ...
        i.prototype._drawGrid = function() {
            var t = Number(this._svg.getAttribute("width"))
              ...
              , n = Math.floor(.5 * t)
              , i = "";
            i += this._pathCmdLine(0, n, t, n),
            i += this._pathCmdLine(e, 0, e, t),
            this._grid.setAttribute("d", i)
        }
        ,
        i.prototype._drawPoint = function() {
            var t = Number(this._svg.getAttribute("width"))
              ...
              , i = (.5 + .5 * -e[1]) * t
              , o = "";
            o += this._pathCmdLine(0, i, t, i),
            o += this._pathCmdLine(n, 0, n, t),
            this._path.setAttribute("d", o),
            this._handle.setAttribute("transform", "translate(" + n + " " + i + ")")
        }
        ,
    ...
    137: function(t, e, n) {
        function i(t, e, n, i) {
            ...
            p.setAttribute("version", "1.2"),
            p.setAttribute("baseProfile", "tiny"),
            s.getElement().appendChild(p);
            var h = this._svgRoot = p.appendChild(this._createSVGObject("g"));
            h.setAttribute("transform", "translate(0.5 0.5)"),
            this._svgSetSize(l, l),
            this._updateHeight(),
            this._node.setStyleClass(a.SVGListItem),
        ...
        i.prototype._updateHeight = function() {
            var t = Number(this._svg.getAttribute("height"));
            this._wrapNode.setHeight(t),
            this._node.setHeight(t + s.PADDING_WRAPPER)
        }
        ,
        i.prototype._redraw = function() {}
        ,
    ...
    138: function(t, e, n) {
        function i(t, e, n, i) {
            ...
            if (v.setStyleClass(r.Select),
            v.addEventListener(h.MOUSE_DOWN, this._onOptionTrigger.bind(this)),
            this._hasTarget()) {
                for (var A = s[p] || "", f = -1; ++f < u.length; )
                    A == u[f] && (this._selected = u[f]);
                v.setProperty("value", A.toString().length > 0 ? A : u[0])
            } else
                v.setProperty("value", i.selected ? u[i.selected] : g);
            this._wrapNode.addChild(v),
            c.get().addEventListener(d.TRIGGER, this, "onOptionTrigger"),
            this.addEventListener(d.TRIGGERED, c.get(), "onOptionTriggered")
        }
        var o = n(14)
          , a = n(3)
          , r = n(2)
        ...
        i.prototype.constructor = i,
        i.prototype.onOptionTrigger = function(t) {
            return t.data.origin == this ? (this._active = !this._active,
            this._updateAppearance(),
            void (this._active ? this._buildOptions() : s.get().clear())) : (this._active = !1,
            void this._updateAppearance())
        }
        ,
        ...
        i.prototype._applySelected = function(t) {
            ...
            this.dispatchEvent(new p(this,u.VALUE_UPDATED), null)
        }
        ,
        i.prototype.applyValue = function() {
        ...
        i.prototype.setValue = function(t) {
            ...
            t == -1 ? (this._selected = null,
            void this._select.setProperty("value", g)) : (this._selected = this._values[this._selectedIndex],
            void this._applySelected(this._selected))
        }
        ,
        i.prototype.getData = function() {
            var t = {};
    ...
    139: function(t, e, n) {
        function i(t, e, n, i, s) {
            s = s || {},
            s.label = s.label || n,
            o.apply(this, [t, e, i, s]),
            this._values = this._obj[this._key],
            this._targetKey = n,
            s.step = s.step || v,
            s.dp = void 0 === s.dp || null == s.dp ? A : s.dp,
            ...
            b.setValue(h[g]),
            f.addChild(b.getNode()),
            this._parent.addEventListener(d.PANEL_MOVE_END, this, "onPanelMoveEnd"),
            this._parent.addEventListener(c.GROUP_SIZE_CHANGE, this, "onGroupWidthChange"),
            this._parent.addEventListener(u.WINDOW_RESIZE, this, "onWindowResize")
        }
        var o = n(14)
          , a = n(2)
          , r = n(140)
        ...
        i.prototype._onSliderMove = function() {
            ...
            this.dispatchEvent(new h(this,g.VALUE_UPDATED,null)),
            this._onChange()
        }
        ,
        ...
        i.prototype.onValueUpdate = function(t) {
            ...
            if (e != this) {
                ...
                if (e instanceof i)
                    ...
                    n.setBoundMin(o[0]),
                    n.setBoundMax(o[1]),
                    e instanceof l || n.setValue(this._obj[this._targetKey])
                }
                this.applyValue()
            }
        }
        ...
        ,
        i.prototype.setValue = function(t) {
            t != -1 && (this._obj[this._targetKey] = t,
            this.dispatchEvent(new h(this,g.VALUE_UPDATED,null)))
        }
        ,
        i.prototype.getData = function() {
    ...
    140: function(t, e, n) {
        function i(t, e, n, i) {
            ...
            l.addChild(p.node),
            p.node.addChild(h.node),
            p.offsetX = p.node.getPositionGlobalX(),
            p.width = Math.floor(p.node.getWidth() - 2 * p.padding),
            h.node.setWidth(h.width),
            p.node.addEventListener(r.MOUSE_DOWN, this._onSlotMouseDown.bind(this)),
            p.node.addEventListener(r.MOUSE_UP, this._onSlotMouseUp.bind(this)),
            document.addEventListener(a.MOUSE_MOVE, this._onDocumentMouseMove.bind(this)),
            document.addEventListener(a.MOUSE_UP, this._onDocumentMouseUp.bind(this))
        }
        var o = n(3)
          , a = n(9)
        ...
        i.prototype._update = function() {
            var t = l.get().getX()
              ...
              , n = this._slot.width
              , i = t < e ? 0 : t > e + n ? n : t - e;
            this._handle.node.setWidth(Math.round(i)),
            this._intrpl = i / n,
    ...
    141: function(t, e, n) {
        function i(t, e, n, i) {
            ...
            if (v) {
                var A = new a;
                A.setStyleClass(r.WrapInputWPreset),
                u.addChild(A),
                A.addChild(h);
                var f = s.get()
                  ...
                  , x = function() {
                    f.build(v, h.getProperty("value"), h, function() {
                        h.setProperty("value", v[f.getSelectedIndex()]),
                        y.pushHistoryState(),
                        y.applyValue()
                ...
                u.addChild(h);
            h.setProperty("value", this._obj[this._key]),
            h.addEventListener(d.KEY_UP, this._onInputKeyUp.bind(this)),
            h.addEventListener(d.CHANGE, this._onInputChange.bind(this)),
            h.addEventListener(d.MOUSE_DOWN, this._onInputDragStart.bind(this)),
            this.addEventListener(c.INPUT_SELECT_DRAG, this._parent, "onComponentSelectDrag")
        }
        var o = n(14)
          , a = n(3)
          , r = n(2)
        ...
        i.prototype = Object.create(o.prototype),
        i.prototype.constructor = i,
        i.prototype._onInputKeyUp = function(t) {
        ...
        i.prototype.applyValue = function() {
            ...
            this.dispatchEvent(new h(this,c.VALUE_UPDATED,null))
        }
        ,
        i.prototype.onValueUpdate = function(t) {
    ...
    143: function(t, e) {
        function n() {
            ...
            return n.document.documentElement.innerHTML = a,
            n
        }
        function i(t) {
            var e = n()
            ...
            i.getElementById("save").addEventListener("click", function() {
                ...
                o.download = n,
                window.webkitURL ? o.href = window.webkitURL.createObjectURL(e) : (o.href = window.createObjectURL(e),
    ...
    147: function(t, e, n) {
        function i(t, e) {
            ...
            var n = this._node
              , i = this._wrapNode
              , o = this._listNode;
            n.setStyleClass(r.Group),
            i.setStyleClass(r.Wrap),
            o.setStyleClass(r.SubGroupList),
            i.addChild(o);
            var l = e.label;
            if (l) {
                var p = new s
                ...
                p.setStyleClass(r.Head),
                g.setStyleClass(r.Wrap),
                v.setStyleClass(r.Label),
                A.setStyleClass(r.ArrowBMax),
                v.setProperty("innerHTML", l),
                p.addChild(A),
                g.addChild(v),
                p.addChild(g),
                n.addChild(p),
                p.addEventListener(u.MOUSE_DOWN, this._onHeadTrigger.bind(this)),
                this.addEventListener(c.GROUP_LIST_SIZE_CHANGE, t, "onGroupListSizeChange"),
                this._updateAppearance()
            }
            ...
            this.hasMaxHeight()) {
                if (!l) {
                    ...
                    f.setStyleClass(r.ScrollBuffer),
                    n.addChildAt(f, 0)
                }
                var m = this._scrollBufferBottom = new s;
                m.setStyleClass(r.ScrollBuffer),
                n.addChild(m)
            }
            t = this._parent,
            t.addEventListener(d.PANEL_MOVE_BEGIN, this, "onPanelMoveBegin"),
        ...
        i.prototype = Object.create(a.prototype),
        i.prototype.constructor = i,
        i.prototype.onPanelMoveBegin = function() {
        ...
        i.prototype.onSubGroupTrigger = function() {
            ...
            this.hasMaxHeight()) {
                ...
                i && i.setStyleProperty("display", "block")) : (t.disable(),
        ...
        i.prototype._onHeadTrigger = function() {
            ...
            this._updateAppearance(),
            this.dispatchEvent(new p(this,c.GROUP_LIST_SIZE_CHANGE,null))
        }
        ,
        ...
        i.prototype._updateAppearance = function() {
            ...
            if (this.isDisabled())
                ...
                e && e.setStyleClass(r.ArrowBMin),
                void (n && (i && i.setStyleProperty("display", "none"),
                o && o.setStyleProperty("display", "none")));
            if (this.hasMaxHeight()) {
                var a = this.getMaxHeight()
                  , s = t.getChildAt(1).getHeight();
                t.setHeight(s < a ? s : a),
                n.isValid() && (i && i.setStyleProperty("display", "block"),
        ...
        i.prototype.addSubGroup = function(t) {
            return this._subGroups.push(new l(this,t)),
            this._updateHeight(),
            this
        }
        ,
        i.prototype._getSubGroup = function() {
            ...
            return 0 == t.length && t.push(new l(this)),
            t[t.length - 1]
        }
        ,
        ...
        i.prototype.setData = function(t) {
            for (var e, n, i = this._components, a = -1, r = 0, s = i.length; ++a < s; )
                e = i[a],
                o(e) && (n = t[r++],
        ...
        ,
        i.prototype.getData = function() {
            for (var t, e = this._components, n = -1, i = e.length, a = []; ++n < i; )
                t = e[n],
                o(t) && a.push(t.getData());
            return a
        }
        ,
        t.exports = i
    ...
    148: function(t, e, n) {
        function i(t, e) {
            ...
            e.valign = e.valign || z,
            e.align = e.align || M,
            e.position = e.position || O,
            e.width = e.width || I,
            e.height = e.height || D,
            e.ratio = e.ratio || R,
            e.label = e.label || k,
            e.opacity = e.opacity || K,
            e.fixed = void 0 === e.fixed ? F : e.fixed,
            e.enable = void 0 === e.enable ? H : e.enable,
            e.vconstrain = void 0 === e.vconstrain ? Y : e.vconstrain,
            e.dock && (e.dock.align = e.dock.align || U.align,
            e.dock.resizable = e.dock.resizable || U.resizable),
            this._width = Math.max(B, Math.min(e.width, G)),
            ...
            f.addChild(m),
            f.addChild(w),
            t.getNode().addChild(f),
            a) {
                var _ = a.align;
                _ != l.LEFT && _ != l.RIGHT || (g = _,
                this._height = window.innerHeight),
                _ == l.TOP || _ == l.BOTTOM,
                f.setStyleProperty("float", g)
            } else {
                var E = this._menuHide = new o(o.INPUT_BUTTON);
                if (E.setStyleClass(s.ButtonMenuHide),
                E.addEventListener(c.MOUSE_DOWN, this._onMenuHideMouseDown.bind(this)),
                b.addChild(E),
                this._parent.panelsAreClosable()) {
                    var P = new o(o.INPUT_BUTTON);
                    P.setStyleClass(s.ButtonMenuClose),
                    P.addEventListener(c.MOUSE_DOWN, this.disable.bind(this)),
                    b.addChild(P)
                }
                ...
                i) {
                    if (r) {
                        var S = r[0]
                          , T = r[1];
                        0 != T && f.setPositionY(T),
                        0 != S && (g == l.RIGHT ? f.getElement().marginRight = S : f.setPositionX(S))
                    }
                    f.setStyleProperty("float", g)
                } else
                    r ? g == l.LEFT || g == l.TOP || g == l.BOTTOM ? f.setPositionGlobal(r[0], r[1]) : (f.setPositionGlobal(window.innerWidth - n - r[0], r[1]),
                    this._position = f.getPosition()) : this._position = f.getPosition(),
                    this._mouseOffset = [0, 0],
                    f.setStyleProperty("position", "absolute"),
                    m.addEventListener(c.MOUSE_DOWN, this._onHeadDragStart.bind(this))
            }
            var N = this._parent
              , L = N.historyIsEnabled()
              , V = N.statesAreEnabled();
            (L || V) && b.addChildAt(new o, 0).setStyleClass(s.Wrap),
            L && (this._menuUndo = b.getChildAt(0).addChild(new o(o.INPUT_BUTTON)).setStyleClass(s.ButtonMenuUndo).setProperty("value", p.get().getNumStates()).addEventListener(c.MOUSE_DOWN, function() {
                p.get().popState()
            }),
            N.addEventListener(v.UPDATE_MENU, this, "onUpdateMenu")),
            V && (b.getChildAt(0).addChild(new o(o.INPUT_BUTTON)).setStyleClass(s.ButtonMenuLoad).setProperty("value", "Load").addEventListener(c.MOUSE_DOWN, function() {
                t._loadState()
            }),
            ...
            1 != A && 0 != A && f.setStyleProperty("opacity", A),
        ...
        i.prototype.constructor = i,
        i.prototype._onMenuHideMouseDown = function() {
            this._enabled = !this._enabled,
            this._updateAppearance()
        }
        ,
        ...
        i.prototype._updateAppearance = function() {
            ...
            t.deleteStyleProperty("height"),
            n.setStyleClass(s.ButtonMenuHide),
            e.setStyleClass(s.Head),
            this.dispatchEvent(new u(this,g.PANEL_SHOW,null))) : (e.getStyle().borderBottom = "none",
            t.setHeight(e.getHeight()),
            n.setStyleClass(s.ButtonMenuShow),
            this.dispatchEvent(new u(this,g.PANEL_HIDE,null)))
        }
        ,
        i.prototype._onHeadDragStart = function() {
            ...
            var a = d.MOUSE_MOVE
              ...
              , p = function() {
                ...
                s.dispatchEvent(new u(this,g.PANEL_MOVE_END,null))
            };
            t.removeChild(e),
            t.addChild(e),
            document.addEventListener(a, l, !1),
            document.addEventListener(r, p, !1),
            this.dispatchEvent(new u(this,g.PANEL_MOVE_BEGIN,null))
        }
        ,
        i.prototype._updatePosition = function() {
            ...
            this.dispatchEvent(new u(this,g.PANEL_MOVE,null))
        }
        ,
        i.prototype._onWindowResize = function() {
            if (this.isDocked()) {
                ...
                if (t.align == l.RIGHT || t.align == l.LEFT) {
                    ...
                    this._height = e,
                    e - i > n ? this._scrollBar.disable() : this._scrollBar.enable(),
                    this.dispatchEvent(new u(this,g.PANEL_SIZE_CHANGE))
                }
            } else
                this.isFixed() || this._constrainPosition();
            this._constrainHeight(),
            this.dispatchEvent(new u(this,d.WINDOW_RESIZE))
        }
        ,
        i.prototype._constrainPosition = function() {
            var t = this._node
              ...
              , i = this._position;
            i[0] = Math.max(0, Math.min(i[0], e)),
            i[1] = Math.max(0, Math.min(i[1], n)),
            t.setPositionGlobal(i[0], i[1])
        }
        ,
        i.prototype._constrainHeight = function() {
            if (this._vConstrain) {
                var t, e = this.hasMaxHeight(), n = this.hasScrollWrap(), i = this._headNode, o = this._wrapNode, a = this._scrollBar, r = this.isDocked() ? 0 : this.isFixed() ? 0 : this._position[1], s = e ? this.getMaxHeight() : n ? a.getTargetNode().getHeight() : o.getHeight(), l = r + s, p = i.getHeight(), h = window.innerHeight, d = h - l - p;
                if (d < 0) {
                    if (t = s + d,
                    !n)
                        return this._addScrollWrap(t),
                        void this.dispatchEvent(new u(this,g.PANEL_SCROLL_WRAP_ADDED,null));
                    a.setWrapHeight(t),
                    o.setHeight(t)
                } else
                    !e && n && (a.removeFromParent(),
                    o.addChild(this._listNode),
                    o.deleteStyleProperty("height"),
                    this._scrollBar.removeMouseListener(),
                    this._scrollBar = null,
                    this.dispatchEvent(new u(this,g.PANEL_SCROLL_WRAP_REMOVED,null)))
            }
        }
        ,
        ...
        i.prototype.addGroup = function(t) {
            ...
            this.isDocked() && this.dispatchEvent(new u(this,g.PANEL_SIZE_CHANGE)),
            this
        }
        ,
        i.prototype.addSubGroup = function(t) {
        ...
        i.prototype._addComponent = function() {
            ...
            return 0 == e.length && e.push(new a(this)),
            t = e[e.length - 1],
            t.addComponent.apply(t, arguments),
            this
        }
        ,
        ...
        ,
        i.prototype.getData = function() {
            for (var t = this._groups, e = -1, n = t.length, i = []; ++e < n; )
                i.push(t[e].getData());
            return i
        }
        ,
    ...
    149: function(t, e, n) {
        function i(t, e) {
            ...
            if (u && 0 != u.length && "none" != u) {
                var d = this._headNode = new a
                  , c = new a
                  , g = new a(a.SPAN);
                d.setStyleClass(r.Head),
                c.setStyleClass(r.Wrap),
                g.setStyleClass(r.Label),
                g.setProperty("innerHTML", u),
                c.addChild(g),
                d.addChild(c);
                var v = this._indiNode = new a;
                v.setStyleClass(r.ArrowBSubMax),
                d.addChildAt(v, 0),
                n.addChildAt(d, 0),
                this.addEventListener(h.SUBGROUP_TRIGGER, this._parent, "onSubGroupTrigger"),
                d.addEventListener(l.MOUSE_DOWN, this._onHeadMouseDown.bind(this)),
                this._updateAppearance()
            }
            ...
            this._parent.addEventListener(p.PANEL_SIZE_CHANGE, this, "onPanelSizeChange"),
            this._parent.addEventListener(l.WINDOW_RESIZE, this, "onWindowResize"),
        ...
        i.prototype = Object.create(o.prototype),
        i.prototype.constructor = i,
        i.prototype._onHeadMouseDown = function() {
            this._enabled = !this._enabled,
            this._onTrigger();
            var t = l.MOUSE_UP
              , e = this
        ...
        i.prototype._onTrigger = function() {
            this._updateAppearance(),
            this.dispatchEvent(new s(this,h.SUBGROUP_TRIGGER,null))
        }
        ,
        i.prototype._updateAppearance = function() {
    ...
    181: function(t, e) {
        var n = function() {
            ...
            h.style.cssText = "width:80px;opacity:0.9;cursor:pointer";
            ...
            u.appendChild(c); 74 > c.children.length; ) {
                var g = document.createElement("span");
                g.style.cssText = "width:1px;height:30px;float:left;background-color:#113",
                c.appendChild(g)
            }
            ...
            A.id = "msText",
            A.style.cssText = "color:#0f0;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px",
            A.innerHTML = "MS",
            v.appendChild(A);
            var f = document.createElement("div");
            for (f.id = "msGraph",
            f.style.cssText = "position:relative;width:74px;height:30px;background-color:#0f0",
            v.appendChild(f); 74 > f.children.length; )
            ...
            return {
                ...
                begin: function() {
                    ...
                    i = Math.min(i, n),
                    o = Math.max(o, n),
                    A.textContent = n + " MS (" + i + "-" + o + ")";
                    var h = Math.min(30, 30 - 30 * (n / 200));
                    return f.appendChild(f.firstChild).style.height = h + "px",
                    l++,
                    p > e + 1e3 && (a = Math.round(1e3 * l / (p - e)),
                    r = Math.min(r, a),
                    s = Math.max(s, a),
                    d.textContent = a + " FPS (" + r + "-" + s + ")",
                    h = Math.min(30, 30 - 30 * (a / 100)),
                    c.appendChild(c.firstChild).style.height = h + "px",
                    e = p,
                    l = 0),
                    p
                },
            ...
            t.OBJLoader.prototype = {
                ...
                _createParserState: function() {
                    var t = {
                        ...
                        startObject: function(t, e) {
                            ...
                            if (this.object = {
                                ...
                                _finalize: function(t) {
                                    ...
                                    return e && e.groupEnd === -1 && (e.groupEnd = this.geometry.vertices.length / 3,
                                    e.groupCount = e.groupEnd - e.groupStart,
                                    e.inherited = !1),
                                    t !== !1 && 0 === this.materials.length && this.materials.push({
                                        name: "",
                                        smooth: this.smooth
                                    }),
                                    e
                        ...
                        addFace: function(t, e, n, i, o, a, r, s, l, p, h, u) {
                            var d, c = this.vertices.length, g = this.parseVertexIndex(t, c), v = this.parseVertexIndex(e, c), A = this.parseVertexIndex(n, c);
                            if (void 0 === i ? this.addVertex(g, v, A) : (d = this.parseVertexIndex(i, c),
                            this.addVertex(g, v, d),
                            this.addVertex(v, A, d)),
                            void 0 !== o) {
                                var f = this.uvs.length;
                                g = this.parseUVIndex(o, f),
                                v = this.parseUVIndex(a, f),
                                A = this.parseUVIndex(r, f),
                                void 0 === i ? this.addUV(g, v, A) : (d = this.parseUVIndex(s, f),
                                this.addUV(g, v, d),
                                this.addUV(v, A, d))
                            }
                            if (void 0 !== l) {
                                var m = this.normals.length;
                                g = this.parseNormalIndex(l, m),
                                v = l === p ? g : this.parseNormalIndex(p, m),
                                A = l === h ? g : this.parseNormalIndex(h, m),
                                void 0 === i ? this.addNormal(g, v, A) : (d = this.parseNormalIndex(u, m),
                                this.addNormal(g, v, d),
                                this.addNormal(v, A, d))
                            }
                        },
                        addLineGeometry: function(t, e) {
                            this.object.geometry.type = "Line";
                            for (var n = this.vertices.length, i = this.uvs.length, o = 0, a = t.length; o < a; o++)
                                this.addVertexLine(this.parseVertexIndex(t[o], n));
                ...
                parse: function(e) {
                    ...
                    for (var i = e.split("\n"), o = "", a = "", r = "", s = 0, l = [], p = "function" == typeof "".trimLeft, h = 0, u = i.length; h < u; h++)
                        if (o = i[h],
                        o = p ? o.trimLeft() : o.trim(),
                        s = o.length,
                        0 !== s && (a = o.charAt(0),
                        "#" !== a))
                            if ("v" === a)
                                if (r = o.charAt(1),
                                " " === r && null !== (l = this.regexp.vertex_pattern.exec(o)))
                                    n.vertices.push(parseFloat(l[1]), parseFloat(l[2]), parseFloat(l[3]));
                                else if ("n" === r && null !== (l = this.regexp.normal_pattern.exec(o)))
                                    n.normals.push(parseFloat(l[1]), parseFloat(l[2]), parseFloat(l[3]));
                                else {
                                    if ("t" !== r || null === (l = this.regexp.uv_pattern.exec(o)))
                                        throw new Error("Unexpected vertex/normal/uv line: '" + o + "'");
                                    n.uvs.push(parseFloat(l[1]), parseFloat(l[2]))
                                }
                            else if ("f" === a)
                                if (null !== (l = this.regexp.face_vertex_uv_normal.exec(o)))
                                    n.addFace(l[1], l[4], l[7], l[10], l[2], l[5], l[8], l[11], l[3], l[6], l[9], l[12]);
                                else if (null !== (l = this.regexp.face_vertex_uv.exec(o)))
                                    n.addFace(l[1], l[3], l[5], l[7], l[2], l[4], l[6], l[8]);
                                else if (null !== (l = this.regexp.face_vertex_normal.exec(o)))
                                    n.addFace(l[1], l[3], l[5], l[7], void 0, void 0, void 0, void 0, l[2], l[4], l[6], l[8]);
                                else {
                                    if (null === (l = this.regexp.face_vertex.exec(o)))
                                        throw new Error("Unexpected face line: '" + o + "'");
                                ...
                                n.object.startMaterial(o.substring(7).trim(), n.materialLibraries);
                            else if (this.regexp.material_library_pattern.test(o))
                                n.materialLibraries.push(o.substring(7).trim());
                            else {
                    ...
                    for (var h = 0, u = n.objects.length; h < u; h++) {
                        ...
                        if (0 !== C.vertices.length) {
                            ...
                            P.addAttribute("position", new t.BufferAttribute(new Float32Array(C.vertices),3)),
                            C.normals.length > 0 ? P.addAttribute("normal", new t.BufferAttribute(new Float32Array(C.normals),3)) : P.computeVertexNormals(),
                            C.uvs.length > 0 && P.addAttribute("uv", new t.BufferAttribute(new Float32Array(C.uvs),2));
                            for (var S = [], T = 0, N = _.length; T < N; T++) {
                                var L = _[T]
                                  , y = void 0;
                                if (null !== this.materials && (y = this.materials.create(L.name),
                                E && y && !(y instanceof t.LineBasicMaterial))) {
                                    var V = new t.LineBasicMaterial;
                                    V.copy(y),
                                    y = V
                                }
                                y || (y = E ? new t.LineBasicMaterial : new t.MeshPhongMaterial,
                                y.name = L.name),
                                y.shading = L.smooth ? t.SmoothShading : t.FlatShading,
                                S.push(y)
                            }
                            var O;
                            if (S.length > 1) {
                                ...
                                O = E ? new t.Line(P,S[0]) : new t.Mesh(P,S[0]);
                            O.name = w.name,
                            x.add(O)
                        }
                    }
    ...
    220: function(t, e, n) {
        ...
        function i(t) {
            ...
            t = t || {},
            this.setShader(r, s),
            this.params.mode = t.mode || 1,
            this.params.opacity = t.opacity || 1,
            this.params.tInput2 = t.tInput2 || null,
            this.params.resolution2 = t.resolution2 || new o.Vector2,
            this.params.sizeMode = t.sizeMode || 1,
            this.params.aspectRatio = t.aspectRatio || 1,
            this.params.aspectRatio2 = t.aspectRatio2 || 1
        }
        var o = n(23)
          , a = n(31)
          , r = n(56)
    ...
    221: function(t, e, n) {
        ...
        function i(t, e) {
            a.call(this),
            this.setShader(r, s),
            this.params.delta = new o.Vector2(t || 0,e || 0)
        }
        var o = n(23)
          , a = n(31)
          , r = n(56)
    ...
    222: function(t, e, n) {
        ...
        i.prototype.run = function(t) {
            ...
            this.boxPass.params.delta.set(e, 0),
            t.pass(this.boxPass),
            this.boxPass.params.delta.set(0, e),
            t.pass(this.boxPass)
        }
    },
    223: function(t, e, n) {
        ...
        function i(t) {
            ...
            t = t || {},
            this.setShader(a, r),
            this.params.focalDistance = t.focalDistance || .01,
            this.params.aperture = t.aperture || .005,
            this.params.tBias = t.tBias || null,
            this.params.blurAmount = t.blurAmount || 1
        }
        var o = n(31)
          , a = n(56)
          , r = n(601);
    ...
    224: function(t, e, n) {
        ...
        function i(t) {
            ...
            t = t || {},
            this.setShader(r, s),
            this.blurPass = new a(2),
            this.width = t.width || 512,
            this.height = t.height || 512,
            this.params.blurAmount = t.blurAmount || 2,
            this.params.fX = .5,
            this.params.fY = .5,
            this.params.fExposure = .6,
            this.params.fDecay = .93,
            this.params.fDensity = .88,
            this.params.fWeight = .4,
            this.params.fClamp = 1
        }
        var o = (n(23),
        n(31))
          , a = n(222)
            ...
            var s = function() {
              ...
              , y = function(e) {
                function n(e) {
                    ...
                    return i.maxShakeOffset = 10,
                    i.explosionTime = 2e3,
                    i.explosionOffset = 700,
                    i.floatingRotationSpeed = 0,
                    i.skullRotationSpeed = 0,
                    i.currentMouseRotation = new t.Vector2,
                    i.targetMouseRotation = new t.Vector2,
                    i.skullRotation = new t.Euler,
                    i.mouseRotationRelevance = 1,
                    i.hasDOF = !1,
                    i.isShaking = !1,
                    i.isExploding = !1,
                    i.isFloating = !1,
                    i.renderer = e,
                    i.loadModel().then(i.setup.bind(i)),
                    i
                }
                return r(n, e),
                s(n, [{
                    ...
                    value: function() {
                        ...
                        return new Promise(function(e, n) {
                            var i = new p.default;
                            i.load(b, function(n) {
                                t.skullMesh = n.children[0],
                                t.verticeCount = t.skullMesh.geometry.attributes.position.array.length / 3,
                                e(n)
                            })
                        }
                        )
                    ...
                    value: function() {
                        ...
                        this.skullMesh.material = n,
                        this.skullMesh.scale.set(.14, .14, .14),
                        this.skullMesh.geometry.center(),
                        this.skullMesh.geometry.computeVertexNormals(),
                        this.skullMesh.position.set(0, 10, 0),
                        this.skullGroup = new t.Object3D,
                        this.skullGroup.add(this.skullMesh),
                        this.add(this.skullGroup)
                    }
                }, {
                    key: "setupFloating",
                    value: function() {
                    ...
                    value: function() {
                        var e = new t.PlaneBufferGeometry(40,70)
                          ...
                          , i = new t.Mesh(e,n);
                        i.rotation.set(85 / 360 * Math.PI * 2, 0, 0),
                        i.position.set(0, -30, 0),
                        this.floor = i,
                        this.add(i)
                    }
                }, {
                    ...
                    value: function() {
                        var e = new t.CircleGeometry(10,32)
                          ...
                          , i = new t.Mesh(e,n);
                        i.position.set(9, 7, 0),
                        i.scale.set(.01, .01, .01),
                        i.isRendered = !0;
                        var o = new t.Mesh(e.clone(),n.clone());
                        o.position.set(-9, 7, 0),
                    ...
                    value: function() {
                        ...
                        r.to(e, 2, {
                            progress: 0,
                            onUpdate: function() {
                                for (var o = 0; o < t.verticeCount; o++)
                                    n[o] = i[o] * e.progress;
                                t.skullMesh.geometry.attributes.aOffset.needsUpdate = !0,
                                t.skullMesh.material.uniforms.uLightPosScale.value = 1 - .9 * e.progress
                            },
                            ease: Power4.easeOut
                        }, "start"),
                        r.fromTo(this.skullMesh.material.uniforms.uFloatingData.value, 2.5, {
                            y: 50 * Math.random() + 50
                        }, {
                            y: 0,
                            ease: Power4.easeOut
                        }, "start"),
                        r.fromTo(this.skullMesh.material.uniforms.uOpacity, 2.5, {
                            value: 0
                        }, {
                            value: 1,
                            ease: Power2.easeOut
                        }, "start"),
                        r.fromTo(this.floor.material.uniforms.uOpacity, .4, {
                            value: 0
                        }, {
                            value: 1,
                            ease: Power2.easeOut
                        }, "start+=2"),
                        r.to(this.skullGroup.position, 3, {
                            y: -3,
                            ease: Power1.easeInOut,
                            repeat: -1,
                            yoyo: !0
                        }, "start+=2.4"),
                        r.to(this.floor.scale, 3, {
                            x: 1.2,
                            y: 1.2,
                            ease: Power1.easeInOut,
                            repeat: -1,
                    ...
                    key: "onKeyDown",
                    value: function() {
                        this.isShaking || this.isExploding || this.isFloating || this.isReassambling || this.startShaking(),
                        this.isKeyDown = !0
                    }
                }, {
                    key: "onKeyUp",
                    value: function() {
                        this.isShaking ? this.stopShaking() : this.isFloating && this.stopFloating(),
                        this.isKeyDown = !1
                    }
                }, {
                    key: "startShaking",
                    value: function() {
                        if (!this.isShaking && !this.isExploding) {
                            this.isShaking = !0,
                            this.shakeStartTime = +new Date,
                            v.default.fadeIn("explosion"),
                            this.animateInTl.pause();
                    ...
                    value: function() {
                        ...
                        if (this.isShaking) {
                            ...
                            o.to([this.light1.scale, this.light2.scale], .3, {
                                x: .01,
                                y: .01,
                                z: .01
                            }, "start"),
                            o.to(this.skullRotation, .3, {
                                x: 0,
                                y: 0,
                                z: 0
                            }, "start"),
                            o.to(this.floor.material.uniforms.uOpacity, .3, {
                                value: 1
                            }, "start"),
                            o.to(this, .3, {
                            ...
                            this.animateInTl.resume()
                        }
                    }
                }, {
                    key: "startFloating",
                    value: function() {
                        this.isFloating || (this.isFloating = !0,
                        this.skullMesh.material.uniforms.uFloatingData.value.x = 1)
                    }
                }, {
                    key: "stopFloating",
                    value: function() {
                        ...
                        if (this.isFloating) {
                            this.isFloating = !1,
                            this.isReassambling = !0,
                            v.default.fadeOut("closedLoop"),
                            v.default.fadeIn("reassambly");
                            var e = this.skullMesh.geometry.attributes.aOffset.array
                              , n = this.skullMesh.geometry.attributes.aOffset.array.slice(0)
                              , i = {
                                progress: 1
                            ...
                            var a = new TimelineMax({
                                onComplete: function() {
                                    t.skullMesh.material.uniforms.uFloatingData.value.x = 0,
                                    t.animateInTl.resume(),
                                    t.isReassambling = !1
                                }
                            });
                            a.to(i, 2, {
                                ...
                                onUpdate: function() {
                                    for (var o = 0; o < t.verticeCount; o++)
                                        e[o] = n[o] * i.progress;
                                    t.skullMesh.geometry.attributes.aOffset.needsUpdate = !0,
                                    t.hasDOF && i.progress < .1 && (t.hasDOF = !1)
                                },
                                ease: Expo.easeInOut
                            }, "start"),
                            a.to(this.floor.material.uniforms.uOpacity, .4, {
                                value: 1,
                                ease: Power2.easeOut
                            }, "start+=1.5"),
                            a.to(this.skullRotation, 2, {
                                x: 0,
                                y: o.y,
                                z: 0,
                                ease: Expo.easeInOut,
                                onComplete: function() {
                                    t.skullRotation.set(0, 0, 0),
                                    t.lightCylinder.isRendered = !1,
                                    t.light1.isRendered = !0,
                                    t.light2.isRendered = !0,
                                    t.light1.scale.set(.01, .01, .01),
                                    t.light2.scale.set(.01, .01, .01),
                                    t.light1.position.z = 0,
                                    t.light2.position.z = 0,
                                    t.lightCylinder.position.z = 50
                                }
                            }, "start"),
                            a.set(this, {
                            ...
                            a.to(this.skullMesh.material.uniforms.uFloatingData.value, 2, {
                                y: 0,
                                ease: Expo.easeInOut
                            }, "start"),
                            a.to(this, .3, {
                            ...
                            a.to(this.skullMesh.material.uniforms.uLightPosScale, 2, {
                                value: 1,
                                ease: Expo.easeInOut
                            }, "start"),
                            a.to(this.logo.material.uniforms.uOpacity, .3, {
                                value: 0,
                    ...
                    value: function() {
                        ...
                        this.isExploding || !function() {
                            ...
                            var e = {
                              ...
                              , n = new TimelineMax({
                                onComplete: function() {
                                    console.log("EXPLO DONE"),
                                    t.isExploding = !1,
                                    t.lightCylinder.isRendered = !1,
                                    t.light1.isRendered = !1,
                                    t.light2.isRendered = !1,
                                    t.startFloating(),
                            ...
                            n.to(e, .6, {
                                ...
                                onUpdate: function() {
                                    ...
                                    t.skullMesh.geometry.attributes.aOffset.needsUpdate = !0,
                                    t.skullMesh.material.uniforms.uLightPosScale.value = 1 - .9 * e.particleProgress,
                                    t.hasDOF = !0
                                }
                            }, "start"),
                            n.to(e, 2, {
                            ...
                            n.to(e, .4, {
                                ...
                                onUpdate: function() {
                                    ...
                                    t.light1.scale.set(n, n, n),
                                    t.light2.scale.set(n, n, n),
                                    t.light1.position.z = 30 * e.eyeLightProgress,
                                    t.light2.position.z = 30 * e.eyeLightProgress
                                }
                            }, "start"),
                            n.to(e, .4, {
                                lightProgress: 1,
                            ...
                            n.to(t.logo.material.uniforms.uOpacity, .3, {
                                value: 1,
                                ease: Power0.easeNone,
                                onStart: function() {
                                    t.logo.visible = !0
                    ...
                    key: "prepGodRayPass",
                    value: function() {
                        this.light1.visible = this.light1.isRendered,
                        this.light2.visible = this.light2.isRendered,
                        this.lightCylinder.visible = this.lightCylinder.isRendered,
                        this.skullMesh.material.uniforms.uDOFData.value.x = 0,
                        this.skullMesh.material.uniforms.uGodrayBlend.value = 1,
                        this.logo.material.uniforms.uDOFData.value.x = 0
                    }
                }, {
                    key: "prepDOFPass",
                    value: function(t, e) {
                        this.light1.visible = !1,
                        this.light2.visible = !1,
                        this.lightCylinder.visible = !1,
                        this.skullMesh.material.uniforms.uGodrayBlend.value = 0,
                        this.skullMesh.material.uniforms.uDOFData.value.set(1, 0, 200),
                        this.logo.material.uniforms.uDOFData.value.set(1, 0, 200)
                    }
                }, {
                    key: "prepBlendPass",
                    value: function() {
                    ...
                    key: "rotateHead",
                    value: function(t) {
                        this.skullRotation.x > t ? this.skullRotation.x -= .05 * Math.random() : this.skullRotation.x < -t ? this.skullRotation.x += .05 * Math.random() : Math.random() > .5 ? this.skullRotation.x -= .05 * Math.random() : this.skullRotation.x += .05 * Math.random(),
                        this.skullRotation.y > t ? this.skullRotation.y -= .05 * Math.random() : this.skullRotation.y < -t ? this.skullRotation.y += .05 * Math.random() : Math.random() > .5 ? this.skullRotation.y -= .05 * Math.random() : this.skullRotation.y += .05 * Math.random()
                    }
                }, {
                    key: "update",
                    value: function() {
                        if (this.isShaking) {
                            ...
                            this.light1.scale.set(n, n, n),
                            this.light2.scale.set(n, n, n);
                            for (var i = 0; i < this.verticeCount; i += 3) {
                                var o = t[i]
                                  , a = o;
                                o <= 0 ? a += .5 * Math.random() + 2 * e : o >= this.maxShakeOffset + 5 * e ? a -= .5 * Math.random() + 2 * e : Math.random() > .5 ? a += .5 * Math.random() + 2 * e : a -= .25 * Math.random() + 1 * e,
                                t[i] = a,
                                t[i + 1] = a,
                                t[i + 2] = a
                            }
                            this.skullMesh.geometry.attributes.aOffset.needsUpdate = !0,
                            this.rotateHead(Math.min(.3, .15 * e)),
                            this.floor.material.uniforms.uOpacity.value = 1 - e,
                            +new Date - this.shakeStartTime >= this.explosionTime && (this.isShaking = !1,
                            this.explode())
                        }
                        this.skullRotation.y += this.skullRotationSpeed,
                        this.skullMesh.material.uniforms.uFloatingData.value.y += this.floatingRotationSpeed,
                        this.currentMouseRotation = this.targetMouseRotation.clone().sub(this.currentMouseRotation).multiplyScalar(.1).add(this.currentMouseRotation);
                        var r = this.currentMouseRotation.multiplyScalar(this.mouseRotationRelevance);
                        this.skullGroup.rotation.copy(this.skullRotation),
                        this.skullGroup.rotation.x += r.y,
                        this.skullGroup.rotation.y += r.x,
                        this.isShaking && this.lightGroup.rotation.copy(this.skullGroup.rotation),
                        this.floor.rotation.z = -this.skullGroup.rotation.y,
                        h.controlKit.update(),
                        this.logo.update()
                    }
                }]),
                ...
                s(n, [{
                    ...
                    value: function() {
                        ...
                        return new Promise(function(e, n) {
                            ...
                            i.onload = function() {
                                t.spriteFrames = 25,
                                t.spriteSize = i.height / t.spriteFrames,
                                t.logo = i,
                                e(i)
                            }
                            ,
                    ...
                    value: function(e) {
                        ...
                        n.magFilter = t.LinearFilter,
                        n.minFilter = t.LinearFilter,
                    ...
                    key: "update",
                    value: function() {
                        this.isReady && (this.material.uniforms.uTime.value += 1,
                        +new Date - this.lastFrame > 1e3 / this.fps && (this.material.uniforms.uImagePosition.value.y = Math.floor(25 * Math.random()),
                        this.lastFrame = +new Date),
                        this.material.uniforms.uImagePosition.value.y >= this.spriteFrames && (this.material.uniforms.uImagePosition.value.y = 0))
                    }
                }]),
                n
            }(t.Object3D);
            ...
            var L = window.APP.isMobile ? "Tap & Hold" : "Hold Space"
              , V = function() {
                function e(n, i) {
                    o(this, e),
                    this.isActive = !1,
                    this.mousePosition = new t.Vector2,
                    (0,
                    y.default)(this),
                    this.$node = n,
                    this.$hint = i,
                ...
                return a(e, [{
                    ...
                    value: function() {
                        ...
                        this.mainComposer = new h.default.Composer(i,{
                            useRGBA: !0,
                        ...
                        this.blendPass = new d.default,
                        this.godrayPass = new g.default,
                        this.dofPass = new A.default,
                        this.noisePass = new m.default,
                        this.blendPass.params.mode = 9,
                        this.godrayPass.params.fExposure = .7,
                        this.dofPass.params.focalDistance = .5,
                        this.dofPass.params.aperture = .001,
                        this.noisePass.params.speed = .45,
                        this.noisePass.params.amount = .15;
                        this.depthTexture = this.godrayPass.getOfflineTexture(window.innerWidth * window.devicePixelRatio, window.innerHeight * window.devicePixelRatio, !1),
                        this.compWidth = window.APP.isMobile ? window.innerWidth : window.innerWidth * window.devicePixelRatio,
                        this.compHeight = window.APP.isMobile ? window.innerHeight : window.innerHeight * window.devicePixelRatio,
                        this.mainComposer.setSize(this.compWidth, this.compHeight),
                        this.secondaryComposer.setSize(this.compWidth, this.compHeight),
                        this.camera = e,
                        this.scene = n,
                        this.renderer = i,
                        this.setupScene(),
                    ...
                    value: function() {
                        this.onResize = (0,
                        l.default)(this.onResize, 100)
                    }
                }, {
                    key: "setupListeners",
                    value: function() {
                        DOMUtils.on(window, "resize", this.onResize),
                        window.APP.isMobile || DOMUtils.on(this.$node, "mousemove", this.onMouseMove),
                        DOMUtils.on(window, "keydown", this.onKeyDown),
                        DOMUtils.on(window, "keyup", this.onKeyUp),
                        DOMUtils.on(this.$node, "touchstart", this.onTouchStart),
                        DOMUtils.on(this.$node, "touchend", this.onTouchEnd)
                    }
                }, {
                    key: "destroyListeners",
                    value: function() {
                        DOMUtils.off(window, "resize", this.onResize),
                        window.APP.isMobile || DOMUtils.off(this.$node, "mousemove", this.onMouseMove),
                        DOMUtils.off(window, "keydown", this.onKeyDown),
                        DOMUtils.off(window, "keyup", this.onKeyUp),
                        DOMUtils.off(this.$node, "touchstart", this.onTouchStart),
                        DOMUtils.off(this.$node, "touchend", this.onTouchEnd)
                    }
                }, {
                    key: "setupScene",
                    value: function() {
                        this.head = new _.default(this.renderer),
                    ...
                    value: function() {
                        ...
                        t.innerHTML = '<img class="symbol" src="assets/images/symbol-l.png" /><img class="symbol" src="assets/images/symbol-e.png" /><img class="symbol" src="assets/images/symbol-h.png" />',
                        this.$node.appendChild(t),
                        this.$symbols = DOMUtils.q(".symbol", this.$node),
                        TweenMax.set(this.$symbols, {
                            autoAlpha: 0
                        }),
                        this.symbolsAppearOrder = [0, 1, 0, 0, 1, 2],
                        this.symbolCorners = [{
                            left: "20%",
                            top: "20%"
                        }, {
                        ...
                        this.lastSymbolSwitch = +new Date,
                        this.symbolSwitchDelay = 2e3 * Math.random() + 500
                    }
                }, {
                    key: "showNextSymbol",
                    value: function() {
                        ...
                        o.set(t, {
                            ...
                            autoAlpha: 0,
                            ease: Power2.easeOut
                        }, "start+=" + .2 * Math.random() + 1),
                        this.currentSymbolIndex++,
                        this.currentSymbolIndex >= this.symbolsAppearOrder.length && (this.currentSymbolIndex = 0),
                        this.lastSymbolSwitch = +new Date,
                        this.symbolSwitchDelay = 1e3 * Math.random() + 500
                    }
                }, {
                    key: "setupDebug",
                    value: function() {
                        this.godrayPass.params.range = [0, 5],
                        this.dofPass.params.focalDistanceRange = [0, 1],
                        this.dofPass.params.apertureRange = [0, .01],
                        this.noisePass.params.amountRange = [0, 1],
                        this.noisePass.params.speedRange = [0, 10],
                        w.default.addGroup({
                            label: "GodrayPass"
                    ...
                    key: "unmute",
                    value: function() {
                        this.isMuted && (this.isMuted = !1,
                        N.default.unmute())
                    }
                }, {
                    key: "render",
                    value: function() {
                        if (this.isActive && requestAnimationFrame(this.render.bind(this)),
                        !this.head.isFloating && !this.head.isExploding && +new Date - this.lastSymbolSwitch > this.symbolSwitchDelay && this.showNextSymbol(),
                        this.head.update(),
                        this.head.light1 && this.head.light2) {
                            if (this.head.isShaking || this.head.isExploding) {
                                this.head.prepGodRayPass(),
                                this.renderer.setClearColor(0, 1);
                                var t = this.head.getLightScreenPos(this.camera);
                                this.secondaryComposer.reset(),
                                this.secondaryComposer.render(this.scene, this.camera),
                                this.godrayPass.params.fX = t.x,
                                this.godrayPass.params.fY = t.y,
                                this.secondaryComposer.pass(this.godrayPass)
                            }
                            this.mainComposer.reset(),
                            this.head.hasDOF && !window.APP.isMobile && (this.head.prepDOFPass(this.camera.near, this.camera.far),
                            this.mainComposer.render(this.scene, this.camera, null, this.depthTexture),
                            this.dofPass.params.tBias = this.depthTexture),
                            this.renderer.setClearColor(15724527, 1),
                            this.head.prepBlendPass(),
                            this.mainComposer.render(this.scene, this.camera),
                            this.head.hasDOF && !window.APP.isMobile && this.mainComposer.pass(this.dofPass),
                            (this.head.isShaking || this.head.isExploding) && (this.blendPass.params.tInput2 = this.secondaryComposer.output,
                            this.mainComposer.pass(this.blendPass)),
                            window.APP.isMobile || this.mainComposer.pass(this.noisePass),
                            this.mainComposer.toScreen()
                        }
                    }
                }, {
                    key: "onResize",
                    value: function() {
                        ...
                        this.compWidth = window.APP.isMobile ? window.innerWidth : window.innerWidth * window.devicePixelRatio,
                        this.compHeight = window.APP.isMobile ? window.innerHeight : window.innerHeight * window.devicePixelRatio,
                        this.mainComposer.setSize(window.innerWidth * window.devicePixelRatio, window.innerHeight * window.devicePixelRatio),
                        this.secondaryComposer.setSize(this.compWidth, this.compHeight),
                        this.depthTexture.setSize(window.innerWidth * window.devicePixelRatio, window.innerHeight * window.devicePixelRatio),
                        this.head.onResize()
                    }
                }, {
                    key: "onMouseMove",
                    ...
                    value: function(t) {
                        t.preventDefault(),
                        this.head.isReassambling || this.head.startShaking()
                    }
                }, {
                    key: "onTouchEnd",
                    value: function(t) {
                        t.preventDefault(),
                        this.head.isReassambling || this.head.stopShaking()
                    }
                }]),
                e
            }();
