...
, function(t, e, n) {
    function i(t, e, n, i) {
        ...
        i = i || {},
        i.label = i.label || n,
        r.apply(this, [t, i.label]),
        this._obj = e,
        this._key = n,
        this._onChange = function() {}
        ,
        a.get().addEventListener(s.UPDATE_VALUE, this, "onValueUpdate"),
        this.addEventListener(s.VALUE_UPDATED, a.get(), "onValueUpdated")
    }
    var o = n(37)
      , r = n(49)
      , s = n(7)
    ...
    i.prototype.setValue = function(t) {
        ...
        this.dispatchEvent(new u(this,s.VALUE_UPDATED,null))
    }
    ,
...
, , , , , function(t, e, n) {
    function i() {
        ...
        this._onDocumentMouseWheel = function(e) {
            ...
            t.dispatchEvent(new r(t,s.MOUSE_WHEEL,e))
        }
        ,
        document.addEventListener(s.MOUSE_MOVE, this._onDocumentMouseMove),
        document.addEventListener(s.MOUSE_WHEEL, this._onDocumentMouseWheel)
    }
    var o = n(17)
      , r = n(4)
      , s = n(9)
    ...
    i.prototype._removeDocumentListener = function() {
        document.removeEventListener(s.MOUSE_MOVE, this._onDocumentMouseMove),
        document.removeEventListener(s.MOUSE_WHEEL, this._onDocumentMouseWheel)
    }
    ,
...
, , , , , function(t, e, n) {
    function i(t) {
        ...
        ,
        this._unfocusable = !1,
        document.addEventListener(r.MOUSE_DOWN, this._onDocumentMouseDown.bind(this)),
        document.addEventListener(r.MOUSE_UP, this._onDocumentMouseUp.bind(this)),
        this.clear()
    }
    var o = n(3)
      , r = n(9)
        ...
        build: function(t, e, n, i, r, h, d, c) {
            ...
            if (d) {
                ...
                for (var b, x; ++y < t.length; ) {
                    ...
                    b.getStyle().backgroundColor = x,
                    b.getStyle().backgroundImage = "linear-gradient( rgba(0,0,0,0) 0%, rgba(0,0,0,0.1) 100%)",
                    b.setProperty("innerHTML", f),
                    f == e && A.setStyleClass(a.OptionsSelected),
                    A.addEventListener(s.MOUSE_DOWN, function() {
                        m._selectedIndex = Array.prototype.indexOf.call(this.parentNode.children, this),
                        i()
                    })
                }
            } else
                for (v.deleteStyleClass(); ++y < t.length; )
                    f = t[y],
                    A = v.addChild(new o(o.LIST_ITEM)),
    ...
    i.prototype.popState = function() {
        if (!this._enabled) {
            ...
            if (!(t.length < 1)) {
                ...
                this.dispatchEvent(new r(this,s.STATE_POP,null))
            }
        }
    }
    ,
...
, , , , function(t, e, n) {
    ...
    a._node._element.style.display = "none",
    e.default = s;
    e.controlKit = a
}
, , , , , , , function(t, e, n) {
    ...
    NumberInput_Internal = function(t, e, n, i, s, a) {
        ...
        l || (p.getElement().setSelectionRange ? (l = function(t, e) {
    ...
    NumberInput_Internal.prototype._onInput = function() {
        ...
        a.test(e) && "-" != e ? (this._onBegin(this._value),
        this._setValue(e),
    ...
    NumberInput_Internal.prototype._onKeydown = function(t) {
        ...
        if (x)
            return w ? (i(n, "-0"),
            l(n, 1)) : (i(n, h ? 0 : String.fromCharCode(e)),
            l(n, g ? r : a)),
            void t.preventDefault();
        if (h && r - 1 == _)
            return void l(n, r - 1);
        ...
        if (m) {
            var P = (f ? s : 1) * this._valueStep
              , C = 38 == e ? 1 : -1;
            return i(n, Number(o) + P * C),
            l(n, r),
            void t.preventDefault()
        }
        return !b || f && A ? !f && !A && !h && r > _ && r < p ? (o = o.substr(0, r) + String.fromCharCode(e) + o.substr(r + 1, p - 1),
        i(n, o),
        l(n, Math.min(r + 1, p - 1)),
        void t.preventDefault()) : void (!h && !A && !m && r >= p && t.preventDefault()) : (A ? l(n, g ? r : a) : (o = o.substr(0, r) + String.fromCharCode(e) + o.substr(a, p - a),
        i(n, o),
        l(n, a)),
        void t.preventDefault())
    }
...
, , , , , , function(t, e, n) {
    function i(t) {
        ...
        ,
        this._isActive = !1,
        e.setStyleClass(p.ButtonPreset),
        e.addEventListener(l.MOUSE_DOWN, this._onMouseDown.bind(this)),
        e.addChild(n),
        t.addChildAt(e, 0),
        r.get().addEventListener(a.TRIGGER, this, "onOptionTrigger"),
        this.addEventListener(a.TRIGGERED, r.get(), "onOptionTriggered")
    }
    var o = n(17)
      , r = n(50)
      , s = n(4)
    ...
    i.prototype.onOptionTrigger = function(t) {
        ...
        this._btnNode.setStyleClass(p.ButtonPresetActive),
    ...
    i.prototype.deactivate = function() {
        this._isActive = !1,
        this._btnNode.setStyleClass(p.ButtonPreset)
    }
    ,
    t.exports = i
}
, function(t, e, n) {
    function i(t, e, n, i) {
        ...
        l.style.stroke = "rgb(" + s[0] + "," + s[1] + "," + s[2] + ")",
        l.style.strokeWidth = r,
        l.style.fill = "none"
    }
    var o = n(137);
    i.prototype = Object.create(o.prototype),
...
, function(t, e, n) {
    function i(t, e, n, i) {
        ...
        i = i || {},
        i.height = i.height || u,
        i.resolution = i.resolution || s;
        for (var p = i.resolution, h = Math.floor(l / p), d = this._points = new Array(2 * h), c = this._buffer0 = new Array(h), g = this._buffer1 = new Array(h), v = .5 * this._lineWidth, A = -1; ++A < h; )
            c[A] = g[A] = d[2 * A] = d[2 * A + 1] = v;
        this._height = i.height = i.height < r.COMPONENT_MIN_HEIGHT ? r.COMPONENT_MIN_HEIGHT : i.height,
        this._svgSetSize(u, Math.floor(i.height)),
    ...
    i.prototype._drawCurve = function() {
        ...
        o[1] = n[0],
        n[r - 1] = e * l * -1 + Math.floor(a),
        s += this._pathCmdMoveTo(o[0], o[1]);
        for (var u, p = 0; ++p < r; )
            u = 2 * p,
            i[p - 1] = n[p],
            o[u + 1] = n[p - 1] = i[p - 1],
            s += this._pathCmdLineTo(o[u], o[u + 1]);
    ...
    var n = {
        HSV2RGB: function(t, e, n) {
            var i = 360
              ...
              , a = 0;
            if (t %= i,
            n = Math.max(a, Math.min(n, r)) / r * 255,
            e <= s)
        ...
        RGB2HSV: function(t, e, n) {
            ...
            var l = t == s ? e - n : n == s ? t - e : n - t
              , u = t == s ? 3 : n == s ? 1 : 5;
            return i = Math.round(60 * (u - l / (a - s))),
            o = Math.round((a - s) / a * 100),
            r = Math.round(100 * a),
            [i, o, r]
        },
...
, function(t, e, n) {
    function i(t, e, n) {
        ...
        this._scrollMin = 0,
        this._scrollMax = 0,
        p.setPositionY(r.SCROLLBAR_TRACK_PADDING),
        ...
        this._onMouseWheel = function(t) {
            ...
            if (n == h || n == d) {
                ...
                c._scroll(p.getPositionY() + e.getWheelDirection() * i * -1),
    ...
    i.prototype.update = function() {
        ...
        !(a > 1)) {
            var l = s * a;
            this._scrollHeight = s,
            this._scrollUnit = o - this._scrollHeight - 2 * n,
            this._scrollMin = n,
            this._scrollMax = n + s - l,
            e.setHeight(l),
            this._isValid = !0
        }
    }
    ...
    i.prototype._updateAppearance = function() {
        ...
        this._thumbNode.setPositionY(r.SCROLLBAR_TRACK_PADDING)) : this._node.setStyleProperty("display", "block")
    }
    ,
...
, function(t, e, n) {
    function i(t, e) {
        ...
        this._setCanvasSize(s, s),
        this._updateHeight(),
        this._node.setStyleClass(r.CanvasListItem),
...
, function(t, e, n) {
    function i(t, e, n, i) {
        ...
        U.setStyleClass(s.GraphSliderYHandle),
        z.addChild(K),
        H.addChild(U),
        M.addChild(z),
        R.addChild(H);
        ...
        if (Y == a.IMPLICIT) {
            ...
            Z.style.width = Z.style.height = G + "px",
            Z.width = Z.height = G,
            k.getElement().insertBefore(Z, D),
            this._canvasContext = Z.getContext("2d"),
        ...
        U.addEventListener(d.MOUSE_DOWN, this._onSliderYHandleDown.bind(this));
        var X = this._units = [null, null];
        this._scale = null,
        Y == a.NON_IMPLICIT ? (X[0] = f,
        X[1] = m,
        this._scale = _) : Y == a.IMPLICIT && (X[0] = y,
        X[1] = b,
        this._scale = P),
        this._unitsMinMax = [x, w],
        this._scaleMinMax = [C, E],
        ...
        D.addEventListener(p.MOUSE_DOWN, this._onDragStart.bind(this), !1),
        this._wrapNode.getElement().addEventListener("mousewheel", this._onScale.bind(this, !1)),
        v.get().addEventListener(h.UPDATE_VALUE, this, "onValueUpdate")
    }
    var o = n(63)
      , r = n(3)
      , s = n(2)
    ...
    i.prototype._updateCenter = function() {
        var t = this._svg
          ...
          , o = this._svgPos
          , r = this._center;
        r[0] = Math.max(0, Math.min(i[0] - o[0], e)),
        r[1] = Math.max(0, Math.min(i[1] - o[1], n)),
        this._plotGraph()
    }
    ,
    i.prototype._onDragStart = function(t) {
        ...
        var i = p.MOUSE_MOVE
          ...
          , s = function() {
            ...
            document.removeEventListener(o, s, !1)
        }
        .bind(this);
        document.addEventListener(i, r, !1),
        document.addEventListener(o, s, !1),
        this._updateCenter()
    }
    ,
    ...
    i.prototype._drawAxes = function() {
        var t = this._svg
          ...
          , r = i[1]
          , s = "";
        s += this._pathCmdLine(0, r, e, r),
        s += this._pathCmdLine(o, 0, o, n),
        this._axes.setAttribute("d", s)
    }
    ,
    i.prototype._drawPlot = function() {
        var t, e, n, i, o, r, s, l, u, p, h, d = this._center, c = d[0], g = d[1], v = this._units, A = this._scale;
        if (this._plotMode == a.NON_IMPLICIT) {
            ...
            for (h = -1; ++h < m; )
                ...
                y[l + 1] = s;
            var b = "";
            for (b += this._pathCmdMoveTo(y[0], y[1]),
            h = 2; h < y.length; )
                b += this._pathCmdLineTo(y[h], y[h + 1]),
                h += 2;
            ...
            for (var N; ++h < e; )
                for (N = -1; ++N < t; )
                    s = this._func((-u + N * P) * n, (-p + h * C) * i),
                    E[0] = Math.floor((T[0] - S[0]) * s + S[0]),
                    E[1] = Math.floor((T[1] - S[1]) * s + S[1]),
                    E[2] = Math.floor((T[2] - S[2]) * s + S[2]),
                    l = 4 * (h * t + N),
                    _.data[l] = E[0],
                    _.data[l + 1] = E[1],
                    _.data[l + 2] = E[2],
    ...
    ,
    i.prototype._drawGrid = function() {
        var t, e, n = this._svg, i = Number(n.getAttribute("width")), o = Number(n.getAttribute("height")), r = this._scale, s = this._units, a = i / (s[0] * r), l = o / (s[1] * r), p = this._center, h = p[0], d = p[1], c = Math.round(d / l) + 1, g = Math.round((o - d) / l) + 1, v = Math.round(h / a) + 1, A = Math.round((i - h) / a) + 1, f = "", m = "", y = u.STROKE_SIZE, b = u.FUNCTION_PLOTTER_LABEL_TICK_SIZE, x = i - b - y, w = o - b - y, _ = x - b, P = w - b, C = x - 2 * (b + y), E = w - 2 * (b + y);
        for (t = -1; ++t < c; )
            e = Math.round(d - l * t),
            f += this._pathCmdLine(0, e, i, e),
            e > b && (m += this._pathCmdLine(x, e, _, e));
        for (t = -1; ++t < g; )
            e = Math.round(d + l * t),
            f += this._pathCmdLine(0, e, i, e),
            e < E && (m += this._pathCmdLine(x, e, _, e));
        for (t = -1; ++t < v; )
            e = Math.round(h - a * t),
            f += this._pathCmdLine(e, 0, e, o),
            e > b && (m += this._pathCmdLine(e, w, e, P));
        for (t = -1; ++t < A; )
            e = Math.round(h + a * t),
            f += this._pathCmdLine(e, 0, e, o),
            e < C && (m += this._pathCmdLine(e, w, e, P));
    ...
    i.prototype._setValue = function() {
        if (!this._parent.isDisabled()) {
            ...
            if ("object" != typeof n || "number" != typeof n.length || "function" != typeof n.splice || n.propertyIsEnumerable("length"))
                ...
                e = n.slice();
                for (var r, s = -1, a = this._wrap; ++s < e.length; )
                    r = e[s] = e[s].toString(),
                    t = r.indexOf("."),
                    t > 0 && (e[s] = r.slice(0, t + o));
                a && (i.setStyleProperty("white-space", "nowrap"),
                e = e.join("\n")),
...
, function(t, e, n) {
    function i(t, e, n, i) {
        ...
        var u = this._textArea = new r(r.TEXTAREA)
          , p = this._wrapNode
          , A = this._node;
        if (u.setProperty("readOnly", !0),
        p.addChild(u),
        u.addEventListener(h.MOUSE_DOWN, this._onInputDragStart.bind(this)),
        this.addEventListener(d.INPUT_SELECT_DRAG, this._parent, "onComponentSelectDrag"),
        i.height) {
            var f = new r;
            f.setStyleClass(s.TextAreaWrap),
            f.addChild(u),
            p.addChild(f);
            var m = this._height = i.height
              , y = 4;
            u.setHeight(Math.max(m + y, a.COMPONENT_MIN_HEIGHT)),
            p.setHeight(u.getHeight()),
            A.setHeight(p.getHeight() + y),
            this._scrollBar = new l(f,u,m - y)
        }
        i.wrap && u.setStyleProperty("white-space", "pre-wrap"),
        this._prevString = "",
    ...
    i.prototype._onDragFinish = function() {
        this.dispatchEvent(new u(this,d.INPUT_SELECT_DRAG,null)),
        document.removeEventListener(p.MOUSE_MOVE, this._onDrag, !1),
        document.removeEventListener(p.MOUSE_MOVE, this._onDragFinish, !1)
    }
    ,
    i.prototype._onInputDragStart = function() {
        this.dispatchEvent(new u(this,d.INPUT_SELECT_DRAG,null)),
        document.addEventListener(p.MOUSE_MOVE, this._onDrag.bind(this), !1),
        document.addEventListener(p.MOUSE_UP, this._onDragFinish.bind(this), !1)
    }
    ,
    t.exports = i
}
, function(t, e, n) {
    function i(t) {
        ...
        Y.addChildren(F, O.getNode()),
        Z.addChildren(Q, I.getNode()),
        X.addChildren(q, B.getNode());
        ...
        W.addChildren($, D.getNode()),
        j.addChildren(tt, G.getNode()),
        J.addChildren(et, M.getNode()),
        f.addChildren(W, Y, j, Z, J, X, K);
        var nt = new o;
        ...
        rt.setProperty("innerHTML", "#"),
        ot.addChildren(rt, it),
        nt.addChild(ot),
        it.addEventListener(p.CHANGE, this._onInputHEXFinish.bind(this)),
        a.setProperty("innerHTML", "Color Picker"),
        l.addChild(g),
        n.addChild(l),
        i.addChild(a),
        n.addChild(i),
        ...
        v.addEventListener(st, at),
        w.addEventListener(st, at),
        at = this._onCanvasSliderMouseDown.bind(this),
        A.addEventListener(st, at),
        _.addEventListener(st, at),
        g.addEventListener(st, this._onClose.bind(this)),
        z.addEventListener(st, this._onPick.bind(this)),
        H.addEventListener(st, this._onClose.bind(this)),
        n.addEventListener(p.MOUSE_DOWN, this._onHeadDragStart.bind(this)),
        this._parentNode = t,
        ...
        this._imageDataSlider = x.createImageData(y.width, y.height),
        this._imageDataField = b.createImageData(m.width, m.height),
    ...
    i.prototype = {
        _drawHandleField: function() {
            ...
            this._setColorHSV(this._valueHue, l, u),
            this._updateColorRGBFromHSV(),
            this._updateColorHEXFromRGB(),
        ...
        _drawHandleSlider: function() {
            ...
            this._setColorHSV(r, this._valueSat, this._valueVal),
            this._updateColorRGBFromHSV(),
            this._updateColorHEXFromRGB(),
        ...
        _onHeadDragStart: function() {
            ...
            var r = u.MOUSE_MOVE
              ...
              , h = function() {
                ...
                document.removeEventListener(s, h, !1)
            };
            e.removeChild(t),
            e.addChild(t),
            document.addEventListener(r, p, !1),
            document.addEventListener(s, h, !1),
        ...
        _updatePosition: function() {
            ...
            s[1] = Math.max(0, Math.min(i, u)),
            o.setPositionGlobal(s[0], s[1])
        },
        _drawCanvasField: function() {
            for (var t, e = this._canvasField, n = this._contextCanvasField, i = e.width, o = e.height, r = 1 / i, s = 1 / o, a = this._imageDataField, u = [], p = 0, h = this._valueHue, d = -1; ++d < o; )
                for (t = -1; ++t < i; )
                    u = l.HSV2RGB(h, t * r * 100, 100 * (1 - d * s)),
                    p = 4 * (d * i + t),
                    a.data[p] = u[0],
                    a.data[p + 1] = u[1],
                    a.data[p + 2] = u[2],
...
, function(t, e, n) {
    function i(t, e, n, i) {
        ...
        g.setStyleClass(a.Label).setProperty("innerHTML", "MAX");
...
, function(t, e, n) {
    function i(t, e) {
        ...
        this._node = new r(r.LIST_ITEM),
        this._wrapNode = new r,
        this._listNode = new r(r.LIST),
    ...
    i.prototype.addScrollWrap = function() {
        var t = this._wrapNode
          , e = this.getMaxHeight();
        this._scrollBar = new s(t,this._listNode,e),
...
, function(t, e, n) {
    ...
    function i(t, e) {
        ...
        this.renderer = t,
        this.copyPass = new r(this.settings),
...
, function(t, e, n) {
    function i(t) {
        ...
        t.loadAndSave = void 0 === t.loadAndSave ? C : t.loadAndSave,
        t.opacity = void 0 === t.opacity ? w : t.opacity,
        t.panelsClosable = void 0 === t.panelsClosable ? _ : t.panelsClosable,
        t.useExternalStyle = void 0 !== t.useExternalStyle && t.useExternalStyle,
        t.enable = void 0 === t.enable ? P : t.enable,
        ...
        var p = v.setup();
        this._historyEnabled ? (p.addEventListener(c.STATE_PUSH, this, "onHistoryStatePush"),
        p.addEventListener(c.STATE_POP, this, "onHistoryStatePop")) : p.disable(),
        f.setup(),
        a.setup(e),
        s.setup(e);
        var d = t.opacity;
        ...
        if (this._enabled && this._canUpdate) {
            ...
            i = p.length; ++t < i; )
                ...
                !s.isDisabled())
                    ...
                    e = -1,
                    o = a.length; ++e < o; )
                        for (l = a[e].getComponents(),
                        n = -1,
                        r = l.length; ++n < r; )
                            u = l[n],
                            u.isDisabled() || (u instanceof m || u instanceof y || u instanceof b) && u.update()
        }
    }
    ,
...
, function(t, e, n) {
    function i(t, e, n, i) {
        ...
        h.setStyleClass(u.Button),
        h.setProperty("value", e);
        var d = this;
        h.addEventListener(r.ON_CLICK, function() {
            n.bind(d)(),
            d.dispatchEvent(new o(d,s.VALUE_UPDATED))
        }),
...
, function(t, e, n) {
    function i(t, e, n, i) {
        ...
        if (this._presetsKey) {
            ...
            var _ = u.get()
              ...
              , S = function() {
                _.build(v, E._value, s, function() {
                    E.pushHistoryState(),
                    E._value = v[_.getSelectedIndex()],
                    E.applyValue(),
                    E._onChange(E._obj[E._key])
            ...
            s.setStyleClass(d.Color),
            l.addChild(s);
        s.addEventListener(g.MOUSE_DOWN, this._onColorTrigger.bind(this)),
        this._updateColor()
    }
    var o = n(14)
      , r = n(3)
    ...
    i.prototype._onColorTrigger = function() {
        var t, e = this._colorMode, n = s.HEX, i = s.RGB, o = s.RGBfv, r = s.HSV, l = this._value, u = function() {
    ...
    i.prototype._validateColorFormat = function(t, e, n) {
        ...
        if (i == s.HEX && "[object Array]" === Object.prototype.toString.call(t) || i == s.HEX && "[object Float32Array]" === Object.prototype.toString.call(t))
            throw new A(e);
        if ((i == s.RGB || i == s.RGBfv || i == s.HSV) && "[object Array]" !== Object.prototype.toString.call(t) || i == s.HSV && "[object Float32Array]" !== Object.prototype.toString.call(t))
            throw new A(n)
    }
    ,
    t.exports = i
...
, function(t, e, n) {
    function i(t, e, n, i) {
        ...
        if (m) {
            var y = new s;
            y.setStyleClass(u.WrapInputWPreset),
            d.addChild(y),
            y.addChild(h.getNode());
            var b = a.get()
              ...
              , P = function() {
                b.build(m, h.getValue(), h.getNode(), function() {
                    h.setValue(m[b.getSelectedIndex()]),
                    _.applyValue(),
                    _._onChange(_._obj[_._key])
                }, w, p.PADDING_PRESET, !1)
            };
            x.setOnActive(P),
            x.setOnDeactive(w)
        } else
            d.addChild(h.getNode());
        h.getNode().addEventListener(c.MOUSE_DOWN, this._onInputDragStart.bind(this)),
        this.addEventListener(g.INPUT_SELECT_DRAG, this._parent, "onComponentSelectDrag"),
        h.setValue(this._obj[this._key])
    }
    var o = n(14)
      , r = n(48)
      , s = n(3)
...
, function(t, e, n) {
    function i(t, e, n, i) {
        o.apply(this, arguments),
        i = i || {},
        i.boundsX = i.boundsX || u,
        i.boundsY = i.boundsY || p,
        i.labelX = i.labelX || h,
        i.labelY = i.labelY || d,
...
, function(t, e, n) {
    function i(t, e, n, i) {
        ...
        u.setAttribute("version", "1.2"),
        u.setAttribute("baseProfile", "tiny"),
        a.getElement().appendChild(u);
        var p = this._svgRoot = u.appendChild(this._createSVGObject("g"));
        p.setAttribute("transform", "translate(0.5 0.5)"),
        this._svgSetSize(l, l),
        this._updateHeight(),
        this._node.setStyleClass(r.SVGListItem),
...
, function(t, e, n) {
    function i(t, e, n, i) {
        ...
        if (v.setStyleClass(s.Select),
        v.addEventListener(p.MOUSE_DOWN, this._onOptionTrigger.bind(this)),
        this._hasTarget()) {
            for (var A = a[u] || "", f = -1; ++f < h.length; )
                A == h[f] && (this._selected = h[f]);
            v.setProperty("value", A.toString().length > 0 ? A : h[0])
        } else
            v.setProperty("value", i.selected ? h[i.selected] : g);
    ...
    i.prototype.onOptionTrigger = function(t) {
        ...
        this._updateAppearance(),
        void (this._active ? this._buildOptions() : a.get().clear())) : (this._active = !1,
    ...
    i.prototype._applySelected = function(t) {
        ...
        this.dispatchEvent(new u(this,h.VALUE_UPDATED), null)
    }
    ,
    i.prototype.applyValue = function() {
...
, function(t, e, n) {
    function i(t, e, n, i, a) {
        a = a || {},
        a.label = a.label || n,
        o.apply(this, [t, e, i, a]),
        this._values = this._obj[this._key],
        this._targetKey = n,
        a.step = a.step || v,
        a.dp = void 0 === a.dp || null == a.dp ? A : a.dp,
        a.onChange = a.onChange || this._onChange,
        a.onFinish = a.onFinish || function() {}
        ,
        this._dp = a.dp,
        this._onChange = a.onChange,
        this._onFinish = a.onFinish;
        var l = this._values
          , p = this._obj
          , g = this._targetKey
          , f = this._wrapNode;
        ...
        this._parent.addEventListener(h.WINDOW_RESIZE, this, "onWindowResize")
    }
    var o = n(14)
      , r = n(2)
      , s = n(140)
    ...
    i.prototype._onSliderMove = function() {
        ...
        this.dispatchEvent(new p(this,g.VALUE_UPDATED,null)),
        this._onChange()
    }
    ,
...
, function(t, e, n) {
    function i(t, e, n, i) {
        ...
        l.addChild(u.node),
        u.node.addChild(p.node),
        u.offsetX = u.node.getPositionGlobalX(),
        u.width = Math.floor(u.node.getWidth() - 2 * u.padding),
        p.node.setWidth(p.width),
        u.node.addEventListener(s.MOUSE_DOWN, this._onSlotMouseDown.bind(this)),
        u.node.addEventListener(s.MOUSE_UP, this._onSlotMouseUp.bind(this)),
        document.addEventListener(r.MOUSE_MOVE, this._onDocumentMouseMove.bind(this)),
        document.addEventListener(r.MOUSE_UP, this._onDocumentMouseUp.bind(this))
    }
    var o = n(3)
      , r = n(9)
...
, function(t, e, n) {
    function i(t, e, n, i) {
        ...
        if (v) {
            var A = new r;
            A.setStyleClass(s.WrapInputWPreset),
            h.addChild(A),
            A.addChild(p);
            var f = a.get()
              ...
              , x = function() {
                f.build(v, p.getProperty("value"), p, function() {
                    p.setProperty("value", v[f.getSelectedIndex()]),
                    b.pushHistoryState(),
                    b.applyValue()
    ...
    i.prototype.applyValue = function() {
        ...
        this.dispatchEvent(new p(this,c.VALUE_UPDATED,null))
    }
    ,
    i.prototype.onValueUpdate = function(t) {
...
, function(t, e) {
    function n() {
        ...
        return n.document.documentElement.innerHTML = r,
        n
    }
    function i(t) {
        var e = n()
...
, function(t, e, n) {
    function i(t, e) {
        ...
        var n = this._node
          , i = this._wrapNode
          , o = this._listNode;
        n.setStyleClass(s.Group),
        i.setStyleClass(s.Wrap),
        o.setStyleClass(s.SubGroupList),
        i.addChild(o);
        var l = e.label;
        if (l) {
            var u = new a
            ...
            u.setStyleClass(s.Head),
            g.setStyleClass(s.Wrap),
            v.setStyleClass(s.Label),
            A.setStyleClass(s.ArrowBMax),
            v.setProperty("innerHTML", l),
            u.addChild(A),
            g.addChild(v),
            u.addChild(g),
            n.addChild(u),
            u.addEventListener(h.MOUSE_DOWN, this._onHeadTrigger.bind(this)),
        ...
        this.hasMaxHeight()) {
            if (!l) {
                ...
                f.setStyleClass(s.ScrollBuffer),
                n.addChildAt(f, 0)
            }
            var m = this._scrollBufferBottom = new a;
            m.setStyleClass(s.ScrollBuffer),
            n.addChild(m)
        }
        t = this._parent,
        ...
        t.addEventListener(p.WINDOW_RESIZE, this, "onWindowResize"),
    ...
    i.prototype._onHeadTrigger = function() {
        ...
        this._updateAppearance(),
        this.dispatchEvent(new u(this,c.GROUP_LIST_SIZE_CHANGE,null))
    }
    ,
    ...
    i.prototype.setData = function(t) {
        for (var e, n, i = this._components, r = -1, s = 0, a = i.length; ++r < a; )
            e = i[r],
            o(e) && (n = t[s++],
    ...
    ,
    i.prototype.getData = function() {
        for (var t, e = this._components, n = -1, i = e.length, r = []; ++n < i; )
            t = e[n],
            o(t) && r.push(t.getData());
        return r
    }
    ,
    t.exports = i
...
, function(t, e, n) {
    function i(t, e) {
        ...
        e.fixed = void 0 === e.fixed ? Y : e.fixed,
        e.enable = void 0 === e.enable ? U : e.enable,
        e.vconstrain = void 0 === e.vconstrain ? Z : e.vconstrain,
        e.dock && (e.dock.align = e.dock.align || K.align,
        e.dock.resizable = e.dock.resizable || K.resizable),
        this._width = Math.max(D, Math.min(e.width, G)),
        ...
        r) {
            var P = r.align;
            P != l.LEFT && P != l.RIGHT || (g = P,
            this._height = window.innerHeight),
            P == l.TOP || P == l.BOTTOM,
            f.setStyleProperty("float", g)
        } else {
            var C = this._menuHide = new o(o.INPUT_BUTTON);
            if (C.setStyleClass(a.ButtonMenuHide),
            C.addEventListener(c.MOUSE_DOWN, this._onMenuHideMouseDown.bind(this)),
            y.addChild(C),
            this._parent.panelsAreClosable()) {
                var E = new o(o.INPUT_BUTTON);
                E.setStyleClass(a.ButtonMenuClose),
                E.addEventListener(c.MOUSE_DOWN, this.disable.bind(this)),
                y.addChild(E)
            }
            ...
            i) {
                ...
                s ? g == l.LEFT || g == l.TOP || g == l.BOTTOM ? f.setPositionGlobal(s[0], s[1]) : (f.setPositionGlobal(window.innerWidth - n - s[0], s[1]),
        ...
        (L || V) && y.addChildAt(new o, 0).setStyleClass(a.Wrap),
        L && (this._menuUndo = y.getChildAt(0).addChild(new o(o.INPUT_BUTTON)).setStyleClass(a.ButtonMenuUndo).setProperty("value", u.get().getNumStates()).addEventListener(c.MOUSE_DOWN, function() {
            u.get().popState()
        }),
        N.addEventListener(v.UPDATE_MENU, this, "onUpdateMenu")),
        V && (y.getChildAt(0).addChild(new o(o.INPUT_BUTTON)).setStyleClass(a.ButtonMenuLoad).setProperty("value", "Load").addEventListener(c.MOUSE_DOWN, function() {
            t._loadState()
        }),
    ...
    i.prototype._updateAppearance = function() {
        ...
        this.dispatchEvent(new h(this,g.PANEL_SHOW,null))) : (e.getStyle().borderBottom = "none",
        t.setHeight(e.getHeight()),
        n.setStyleClass(a.ButtonMenuShow),
        this.dispatchEvent(new h(this,g.PANEL_HIDE,null)))
    }
    ,
    i.prototype._onHeadDragStart = function() {
        ...
        var r = d.MOUSE_MOVE
          ...
          , u = function() {
            ...
            document.removeEventListener(s, u, !1),
            a.dispatchEvent(new h(this,g.PANEL_MOVE_END,null))
        };
        t.removeChild(e),
        t.addChild(e),
        document.addEventListener(r, l, !1),
        document.addEventListener(s, u, !1),
        this.dispatchEvent(new h(this,g.PANEL_MOVE_BEGIN,null))
    }
    ,
    i.prototype._updatePosition = function() {
        ...
        this.dispatchEvent(new h(this,g.PANEL_MOVE,null))
    }
    ,
    i.prototype._onWindowResize = function() {
        if (this.isDocked()) {
            ...
            if (t.align == l.RIGHT || t.align == l.LEFT) {
                ...
                this.dispatchEvent(new h(this,g.PANEL_SIZE_CHANGE))
            }
        } else
            this.isFixed() || this._constrainPosition();
        this._constrainHeight(),
        this.dispatchEvent(new h(this,d.WINDOW_RESIZE))
    }
    ,
    ...
    i.prototype._constrainHeight = function() {
        if (this._vConstrain) {
            var t, e = this.hasMaxHeight(), n = this.hasScrollWrap(), i = this._headNode, o = this._wrapNode, r = this._scrollBar, s = this.isDocked() ? 0 : this.isFixed() ? 0 : this._position[1], a = e ? this.getMaxHeight() : n ? r.getTargetNode().getHeight() : o.getHeight(), l = s + a, u = i.getHeight(), p = window.innerHeight, d = p - l - u;
            if (d < 0) {
                if (t = a + d,
                !n)
                    return this._addScrollWrap(t),
                    void this.dispatchEvent(new h(this,g.PANEL_SCROLL_WRAP_ADDED,null));
                r.setWrapHeight(t),
                o.setHeight(t)
            } else
                ...
                this._scrollBar = null,
                this.dispatchEvent(new h(this,g.PANEL_SCROLL_WRAP_REMOVED,null)))
        }
    }
    ,
    ...
    i.prototype.addGroup = function(t) {
        ...
        this.isDocked() && this.dispatchEvent(new h(this,g.PANEL_SIZE_CHANGE)),
        this
    }
    ,
    i.prototype.addSubGroup = function(t) {
    ...
    i.prototype._addComponent = function() {
        ...
        return 0 == e.length && e.push(new r(this)),
        t = e[e.length - 1],
...
, function(t, e, n) {
    function i(t, e) {
        ...
        if (h && 0 != h.length && "none" != h) {
            var d = this._headNode = new r
              , c = new r
              , g = new r(r.SPAN);
            d.setStyleClass(s.Head),
            c.setStyleClass(s.Wrap),
            g.setStyleClass(s.Label),
            g.setProperty("innerHTML", h),
            c.addChild(g),
            d.addChild(c);
            var v = this._indiNode = new r;
            v.setStyleClass(s.ArrowBSubMax),
            d.addChildAt(v, 0),
            n.addChildAt(d, 0),
            this.addEventListener(p.SUBGROUP_TRIGGER, this._parent, "onSubGroupTrigger"),
            d.addEventListener(l.MOUSE_DOWN, this._onHeadMouseDown.bind(this)),
            this._updateAppearance()
        }
        this.hasMaxHeight() && this.addScrollWrap(),
        this._parent.addEventListener(p.SUBGROUP_ENABLE, this, "onEnable"),
        this._parent.addEventListener(p.SUBGROUP_DISABLE, this, "onDisable"),
        this._parent.addEventListener(u.PANEL_MOVE_END, this, "onPanelMoveEnd"),
        this._parent.addEventListener(p.GROUP_SIZE_CHANGE, this, "onGroupSizeChange"),
        this._parent.addEventListener(u.PANEL_SIZE_CHANGE, this, "onPanelSizeChange"),
    ...
    i.prototype._onTrigger = function() {
        this._updateAppearance(),
        this.dispatchEvent(new a(this,p.SUBGROUP_TRIGGER,null))
    }
    ,
    i.prototype._updateAppearance = function() {
        this.isDisabled() ? (this._wrapNode.setHeight(0),
        this.hasLabel() && (this._headNode.setStyleClass(s.HeadInactive),
        this._indiNode.setStyleClass(s.ArrowBSubMin))) : (this.hasMaxHeight() ? this._wrapNode.setHeight(this.getMaxHeight()) : this._wrapNode.deleteStyleProperty("height"),
        this.hasLabel() && (this._headNode.setStyleClass(s.Head),
        this._indiNode.setStyleClass(s.ArrowBSubMax)))
    }
    ,
    i.prototype.update = function() {
        this.hasMaxHeight() && this._scrollBar.update()
...
, function(t, e) {
    var n = function() {
        ...
        h.appendChild(c); 74 > c.children.length; ) {
        ...
        return {
            ...
            begin: function() {
                ...
                return f.appendChild(f.firstChild).style.height = p + "px",
                l++,
                u > e + 1e3 && (r = Math.round(1e3 * l / (u - e)),
                s = Math.min(s, r),
                a = Math.max(a, r),
                d.textContent = r + " FPS (" + s + "-" + a + ")",
                p = Math.min(30, 30 - 30 * (r / 100)),
                c.appendChild(c.firstChild).style.height = p + "px",
                e = u,
                l = 0),
                u
            },
      ...
      , o = function() {
        ...
        return i(t, [{
            ...
            value: function(t, e) {
                if (this.SOUNDS[t]) {
                    var n = this.SOUNDS[t];
                    "undefined" != typeof e && n.stereo(e.x / 40),
                    TweenMax.fromTo(n, .5, {
                        volume: 0
                    }, {
                        volume: n.baseVolume,
            ...
            a(n, [{
                ...
                value: function() {
                    for (var e = new t.BufferGeometry, n = new Float32Array(3 * d), i = new Float32Array(1 * d), o = 0; o < d; o++) {
                        ...
                        n[r + 0] = s * Math.cos(l) * Math.cos(a),
                        n[r + 1] = s * Math.sin(a),
                        n[r + 2] = s * Math.sin(l) * Math.cos(a),
                        i[o] = .7 * Math.random() + .3
                    }
                    e.addAttribute("position", new t.BufferAttribute(n,3)),
                    e.addAttribute("aOpacity", new t.BufferAttribute(i,1));
                    var u = new t.ShaderMaterial({
                        transparent: !0,
                        vertexShader: h.Vertex,
                        fragmentShader: h.Fragment
                    });
                    this.particles = new t.Points(e,u),
                ...
                value: function(e) {
                    (0,
                    u.rotateAroundWorldAxis)(this, new t.Vector3(1,0,0), .01 * e.y),
                    (0,
                    u.rotateAroundWorldAxis)(this, new t.Vector3(0,1,0), .01 * e.x)
                }
            }]),
            n
        }(t.Object3D);
        ...
        var a = function() {
          ...
          , m = function(e) {
            function n(e) {
                o(this, n);
                var i = r(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this));
                return i.isMouseDown = !1,
                i.mouseDownTime = 0,
                i.mouseMoveCount = 0,
                i.swooshPos = new t.Vector2,
                i.lastMousePos = new t.Vector2,
                i.raycaster = new t.Raycaster,
                i.currentMouseLightPos = new t.Vector3,
                i.targetMouseLightPos = new t.Vector3,
                (0,
                u.default)(i),
                i.environment = e,
                i.setup(),
            ...
            a(n, [{
                ...
                value: function() {
                    this.setupPlanet(),
                    window.APP.isMobile || this.setupLogo()
                }
            }, {
                key: "setupPlanet",
                value: function() {
                ...
                value: function() {
                    ...
                    this.logo = t,
                    this.logo.position.set(0, 7, 50),
                    this.add(t)
                }
            }, {
                key: "setupListeners",
                value: function() {
                    window.APP.isMobile ? (DOMUtils.on(this.environment.$node, "touchstart", this.onTouchStart),
                    DOMUtils.on(this.environment.$node, "touchmove", this.onTouchMove)) : (DOMUtils.on(this.environment.$node, "mousedown", this.onMouseDown),
                    DOMUtils.on(this.environment.$node, "mousemove", this.onMouseMove))
                }
            }, {
                key: "destroyListeners",
                value: function() {
                    DOMUtils.off(this.environment.$node, "mousedown", this.onMouseDown),
                    DOMUtils.off(this.environment.$node, "mousemove", this.onMouseMove),
                    DOMUtils.off(this.environment.$node, "touchstart", this.onTouchStart),
                    DOMUtils.off(this.environment.$node, "touchmove", this.onTouchMove),
                ...
                key: "update",
                value: function() {
                    this.currentMouseLightPos.x += .1 * (this.targetMouseLightPos.x - this.currentMouseLightPos.x),
                    this.currentMouseLightPos.y += .1 * (this.targetMouseLightPos.y - this.currentMouseLightPos.y),
                    this.currentMouseLightPos.z += .1 * (this.targetMouseLightPos.z - this.currentMouseLightPos.z),
                    this.planet.mouseLightPos.copy(this.currentMouseLightPos),
                    this.swooshPos.x *= .9,
                    this.swooshPos.x > 0 ? this.swooshPos.floor() : this.swooshPos.ceil(),
                    f.default.SOUNDS.swoosh.volume(Math.abs(this.swooshPos.x / 50)),
                    f.default.SOUNDS.swoosh.stereo(this.swooshPos.x / 40),
                    this.planet.update(),
                    window.APP.isMobile || this.logo.update()
                }
            }, {
                key: "onResize",
                value: function() {
                ...
                value: function(t) {
                    ...
                    this.planetNoiseOffsetClone = this.planet.targetNoiseOffset,
                ...
                value: function(e) {
                    ...
                    if (o.z > -150 && this.raycaster.ray.direction.y < 0 && (this.targetMouseLightPos = o.clone(),
                    this.targetMouseLightPos.y = 5),
                    (this.lastMousePos.x !== e.clientX || this.lastMousePos.y !== e.clientY) && this.isMouseDown) {
                        this.mouseMoveCount++;
                        ...
                        this.swooshPos.x += .1 * (a - u),
                        this.planet.targetNoiseOffset.x = this.planetNoiseOffsetClone.x - (a - u) / r * 50,
                        this.planet.targetNoiseOffset.y = this.planetNoiseOffsetClone.y + (l - p) / s * 50,
                ...
                value: function(e) {
                    if (e.preventDefault(),
                    this.isMouseDown = !1,
                    +new Date - this.mouseDownTime < 300 && this.mouseMoveCount < 2) {
                ...
                value: function(t) {
                    ...
                    this.lastMousePos.set(e.clientX, e.clientY),
                    this.planetNoiseOffsetClone = this.planet.targetNoiseOffset,
                    DOMUtils.on(window, "touchend", this.onTouchEnd)
                }
            }, {
                key: "onTouchMove",
                value: function(e) {
                    ...
                    if (this.lastMousePos.x !== n.clientX || this.lastMousePos.y !== n.clientY) {
                        ...
                        this.planet.targetNoiseOffset.x = this.planetNoiseOffsetClone.x - (r - a) / i * 50,
                        this.planet.targetNoiseOffset.y = this.planetNoiseOffsetClone.y + (s - l) / o * 50,
                        this.lastMousePos.set(n.clientX, n.clientY)
                    }
                }
            }, {
                key: "onTouchEnd",
          ...
          , w = function() {
            ...
            return r(e, [{
                ...
                value: function() {
                    ...
                    e.position.set(0, 10, 100),
                    e.lookAt(new t.Vector3);
                    var n = new t.WebGLRenderer({
                        antialias: !0
                    });
                    n.setClearColor(0, 1),
                    this.$node.appendChild(n.domElement);
                    var i = new t.Scene
                ...
                value: function() {
                    ...
                    this.unmute(),
                    this.setupListeners(),
                    this.contentContainer.setupListeners(),
                    this.render(),
                    b.default.fadeIn("ambient"),
                    b.default.play("swoosh")
                }
            }, {
                key: "stop",
                value: function() {
                    ...
                    this.contentContainer.destroyListeners()
                }
            }, {
                key: "pause",
                value: function() {
                ...
                value: function() {
                    ...
                    window.APP.isMobile ? this.renderer.render(this.scene, this.camera) : (this.composer.reset(),
                ...
                value: function() {
                    ...
                    "undefined" != typeof this.scene && this.contentContainer.onResize()
                }
            }]),
            e
        }();
...
, function(t, e, n) {
    (function(t) {
        ...
        !function() {
            var e = new t.TextureLoader;
            h = e.load(p),
            h.wrapS = t.RepeatWrapping,
            h.wrapT = t.RepeatWrapping
        }();
        var d = function(e) {
            function n(t, e) {
                o(this, n);
                var i = r(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this));
                return i.name = "LightPillar",
                i.visible = !1,
                i.camera = e,
                i.renderer = t,
                i.init(),
            ...
            a(n, [{
                ...
                value: function() {
                    ...
                    this.width = e,
                    this.height = n,
                    this.mesh = new t.Mesh(new t.PlaneBufferGeometry(e,n,1,1),new t.ShaderMaterial({
                        side: t.DoubleSide,
        ...
        var a = function() {
          ...
          , h = function(e) {
            function n(e) {
                ...
                var i = r(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this));
                return i.name = "Lines",
                i.noisePosition = new t.Vector2,
                i.currentHitPointIndex = 0,
                i.setup(e),
                i
            }
            return s(n, e),
            a(n, [{
                ...
                value: function(e) {
                    ...
                    window.APP.isMobile ? o.position.y += .12 : o.position.y += .12,
                    this.add(o),
                    this.setupDebug()
                }
            }, {
                key: "setupDebug",
                value: function() {
                    this.mesh.material.uniforms.uMovementData.value.noiseRange = [-10, 10],
                    this.mesh.material.uniforms.uLineData.value.thicknessRange = [.01, 1],
                    this.mesh.material.uniforms.uLineData.value.spaceRange = [.01, 10],
                    this.mesh.material.uniforms.uLineData.value.blurRange = [.01, 1],
                    this.mesh.material.uniforms.uLineWarpData.value.areaRange = [.01, .2],
                    this.mesh.material.uniforms.uLineWarpData.value.spreadRange = [0, 10],
                    this.mesh.position.range = [-5, 5],
                    u.default.addGroup({
                        label: "Lines"
                ...
                value: function(t) {
                    ...
                    e.to(this.mesh.material.uniforms.uHitPoints.value[this.currentHitPointIndex], 1, {
                        z: 10,
                        ease: Power1.easeIn
                    }, "start"),
                    this.currentHitPointIndex++,
                    this.currentHitPointIndex >= this.mesh.material.uniforms.uHitPoints.value.length && (this.currentHitPointIndex = 0)
                }
            }, {
                key: "update",
                value: function() {}
          ...
          , c = function(e) {
            ...
            a(n, [{
                ...
                value: function(e) {
                    ...
                    n.renderTarget.texture.mapping = t.CubeReflectionMapping,
                    e.children.forEach(function(t) {
                        t.material = i
                    }),
                    e.scale.set(.06, .06, .06),
                    this.add(e),
                    this.add(n),
                    this.meshes = e,
                    this.material = i,
                    this.reflectionCamera = n,
                    this.isReady = !0,
                    this.setupDebug()
                }
            }, {
                key: "setupDebug",
                value: function() {
                    this.material.reflectivityRange = [0, 1],
                    this.material.refractionRatioRange = [0, 1],
                    this.material.opacityRange = [0, 1],
                    this.reflectionCamera.renderTarget.texture.mappingOptions = [t.CubeReflectionMapping, t.CubeRefractionMapping],
                    h.default.addGroup({
                        label: "Logo"
                ...
                key: "update",
                value: function() {
                    this.isReady && (this.meshes.visible = !1,
                    this.parent.prepReflection(),
                    this.reflectionCamera.updateCubeMap(this.environment.renderer, this.parent),
                    this.parent.prepNoReflection(),
                    this.meshes.visible = !0)
                }
            }]),
            n
        }(t.Object3D);
        ...
        var a = function() {
          ...
          , v = function(e) {
            function n(e) {
                o(this, n);
                var i = r(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this));
                return i.name = "Planet",
                i.noisePosition = new t.Vector2,
                i.noiseOffset = new t.Vector2,
                i.targetNoiseOffset = new t.Vector2,
                i.mouseLightPos = new t.Vector3,
                i.currentHitPointIndex = 0,
                i.pillars = [],
                i.environment = e,
                i.setup(),
            ...
            a(n, [{
                ...
                key: "setupLines",
                value: function() {
                    this.lines = new u.default(this.mesh),
                    this.add(this.lines)
                }
            }, {
                key: "setupBackground",
                value: function() {
                    ...
                    this.background = new c.default(this.renderer,t),
                ...
                value: function() {
                    ...
                    this.mesh.visible = !0,
                    this.background.visible = !0
                }
            }, {
                key: "hitComet",
                value: function(t) {
                    console.log("HIT COMET", t),
                    this.mesh.material.uniforms.uHitPoints.value[this.currentHitPointIndex].set(t.x, -t.z, 0),
                    TweenMax.to(this.mesh.material.uniforms.uHitPoints.value[this.currentHitPointIndex], 1.5, {
                        z: 1,
                        ease: Power0.easeNone
                    }),
                    this.currentHitPointIndex++,
                    this.currentHitPointIndex >= this.mesh.material.uniforms.uHitPoints.value.length && (this.currentHitPointIndex = 0),
                    this.lines.hitComet(t);
                ...
                key: "update",
                value: function() {
                    this.lastNoisePos = this.mesh.material.uniforms.uNoisePosition.value.clone(),
                    this.noisePosition.y += .08,
                    this.noiseOffset.sub(this.noiseOffset.clone().sub(this.targetNoiseOffset).multiplyScalar(.1)),
                    this.mesh.material.uniforms.uNoisePosition.value.copy(this.noisePosition).add(this.noiseOffset),
                    this.lines.setNoisePosition(this.mesh.material.uniforms.uNoisePosition.value),
                    this.lines.setMouseLightPosition(this.mouseLightPos),
                ...
                value: function() {
                    var t = this.mesh.material.uniforms.uNoisePosition.value.clone().sub(this.lastNoisePos);
                    this.background.updateRotation(t),
...
, , , , , , , , function(t, e, n) {
    (function(t) {
        ...
        e.rotateAroundWorldAxis = function(e, i, o) {
            n = new t.Matrix4,
            n.makeRotationAxis(i.normalize(), o),
            n.multiply(e.matrix),
            e.matrix = n,
                ...
                var t = {
                    ...
                    addFace: function(t, e, n, i, o, r, s, a, l, u, p, h) {
                        ...
                        void 0 !== o) {
                            ...
                            v = this.parseUVIndex(r, f),
                            A = this.parseUVIndex(s, f),
                            void 0 === i ? this.addUV(g, v, A) : (d = this.parseUVIndex(a, f),
                            this.addUV(g, v, d),
                            this.addUV(v, A, d))
                        }
                        if (void 0 !== l) {
                            ...
                            v = l === u ? g : this.parseNormalIndex(u, m),
                            A = l === p ? g : this.parseNormalIndex(p, m),
                            void 0 === i ? this.addNormal(g, v, A) : (d = this.parseNormalIndex(h, m),
                    ...
                    addLineGeometry: function(t, e) {
                        ...
                        for (var n = this.vertices.length, i = this.uvs.length, o = 0, r = t.length; o < r; o++)
            ...
            parse: function(e) {
                ...
                for (var i = e.split("\n"), o = "", r = "", s = "", a = 0, l = [], u = "function" == typeof "".trimLeft, p = 0, h = i.length; p < h; p++)
                    ...
                    "#" !== r))
                        if ("v" === r)
                            if (s = o.charAt(1),
                            " " === s && null !== (l = this.regexp.vertex_pattern.exec(o)))
                                n.vertices.push(parseFloat(l[1]), parseFloat(l[2]), parseFloat(l[3]));
                            else if ("n" === s && null !== (l = this.regexp.normal_pattern.exec(o)))
                                n.normals.push(parseFloat(l[1]), parseFloat(l[2]), parseFloat(l[3]));
                            else {
                                if ("t" !== s || null === (l = this.regexp.uv_pattern.exec(o)))
                ...
                for (var p = 0, h = n.objects.length; p < h; p++) {
                    ...
                    if (0 !== _.vertices.length) {
                        ...
                        E.addAttribute("position", new t.BufferAttribute(new Float32Array(_.vertices),3)),
                        _.normals.length > 0 ? E.addAttribute("normal", new t.BufferAttribute(new Float32Array(_.normals),3)) : E.computeVertexNormals(),
                        _.uvs.length > 0 && E.addAttribute("uv", new t.BufferAttribute(new Float32Array(_.uvs),2));
                        for (var S = [], T = 0, N = P.length; T < N; T++) {
                            var L = P[T]
                              , b = void 0;
                            if (null !== this.materials && (b = this.materials.create(L.name),
                            C && b && !(b instanceof t.LineBasicMaterial))) {
                                var V = new t.LineBasicMaterial;
                                V.copy(b),
                                b = V
                            }
                            b || (b = C ? new t.LineBasicMaterial : new t.MeshPhongMaterial,
                            b.name = L.name),
                            b.shading = L.smooth ? t.SmoothShading : t.FlatShading,
                            S.push(b)
                        }
                        var O;
                        if (S.length > 1) {
                            ...
                            O = C ? new t.Line(E,S[0]) : new t.Mesh(E,S[0]);
                        O.name = w.name,
                        x.add(O)
                    }
                }
